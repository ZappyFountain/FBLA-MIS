window.QUESTION_BANK = [
  {
    ...
    "a": 1,
    "exp": "Correct answer is supported by the concept coverage: Requirements • Elicitation • Stakeholder • Analysis. Reference: Systems Analysis; Requirements Gathering.",
    "objective": "Systems Design & Analysis",
    "conceptCoverage": "Requirements • Elicitation • Stakeholder • Analysis",
  ...
  },
  {
    ...
    "fullTopic": "Systems Design & Analysis",
    "d": "medium",
    "q": "A financial-services company is redesigning its customer portal. Stakeholders require customers to view account balances, submit service requests, and download statements. They also require the portal to remain available during peak hours and display requested account information within three seconds. Which statement BEST classifies these requirements?",
    "opts": [
    ...
    "a": 2,
    "exp": "Correct answer is supported by the concept coverage: Functional • vs. • Nonfunctional • Requirements. Reference: Systems Analysis; Requirements Specification.",
    "objective": "Systems Design & Analysis",
    "conceptCoverage": "Functional • vs. • Nonfunctional • Requirements",
  ...
  },
  {
    ...
    "fullTopic": "Systems Design & Analysis",
    "d": "medium",
    "q": "A warehouse manager states that all outbound shipments are scanned, verified, and approved before loading. During observation, an analyst finds that employees skip verification during late-afternoon rush periods because the process creates a bottleneck. Which interpretation is MOST appropriate?",
    "opts": [
    ...
    "a": 0,
    "exp": "Correct answer is supported by the concept coverage: Observation • Workflow • Analysis. Reference: Requirements Gathering; Business Process Analysis.",
    "objective": "Systems Design & Analysis",
    "conceptCoverage": "Observation • Workflow • Analysis",
  ...
  },
  {
    ...
    "fullTopic": "Systems Design & Analysis",
    "d": "medium",
    "q": "In a data flow diagram, which component represents a person, department, organization, or external system that sends data to or receives data from the system being modeled?",
    "opts": [
      "Data store",
      "Process",
      "Data flow",
    ...
    "a": 3,
    "exp": "Correct answer is supported by the concept coverage: Recall • Data • Flow • Diagrams. Reference: Structured Analysis; Data Flow Diagram Components.",
    "objective": "Systems Design & Analysis",
    "conceptCoverage": "Recall • Data • Flow • Diagrams",
  ...
  },
  {
    ...
    "a": 1,
    "exp": "Correct answer is supported by the concept coverage: Feasibility • Analysis • Organizational • Feasibility. Reference: Feasibility Study; Organizational Change.",
    "objective": "Systems Design & Analysis",
    "conceptCoverage": "Feasibility • Analysis • Organizational • Feasibility",
  ...
  },
  {
    ...
    "a": 2,
    "exp": "Correct answer is supported by the concept coverage: Validation • vs. • Verification. Reference: Systems Testing; User Acceptance Testing.",
    "objective": "Systems Design & Analysis",
    "conceptCoverage": "Validation • vs. • Verification",
  ...
  },
  {
    ...
    "fullTopic": "Systems Design & Analysis",
    "d": "medium",
    "q": "Executives want a high-level view of a new payroll system before reviewing detailed process models. They want to see the payroll system as a single unit, identify outside entities such as employees and tax agencies, and understand the major information exchanged with each. Which artifact BEST meets this need?",
    "opts": [
    ...
    "a": 0,
    "exp": "Correct answer is supported by the concept coverage: Context • Diagram. Reference: Structured Analysis; Context Diagrams.",
    "objective": "Systems Design & Analysis",
    "conceptCoverage": "Context • Diagram",
  ...
  },
  {
    ...
    "a": 3,
    "exp": "Correct answer is supported by the concept coverage: Prototyping. Reference: Alternative Development Approaches; Prototyping.",
    "objective": "Systems Design & Analysis",
    "conceptCoverage": "Prototyping",
  ...
  },
  {
    ...
    "fullTopic": "Systems Design & Analysis",
    "d": "medium",
    "q": "Midway through development of a customer-support platform, marketing requests a loyalty-program feature that was not part of the approved project scope. The feature may be useful, but it would require additional integrations and delay the planned launch. What should the project manager do FIRST?",
    "opts": [
    ...
    "a": 1,
    "exp": "Correct answer is supported by the concept coverage: Scope • Management • Change • Control. Reference: Requirements Management; Systems Proposal.",
    "objective": "Systems Design & Analysis",
    "conceptCoverage": "Scope • Management • Change • Control",
  ...
  },
  {
    ...
    "a": 2,
    "exp": "Correct answer is supported by the concept coverage: Logical • vs. • Physical • Design. Reference: Systems Design; Logical Design.",
    "objective": "Systems Design & Analysis",
    "conceptCoverage": "Logical • vs. • Physical • Design",
  ...
  },
  {
    ...
    "a": 0,
    "exp": "Correct answer is supported by the concept coverage: Input • Controls • Data • Integrity. Reference: System Controls; Input Validation.",
    "objective": "Systems Design & Analysis",
    "conceptCoverage": "Input • Controls • Data • Integrity",
  ...
  },
  {
    ...
    "fullTopic": "Systems Design & Analysis",
    "d": "medium",
    "q": "A hospital activates a replacement patient-registration system at one outpatient clinic, monitors its performance for several weeks, and addresses workflow issues before expanding the system to all remaining clinics. Which conversion strategy is being used?",
    "opts": [
      "Parallel conversion",
      "Direct conversion",
      "Phased conversion",
    ...
    "a": 3,
    "exp": "Correct answer is supported by the concept coverage: Recall • Conversion • Strategies. Reference: System Implementation; Conversion Approaches.",
    "objective": "Systems Design & Analysis",
    "conceptCoverage": "Recall • Conversion • Strategies",
  ...
  },
  {
    ...
    "fullTopic": "Systems Design & Analysis",
    "d": "medium",
    "q": "A retailer’s database design must reflect that one customer may place many orders over time, while each individual order is associated with one customer. Which relationship should be represented between the Customer and Order entities?",
    "opts": [
    ...
    "a": 1,
    "exp": "Correct answer is supported by the concept coverage: Entity • Relationship • Diagrams • Cardinality. Reference: Data Modeling; Entity Relationship Diagrams.",
    "objective": "Systems Design & Analysis",
    "conceptCoverage": "Entity • Relationship • Diagrams • Cardinality",
  ...
  },
  {
    ...
    "fullTopic": "Systems Design & Analysis",
    "d": "medium",
    "q": "A payroll application has passed unit, integration, and system testing. Before organization-wide deployment, payroll specialists process realistic pay periods, examine exception reports, and test unusual circumstances such as retroactive wage adjustments. What is the PRIMARY purpose of this activity?",
    "opts": [
    ...
    "a": 2,
    "exp": "Correct answer is supported by the concept coverage: User • Acceptance • Testing. Reference: Testing and Implementation; Validation.",
    "objective": "Systems Design & Analysis",
    "conceptCoverage": "User • Acceptance • Testing",
  ...
  },
  {
    ...
    "fullTopic": "Systems Design & Analysis",
    "d": "medium",
    "q": "Nine months after deploying a new claims-processing system, executives compare actual cycle-time reduction, error rates, user productivity, and operating costs with estimates used to justify the project. What question are they primarily attempting to answer?",
    "opts": [
    ...
    "a": 0,
    "exp": "Correct answer is supported by the concept coverage: Post-Implementation • Review • Benefits • Realization. Reference: System Evaluation; Maintenance.",
    "objective": "Systems Design & Analysis",
    "conceptCoverage": "Post-Implementation • Review • Benefits • Realization",
  ...
  },
  {
    ...
    "a": 2,
    "exp": "Correct answer is supported by the concept coverage: Joint • Application • Design • Requirements • Reconciliation. Reference: Requirements Gathering; Stakeholder Collaboration.",
    "objective": "Systems Design & Analysis",
    "conceptCoverage": "Joint • Application • Design • Requirements • Reconciliation",
  ...
  },
  {
    ...
    "fullTopic": "Systems Design & Analysis",
    "d": "medium",
    "q": "A developer joins a retail-ordering project and needs to determine whether the field SHIPMENT_STATUS accepts abbreviations, which values are valid, what its maximum length is, and which process updates it. Which project artifact should the developer consult FIRST?",
    "opts": [
    ...
    "a": 0,
    "exp": "Correct answer is supported by the concept coverage: Data • Dictionary • Metadata. Reference: System Design Documentation; Data Definitions.",
    "objective": "Systems Design & Analysis",
    "conceptCoverage": "Data • Dictionary • Metadata",
  ...
  },
  {
    ...
    "a": 3,
    "exp": "Correct answer is supported by the concept coverage: Rapid • Application • Development • Time • Constraints. Reference: Alternative Development Approaches; Rapid Application Development.",
    "objective": "Systems Design & Analysis",
    "conceptCoverage": "Rapid • Application • Development • Time • Constraints",
  ...
  },
  {
    ...
    "fullTopic": "Systems Design & Analysis",
    "d": "medium",
    "q": "A manufacturer has completed preliminary analysis of a new maintenance-management system. Executives ask for a decision document that compares building custom software, purchasing a package, and outsourcing the platform. They want projected benefits, costs, risks, implementation implications, and a recommendation. What should the analyst prepare?",
    "opts": [
    ...
    "a": 1,
    "exp": "Correct answer is supported by the concept coverage: Systems • Proposal • Alternative • Evaluation. Reference: Feasibility Study; Systems Proposal.",
    "objective": "Systems Design & Analysis",
    "conceptCoverage": "Systems • Proposal • Alternative • Evaluation",
  ...
  },
  {
    ...
    "a": 2,
    "exp": "Correct answer is supported by the concept coverage: Build • vs. • Buy • Application • Packages. Reference: Alternative Systems-Building Approaches; Application Software Packages.",
    "objective": "Systems Design & Analysis",
    "conceptCoverage": "Build • vs. • Buy • Application • Packages",
  ...
  },
  {
    ...
    "fullTopic": "Systems Design & Analysis",
    "d": "medium",
    "q": "A retailer contracts with a vendor to host and enhance its customer-loyalty platform. The vendor will process customer profiles, maintain integrations, and develop requested features. Before signing the agreement, which action would MOST directly reduce the risk of losing control over essential information-system capabilities?",
    "opts": [
    ...
    "a": 3,
    "exp": "Correct answer is supported by the concept coverage: Outsourcing • Vendor • Governance. Reference: Outsourcing; Information-System Governance.",
    "objective": "Systems Design & Analysis",
    "conceptCoverage": "Outsourcing • Vendor • Governance",
  ...
  },
  {
    ...
    "fullTopic": "Systems Design & Analysis",
    "d": "medium",
    "q": "A development team has tested reservation, payment, and notification modules independently. The next concern is whether successful payment authorization correctly updates the reservation record and triggers the appropriate customer message. Which testing activity should occur NEXT?",
    "opts": [
    ...
    "a": 0,
    "exp": "Correct answer is supported by the concept coverage: Testing • Integration • Testing. Reference: Systems Testing; Implementation.",
    "objective": "Systems Design & Analysis",
    "conceptCoverage": "Testing • Integration • Testing",
  ...
  },
  {
    ...
    "fullTopic": "Systems Design & Analysis",
    "d": "medium",
    "q": "An analyst decomposes a context diagram for an online ordering system into a Level-1 data flow diagram. The context diagram shows Customer Order as an incoming data flow, but no Level-1 process receives that flow or shows how it enters the system. Which issue is MOST likely present?",
    "opts": [
    ...
    "a": 1,
    "exp": "Correct answer is supported by the concept coverage: Data • Flow • Diagrams • Balancing. Reference: Structured Analysis; Data Flow Diagram Decomposition.",
    "objective": "Systems Design & Analysis",
    "conceptCoverage": "Data • Flow • Diagrams • Balancing",
  ...
  },
  {
    ...
    "a": 2,
    "exp": "Correct answer is supported by the concept coverage: Exception • Reports • Output • Controls. Reference: System Controls; Output Controls.",
    "objective": "Systems Design & Analysis",
    "conceptCoverage": "Exception • Reports • Output • Controls",
  ...
  },
  {
    ...
    "fullTopic": "Systems Design & Analysis",
    "d": "medium",
    "q": "After implementation of a payroll system, developers correct an intermittent overtime-calculation defect. Several months later, they revise tax-withholding logic to comply with a new state tax law. Which classification is MOST accurate?",
    "opts": [
    ...
    "a": 3,
    "exp": "Correct answer is supported by the concept coverage: Corrective • vs. • Adaptive • Maintenance. Reference: System Maintenance; Types of Maintenance.",
    "objective": "Systems Design & Analysis",
    "conceptCoverage": "Corrective • vs. • Adaptive • Maintenance",
  ...
  },
  {
    ...
    "a": 1,
    "exp": "Correct answer is supported by the concept coverage: User • Acceptance • Testing • Validation. Reference: Testing and Implementation; Validation.",
    "objective": "Systems Design & Analysis",
    "conceptCoverage": "User • Acceptance • Testing • Validation",
    "reference": "Testing and Implementation; Validation"
  },
  {
    "id": "SYS-027",
    ...
    "fullTopic": "Systems Design & Analysis",
    "d": "medium",
    "q": "Which UML artifact is designed to represent classes, their attributes, operations, and relationships such as inheritance or association?",
    "opts": [
      "Class diagram",
      "Use-case diagram",
      "Context diagram",
    ...
    "a": 0,
    "exp": "Correct answer is supported by the concept coverage: Recall • Class • Diagrams. Reference: Object-Oriented Analysis and Design; UML.",
    "objective": "Systems Design & Analysis",
    "conceptCoverage": "Recall • Class • Diagrams",
  ...
  },
  {
    ...
    "a": 2,
    "exp": "Correct answer is supported by the concept coverage: Direct • Conversion • Implementation • Risk. Reference: System Implementation; Conversion Strategies.",
    "objective": "Systems Design & Analysis",
    "conceptCoverage": "Direct • Conversion • Implementation • Risk",
  ...
  },
  {
    ...
    "fullTopic": "Systems Design & Analysis",
    "d": "medium",
    "q": "A human-resources application functions correctly and complies with all current policies, but employees request a redesigned benefits-enrollment dashboard that reduces the number of screens required for common tasks. Which type of maintenance is MOST accurately represented?",
    "opts": [
    ...
    "a": 1,
    "exp": "Correct answer is supported by the concept coverage: Perfective • Maintenance • Usability. Reference: System Maintenance; Perfective Maintenance.",
    "objective": "Systems Design & Analysis",
    "conceptCoverage": "Perfective • Maintenance • Usability",
  ...
  },
  {
    ...
    "fullTopic": "Systems Design & Analysis",
    "d": "medium",
    "q": "Nine months after deploying a claims-processing system, executives compare actual cycle-time reduction, error rates, user productivity, and operating costs with the original estimates used to approve the project. What question are they primarily attempting to answer?",
    "opts": [
    ...
    "a": 3,
    "exp": "Correct answer is supported by the concept coverage: Post-Implementation • Review • Benefits • Realization. Reference: System Evaluation; Project Review.",
    "objective": "Systems Design & Analysis",
    "conceptCoverage": "Post-Implementation • Review • Benefits • Realization",
  ...
  },
  {
    ...
    "a": 1,
    "exp": "Correct answer is supported by the concept coverage: Requirements • Elicitation • Interviews • vs. • Observation. Reference: Requirements Gathering; Workflow Analysis.",
    "objective": "Systems Design & Analysis",
    "conceptCoverage": "Requirements • Elicitation • Interviews • vs. • Observation",
  ...
  },
  {
    ...
    "fullTopic": "Systems Design & Analysis",
    "d": "medium",
    "q": "A manufacturer selects a production-scheduling application that meets technical and budget requirements. During pilot testing, supervisors report that the system assigns work in a sequence that conflicts with established safety inspections and union work rules. Which concern is MOST directly raised?",
    "opts": [
    ...
    "a": 3,
    "exp": "Correct answer is supported by the concept coverage: Operational • Feasibility • Business • Process • Fit. Reference: Feasibility Analysis; Organizational Change.",
    "objective": "Systems Design & Analysis",
    "conceptCoverage": "Operational • Feasibility • Business • Process • Fit",
  ...
  },
  {
    ...
    "fullTopic": "Systems Design & Analysis",
    "d": "medium",
    "q": "An analyst creates a Level-1 data flow diagram for an online order system. The diagram separates the high-level “Process Order” activity into Validate Payment, Check Inventory, Create Shipment, and Update Customer Account. What is the PRIMARY purpose of this decomposition?",
    "opts": [
    ...
    "a": 0,
    "exp": "Correct answer is supported by the concept coverage: Data • Flow • Diagrams • Process • Decomposition. Reference: Structured Analysis; Data Flow Diagrams.",
    "objective": "Systems Design & Analysis",
    "conceptCoverage": "Data • Flow • Diagrams • Process • Decomposition",
  ...
  },
  {
    ...
    "fullTopic": "Systems Design & Analysis",
    "d": "medium",
    "q": "A university database must represent that students can enroll in many courses and each course can include many students. The system must also record the semester, grade, and enrollment status for every individual student-course pairing. Which design is MOST appropriate?",
    "opts": [
    ...
    "a": 2,
    "exp": "Correct answer is supported by the concept coverage: Entity • Relationship • Diagrams • Associative • Entities. Reference: Data Modeling; Entity Relationship Diagrams.",
    "objective": "Systems Design & Analysis",
    "conceptCoverage": "Entity • Relationship • Diagrams • Associative • Entities",
    "reference": "Data Modeling; Entity Relationship Diagrams"
  },
  {
    "id": "SYS-035",
    ...
    "a": 1,
    "exp": "Correct answer is supported by the concept coverage: Requirements • Prioritization • MoSCoW • Analysis. Reference: Requirements Management; Project Scope.",
    "objective": "Systems Design & Analysis",
    "conceptCoverage": "Requirements • Prioritization • MoSCoW • Analysis",
  ...
  },
  {
    ...
    "fullTopic": "Systems Design & Analysis",
    "d": "medium",
    "q": "A city is developing an online permit application. Users agree on required information but differ on whether applicants should complete one long form or a guided sequence of shorter steps. The design team wants feedback before investing in full development. Which action is MOST appropriate?",
    "opts": [
    ...
    "a": 3,
    "exp": "Correct answer is supported by the concept coverage: Prototyping • Requirements • Validation. Reference: Alternative Development Approaches; Prototyping.",
    "objective": "Systems Design & Analysis",
    "conceptCoverage": "Prototyping • Requirements • Validation",
    "reference": "Alternative Development Approaches; Prototyping"
  },
  {
    "id": "SYS-037",
    ...
    "fullTopic": "Systems Design & Analysis",
    "d": "medium",
    "q": "A retailer is evaluating a new fraud-detection system. The proposal estimates software licensing, implementation, training, and support costs, along with expected reductions in fraudulent refunds and chargebacks. Which analysis is MOST directly being performed?",
    "opts": [
    ...
    "a": 2,
    "exp": "Correct answer is supported by the concept coverage: Systems • Proposal • Cost-Benefit • Analysis. Reference: Feasibility Study; Systems Proposal.",
    "objective": "Systems Design & Analysis",
    "conceptCoverage": "Systems • Proposal • Cost-Benefit • Analysis",
    "reference": "Feasibility Study; Systems Proposal"
  },
  {
    "id": "SYS-038",
    ...
    "a": 0,
    "exp": "Correct answer is supported by the concept coverage: Verification • Test • Planning. Reference: Systems Testing; Verification.",
    "objective": "Systems Design & Analysis",
    "conceptCoverage": "Verification • Test • Planning",
  ...
  },
  {
    ...
    "a": 1,
    "exp": "Correct answer is supported by the concept coverage: Parallel • Conversion • Risk • Mitigation. Reference: System Implementation; Conversion Strategies.",
    "objective": "Systems Design & Analysis",
    "conceptCoverage": "Parallel • Conversion • Risk • Mitigation",
    "reference": "System Implementation; Conversion Strategies"
  },
  {
    "id": "SYS-040",
    ...
    "fullTopic": "Systems Design & Analysis",
    "d": "medium",
    "q": "A software team releases a working version of an expense-management application every three weeks. After each release, finance staff review completed features, identify new compliance priorities, and revise the order of remaining work. Which characteristic MOST clearly distinguishes this approach from a traditional sequential life cycle?",
    "opts": [
    ...
    "a": 2,
    "exp": "Correct answer is supported by the concept coverage: Agile • Development • Iterative • Delivery. Reference: Agile Development; Product Backlog.",
    "objective": "Systems Design & Analysis",
    "conceptCoverage": "Agile • Development • Iterative • Delivery",
  ...
  },
  {
    ...
    "fullTopic": "Systems Design & Analysis",
    "d": "medium",
    "q": "A company introduces a new procurement application that changes approval responsibilities for department managers. The application works technically, but employees continue using email and spreadsheets because they do not understand the new process or believe the system adds value. Which intervention is MOST likely to improve adoption?",
    "opts": [
    ...
    "a": 3,
    "exp": "Correct answer is supported by the concept coverage: Change • Management • Stakeholder • Engagement. Reference: Organizational Feasibility; System Implementation.",
    "objective": "Systems Design & Analysis",
    "conceptCoverage": "Change • Management • Stakeholder • Engagement",
  ...
  },
  {
    ...
    "fullTopic": "Systems Design & Analysis",
    "d": "medium",
    "q": "Which artifact is MOST useful for documenting a data element’s business meaning, data type, permitted values, length, source, and the processes that create or update it?",
    "opts": [
      "Data dictionary",
      "Context diagram",
      "Gantt chart",
    ...
    "a": 0,
    "exp": "Correct answer is supported by the concept coverage: Recall • Data • Dictionary. Reference: System Design Documentation; Metadata.",
    "objective": "Systems Design & Analysis",
    "conceptCoverage": "Recall • Data • Dictionary",
  ...
  },
  {
    ...
    "a": 1,
    "exp": "Correct answer is supported by the concept coverage: Direct • Conversion • Contingency • Planning. Reference: System Implementation; Conversion Strategies.",
    "objective": "Systems Design & Analysis",
    "conceptCoverage": "Direct • Conversion • Contingency • Planning",
    "reference": "System Implementation; Conversion Strategies"
  },
  {
    "id": "SYS-044",
    ...
    "fullTopic": "Systems Design & Analysis",
    "d": "medium",
    "q": "A customer-service application functions correctly but becomes slow during seasonal demand peaks. Developers modify query logic, add indexing, and optimize report generation without changing business rules or correcting an existing defect. Which type of maintenance is MOST accurately represented?",
    "opts": [
    ...
    "a": 2,
    "exp": "Correct answer is supported by the concept coverage: Perfective • Maintenance • Performance • Improvement. Reference: System Maintenance; Maintenance Types.",
    "objective": "Systems Design & Analysis",
    "conceptCoverage": "Perfective • Maintenance • Performance • Improvement",
  ...
  },
  {
    ...
    "fullTopic": "Systems Design & Analysis",
    "d": "medium",
    "q": "After deploying a new inventory system, project leaders review actual costs, schedule performance, user adoption, error rates, and realized business benefits. They also document what worked well and what should change in future projects. Which purpose BEST describes this activity?",
    "opts": [
    ...
    "a": 3,
    "exp": "Correct answer is supported by the concept coverage: Post-Implementation • Review • Lessons • Learned. Reference: System Evaluation; Project Management.",
    "objective": "Systems Design & Analysis",
    "conceptCoverage": "Post-Implementation • Review • Lessons • Learned",
  ...
  },
  {
    ...
    "a": 1,
    "exp": "Correct answer is supported by the concept coverage: Requirements • Traceability • Scope • Control. Reference: Requirements Management; Systems Analysis.",
    "objective": "Systems Design & Analysis",
    "conceptCoverage": "Requirements • Traceability • Scope • Control",
  ...
  },
  {
    ...
    "a": 3,
    "exp": "Correct answer is supported by the concept coverage: Decision • Tables • Business • Rules. Reference: Structured Analysis; Decision Logic.",
    "objective": "Systems Design & Analysis",
    "conceptCoverage": "Decision • Tables • Business • Rules",
  ...
  },
  {
    ...
    "a": 0,
    "exp": "Correct answer is supported by the concept coverage: Data • Flow • Diagrams • Data • Stores. Reference: Structured Analysis; Data Flow Diagram Components.",
    "objective": "Systems Design & Analysis",
    "conceptCoverage": "Data • Flow • Diagrams • Data • Stores",
    "reference": "Structured Analysis; Data Flow Diagram Components"
  },
  {
    "id": "SYS-049",
    ...
    "a": 2,
    "exp": "Correct answer is supported by the concept coverage: Process • Rationalization • Workflow • Improvement. Reference: Business Process Improvement; Systems Analysis.",
    "objective": "Systems Design & Analysis",
    "conceptCoverage": "Process • Rationalization • Workflow • Improvement",
  ...
  },
  {
    ...
    "a": 1,
    "exp": "Correct answer is supported by the concept coverage: Schedule • Feasibility • Project • Constraints. Reference: Feasibility Analysis; Project Planning.",
    "objective": "Systems Design & Analysis",
    "conceptCoverage": "Schedule • Feasibility • Project • Constraints",
  ...
  },
  {
    ...
    "a": 3,
    "exp": "Correct answer is supported by the concept coverage: Use-Case • Relationships • Include • Behavior. Reference: UML; Use-Case Modeling.",
    "objective": "Systems Design & Analysis",
    "conceptCoverage": "Use-Case • Relationships • Include • Behavior",
  ...
  },
  {
    ...
    "a": 0,
    "exp": "Correct answer is supported by the concept coverage: Requirements • Validation • Walkthroughs. Reference: Requirements Analysis; Stakeholder Review.",
    "objective": "Systems Design & Analysis",
    "conceptCoverage": "Requirements • Validation • Walkthroughs",
  ...
  },
  {
    ...
    "fullTopic": "Systems Design & Analysis",
    "d": "medium",
    "q": "A purchasing system allows department managers to submit purchase requests, procurement staff to approve vendor selection, and accounts-payable staff to release payment. No employee should be able to perform all three actions for the same transaction. Which control objective is MOST directly supported?",
    "opts": [
    ...
    "a": 2,
    "exp": "Correct answer is supported by the concept coverage: Logical • Controls • Segregation • of • Duties. Reference: System Controls; Internal Controls.",
    "objective": "Systems Design & Analysis",
    "conceptCoverage": "Logical • Controls • Segregation • of • Duties",
  ...
  },
  {
    ...
    "fullTopic": "Systems Design & Analysis",
    "d": "medium",
    "q": "A development team needs to document the time-ordered interactions that occur when a customer submits an online order: the website validates the cart, contacts the payment service, updates inventory, and sends confirmation. Which UML artifact is MOST appropriate?",
    "opts": [
    ...
    "a": 1,
    "exp": "Correct answer is supported by the concept coverage: System • Sequence • Diagrams • Interactions. Reference: UML; Sequence Modeling.",
    "objective": "Systems Design & Analysis",
    "conceptCoverage": "System • Sequence • Diagrams • Interactions",
  ...
  },
  {
    ...
    "a": 3,
    "exp": "Correct answer is supported by the concept coverage: Phased • Conversion • Implementation • Planning. Reference: System Implementation; Conversion Strategies.",
    "objective": "Systems Design & Analysis",
    "conceptCoverage": "Phased • Conversion • Implementation • Planning",
    "reference": "System Implementation; Conversion Strategies"
  },
  {
    "id": "SYS-056",
    ...
    "a": 0,
    "exp": "Correct answer is supported by the concept coverage: Recovery • Controls • Backup • Procedures. Reference: System Controls; Business Continuity.",
    "objective": "Systems Design & Analysis",
    "conceptCoverage": "Recovery • Controls • Backup • Procedures",
  ...
  },
  {
    ...
    "fullTopic": "Systems Design & Analysis",
    "d": "medium",
    "q": "A retailer specifies that customers may return products within 30 days unless the purchase is marked final sale, while electronics valued above $500 require manager approval before a refund is issued. How should these statements MOST appropriately be classified?",
    "opts": [
    ...
    "a": 2,
    "exp": "Correct answer is supported by the concept coverage: Requirement • Types • Business • Rules. Reference: Requirements Specification; Business Rules.",
    "objective": "Systems Design & Analysis",
    "conceptCoverage": "Requirement • Types • Business • Rules",
  ...
  },
  {
    ...
    "fullTopic": "Systems Design & Analysis",
    "d": "medium",
    "q": "A nationwide retailer wants input from thousands of store employees about preferred features for a new scheduling application. Leadership primarily needs broad, comparable feedback about common pain points rather than detailed explanations of unusual local workflows. Which method is MOST appropriate?",
    "opts": [
    ...
    "a": 1,
    "exp": "Correct answer is supported by the concept coverage: Requirements • Elicitation • Surveys. Reference: Requirements Gathering; Survey Methods.",
    "objective": "Systems Design & Analysis",
    "conceptCoverage": "Requirements • Elicitation • Surveys",
  ...
  },
  {
    ...
    "fullTopic": "Systems Design & Analysis",
    "d": "medium",
    "q": "A requirement for an expense-reporting system states, “The system should be easy to use and process reimbursements quickly.” Before design begins, the project manager asks the team to revise it. Which revision would MOST improve the requirement’s quality?",
    "opts": [
    ...
    "a": 3,
    "exp": "Correct answer is supported by the concept coverage: Acceptance • Criteria • Requirements • Quality. Reference: Requirements Specification; Testing Preparation.",
    "objective": "Systems Design & Analysis",
    "conceptCoverage": "Acceptance • Criteria • Requirements • Quality",
  ...
  },
  {
    ...
    "fullTopic": "Systems Design & Analysis",
    "d": "medium",
    "q": "A logistics company deployed route-optimization software to reduce fuel costs and late deliveries. Six months later, executives review fuel consumption, on-time delivery rates, dispatcher workload, user feedback, and the cost of maintaining the platform. Which activity are they primarily performing?",
    "opts": [
    ...
    "a": 0,
    "exp": "Correct answer is supported by the concept coverage: Post-Implementation • Evaluation • Operational • Metrics. Reference: System Evaluation; Benefits Realization.",
    "objective": "Systems Design & Analysis",
    "conceptCoverage": "Post-Implementation • Evaluation • Operational • Metrics",
  ...
  },
  {
    ...
    "a": 2,
    "exp": "Correct answer is supported by the concept coverage: Business • Process • Redesign • Cross-Functional • Workflow. Reference: Business Process Improvement; Systems Analysis.",
    "objective": "Systems Design & Analysis",
    "conceptCoverage": "Business • Process • Redesign • Cross-Functional • Workflow",
    "reference": "Business Process Improvement; Systems Analysis"
  },
  {
    "id": "SYS-062",
    ...
    "fullTopic": "Systems Design & Analysis",
    "d": "medium",
    "q": "A financial institution needs to document a loan-review policy in which different actions occur depending on credit score, collateral status, debt-to-income ratio, and the requested amount. Analysts want a visual model that shows alternative decision paths and their resulting actions. Which artifact is MOST appropriate?",
    "opts": [
    ...
    "a": 0,
    "exp": "Correct answer is supported by the concept coverage: Decision • Trees • Business • Rules. Reference: Structured Analysis; Decision Logic.",
    "objective": "Systems Design & Analysis",
    "conceptCoverage": "Decision • Trees • Business • Rules",
    "reference": "Structured Analysis; Decision Logic"
  },
  {
    "id": "SYS-063",
    ...
    "fullTopic": "Systems Design & Analysis",
    "d": "medium",
    "q": "A retailer plans to implement a demand-forecasting platform that processes sales data from thousands of stores every hour. The software meets functional needs, but analysts are uncertain whether current servers, network capacity, and database performance can support the projected workload. Which feasibility question is MOST directly being evaluated?",
    "opts": [
    ...
    "a": 3,
    "exp": "Correct answer is supported by the concept coverage: Technical • Feasibility • Capacity • Planning. Reference: Feasibility Analysis; Technical Requirements.",
    "objective": "Systems Design & Analysis",
    "conceptCoverage": "Technical • Feasibility • Capacity • Planning",
  ...
  },
  {
    ...
    "fullTopic": "Systems Design & Analysis",
    "d": "medium",
    "q": "An analyst models a vendor-payment process. The Accounts Payable process retrieves invoice data from the Invoice Repository, sends approved-payment information to the Bank Interface, and updates the Vendor Account record. Which statement BEST describes a data flow in this model?",
    "opts": [
    ...
    "a": 1,
    "exp": "Correct answer is supported by the concept coverage: Data • Flow • Diagrams • Data • Movement. Reference: Structured Analysis; Data Flow Diagram Components.",
    "objective": "Systems Design & Analysis",
    "conceptCoverage": "Data • Flow • Diagrams • Data • Movement",
    "reference": "Structured Analysis; Data Flow Diagram Components"
  },
  {
    "id": "SYS-065",
    ...
    "fullTopic": "Systems Design & Analysis",
    "d": "medium",
    "q": "A hospital defines the following requirement for a patient-portal project: “Patients must be able to review laboratory results after the ordering provider releases them.” Which addition would MOST improve the requirement’s testability without changing its intended function?",
    "opts": [
    ...
    "a": 2,
    "exp": "Correct answer is supported by the concept coverage: Functional • Requirements • Acceptance • Criteria. Reference: Requirements Specification; Requirements Quality.",
    "objective": "Systems Design & Analysis",
    "conceptCoverage": "Functional • Requirements • Acceptance • Criteria",
  ...
  },
  {
    ...
    "a": 0,
    "exp": "Correct answer is supported by the concept coverage: Pilot • Conversion • Risk • Reduction. Reference: System Implementation; Conversion Strategies.",
    "objective": "Systems Design & Analysis",
    "conceptCoverage": "Pilot • Conversion • Risk • Reduction",
    "reference": "System Implementation; Conversion Strategies"
  },
  {
    "id": "SYS-067",
    ...
    "fullTopic": "Systems Design & Analysis",
    "d": "medium",
    "q": "A logistics company is evaluating a fleet-tracking system. The proposal estimates implementation and support costs, expected reductions in fuel use, fewer missed deliveries, lower overtime, and improved customer retention. Which purpose is MOST directly served by this analysis?",
    "opts": [
    ...
    "a": 1,
    "exp": "Correct answer is supported by the concept coverage: Feasibility • Analysis • Cost-Benefit • Evaluation. Reference: Systems Proposal; Cost-Benefit Analysis.",
    "objective": "Systems Design & Analysis",
    "conceptCoverage": "Feasibility • Analysis • Cost-Benefit • Evaluation",
  ...
  },
  {
    ...
    "fullTopic": "Systems Design & Analysis",
    "d": "medium",
    "q": "A retailer stores customer information in a Customer table and purchase information in an Order table. Each order must reference the customer who placed it, while each customer may be associated with many orders. Which implementation best preserves this relationship?",
    "opts": [
    ...
    "a": 3,
    "exp": "Correct answer is supported by the concept coverage: Data • Modeling • Primary • and • Foreign • Keys. Reference: Database Design; Entity Relationship Diagrams.",
    "objective": "Systems Design & Analysis",
    "conceptCoverage": "Data • Modeling • Primary • and • Foreign • Keys",
  ...
  },
  {
    ...
    "fullTopic": "Systems Design & Analysis",
    "d": "medium",
    "q": "A procurement system allows employees to create purchase requests, supervisors to approve requests up to assigned limits, and finance personnel to release payment. The system denies approval attempts when a user lacks the required role or when the request exceeds the user’s authorization threshold. Which control is MOST directly represented?",
    "opts": [
    ...
    "a": 2,
    "exp": "Correct answer is supported by the concept coverage: System • Controls • Authorization. Reference: Internal Controls; Access Management.",
    "objective": "Systems Design & Analysis",
    "conceptCoverage": "System • Controls • Authorization",
  ...
  },
  {
    ...
    "a": 0,
    "exp": "Correct answer is supported by the concept coverage: Agile • Development • Sprint • Review. Reference: Agile Development; Iterative Delivery.",
    "objective": "Systems Design & Analysis",
    "conceptCoverage": "Agile • Development • Sprint • Review",
  ...
  },
  {
    ...
    "fullTopic": "Systems Design & Analysis",
    "d": "medium",
    "q": "A team is modeling a travel-booking system. Customers search flights and reserve itineraries, travel agents modify bookings on behalf of customers, and payment processors authorize transactions. Which statement BEST describes the role of these entities in a use-case diagram?",
    "opts": [
    ...
    "a": 1,
    "exp": "Correct answer is supported by the concept coverage: Use-Case • Diagrams • Actors. Reference: UML; Use-Case Modeling.",
    "objective": "Systems Design & Analysis",
    "conceptCoverage": "Use-Case • Diagrams • Actors",
    "reference": "UML; Use-Case Modeling"
  },
  {
    "id": "SYS-072",
    ...
    "a": 3,
    "exp": "Correct answer is supported by the concept coverage: Preventive • Maintenance. Reference: System Maintenance; Maintenance Types.",
    "objective": "Systems Design & Analysis",
    "conceptCoverage": "Preventive • Maintenance",
    "reference": "System Maintenance; Maintenance Types"
  },
  {
    "id": "SYS-073",
    ...
    "fullTopic": "Systems Design & Analysis",
    "d": "medium",
    "q": "A retailer is planning the first release of a mobile ordering application. Stakeholders want loyalty rewards, delivery tracking, saved payment methods, product search, and accessibility improvements. The team has limited capacity and notes that delivery tracking depends on core order-status functionality that has not yet been built. Which prioritization approach is MOST appropriate?",
    "opts": [
    ...
    "a": 1,
    "exp": "Correct answer is supported by the concept coverage: Requirements • Prioritization • Dependencies. Reference: Requirements Management; Project Scope.",
    "objective": "Systems Design & Analysis",
    "conceptCoverage": "Requirements • Prioritization • Dependencies",
    "reference": "Requirements Management; Project Scope"
  },
  {
    "id": "SYS-074",
    ...
    "fullTopic": "Systems Design & Analysis",
    "d": "medium",
    "q": "A development team needs to document how objects interact when a customer places an online order. The model must show the order in which the website validates the cart, requests payment authorization, updates inventory, and sends confirmation. Which UML diagram BEST satisfies this need?",
    "opts": [
    ...
    "a": 0,
    "exp": "Correct answer is supported by the concept coverage: Sequence • Diagrams • Object • Interaction. Reference: UML; Sequence Modeling.",
    "objective": "Systems Design & Analysis",
    "conceptCoverage": "Sequence • Diagrams • Object • Interaction",
    "reference": "UML; Sequence Modeling"
  },
  {
    "id": "SYS-075",
    ...
    "fullTopic": "Systems Design & Analysis",
    "d": "medium",
    "q": "Following implementation of a new enterprise purchasing system, project leaders compare planned and actual costs, adoption rates, processing times, control exceptions, and realized savings. They also document which implementation decisions improved outcomes and which created avoidable delays. What is the PRIMARY purpose of this activity?",
    "opts": [
    ...
    "a": 1,
    "exp": "Correct answer is supported by the concept coverage: Post-Implementation • Review • Lessons • Learned. Reference: System Evaluation; Benefits Realization.",
    "objective": "Systems Design & Analysis",
    "conceptCoverage": "Post-Implementation • Review • Lessons • Learned",
    "reference": "System Evaluation; Benefits Realization"
  },
  {
    ...
    "a": 1,
    "exp": "Correct answer is supported by the concept coverage: Joint • Application • Design • Stakeholder • Alignment. Reference: Requirements Gathering; Joint Application Design.",
    "objective": "Systems Design & Analysis",
    "conceptCoverage": "Joint • Application • Design • Stakeholder • Alignment",
  ...
  },
  {
    ...
    "a": 3,
    "exp": "Correct answer is supported by the concept coverage: Use-Case • Relationships • Extending • Behavior. Reference: UML; Use-Case Modeling.",
    "objective": "Systems Design & Analysis",
    "conceptCoverage": "Use-Case • Relationships • Extending • Behavior",
    "reference": "UML; Use-Case Modeling"
  },
  {
    "id": "SYS-078",
    ...
    "fullTopic": "Systems Design & Analysis",
    "d": "medium",
    "q": "A transportation company needs dispatch software. Most required functionality is available in established commercial products, but the company’s proprietary routing algorithm provides a competitive advantage and must remain under internal control. Which strategy BEST balances implementation speed with strategic differentiation?",
    "opts": [
    ...
    "a": 0,
    "exp": "Correct answer is supported by the concept coverage: Build • vs. • Buy • Strategic • Fit. Reference: Alternative Systems-Building Approaches; Application Packages.",
    "objective": "Systems Design & Analysis",
    "conceptCoverage": "Build • vs. • Buy • Strategic • Fit",
  ...
  },
  {
    ...
    "fullTopic": "Systems Design & Analysis",
    "d": "medium",
    "q": "An analyst is reviewing a data flow diagram for a purchase-order system. One process is labeled “Purchase Order,” receives requisition data, accesses supplier records, and produces an approved order. Which revision would MOST improve the diagram’s clarity?",
    "opts": [
    ...
    "a": 2,
    "exp": "Correct answer is supported by the concept coverage: Data • Flow • Diagrams • Process • Definition. Reference: Structured Analysis; Data Flow Diagram Components.",
    "objective": "Systems Design & Analysis",
    "conceptCoverage": "Data • Flow • Diagrams • Process • Definition",
    "reference": "Structured Analysis; Data Flow Diagram Components"
  },
  {
    "id": "SYS-080",
    ...
    "a": 1,
    "exp": "Correct answer is supported by the concept coverage: Requirements • Prioritization • Regulatory • Constraints. Reference: Requirements Management; Business Rules.",
    "objective": "Systems Design & Analysis",
    "conceptCoverage": "Requirements • Prioritization • Regulatory • Constraints",
  ...
  },
  {
    ...
    "a": 3,
    "exp": "Correct answer is supported by the concept coverage: Phased • Conversion • Implementation • Strategy. Reference: System Implementation; Conversion Strategies.",
    "objective": "Systems Design & Analysis",
    "conceptCoverage": "Phased • Conversion • Implementation • Strategy",
    "reference": "System Implementation; Conversion Strategies"
  },
  {
    "id": "SYS-082",
    ...
    "fullTopic": "Systems Design & Analysis",
    "d": "medium",
    "q": "A design team has already documented required reports, workflow rules, user roles, and data relationships for a new claims application. It now selects a cloud database platform, defines encryption standards, specifies server capacity, and determines network connectivity between offices. Which stage of design is being performed?",
    "opts": [
    ...
    "a": 0,
    "exp": "Correct answer is supported by the concept coverage: Physical • Design • Technical • Architecture. Reference: Systems Design; Physical Design.",
    "objective": "Systems Design & Analysis",
    "conceptCoverage": "Physical • Design • Technical • Architecture",
  ...
  },
  {
    ...
    "fullTopic": "Systems Design & Analysis",
    "d": "medium",
    "q": "A city develops a clickable prototype for a new online parking-permit application. Residents can complete simulated submissions, but the prototype does not store real permits, process payments, or integrate with enforcement systems. What is the PRIMARY value of this prototype at the current stage?",
    "opts": [
    ...
    "a": 2,
    "exp": "Correct answer is supported by the concept coverage: Prototyping • Interface • Validation. Reference: Alternative Development Approaches; Prototyping.",
    "objective": "Systems Design & Analysis",
    "conceptCoverage": "Prototyping • Interface • Validation",
    "reference": "Alternative Development Approaches; Prototyping"
  },
  {
    "id": "SYS-084",
    ...
    "a": 1,
    "exp": "Correct answer is supported by the concept coverage: System • Testing • End-to-End • Workflows. Reference: Testing and Implementation; System Testing.",
    "objective": "Systems Design & Analysis",
    "conceptCoverage": "System • Testing • End-to-End • Workflows",
  ...
  },
  {
    ...
    "fullTopic": "Systems Design & Analysis",
    "d": "medium",
    "q": "A retailer plans to replace a store-inventory application before its busiest holiday period. The project team identifies the risk that synchronization failures could cause inaccurate stock availability during launch. Which response BEST represents an appropriate contingency plan?",
    "opts": [
    ...
    "a": 3,
    "exp": "Correct answer is supported by the concept coverage: Risk • Assessment • Contingency • Planning. Reference: System Implementation; Project Risk Management.",
    "objective": "Systems Design & Analysis",
    "conceptCoverage": "Risk • Assessment • Contingency • Planning",
  ...
  },
  {
    ...
    "fullTopic": "Systems Design & Analysis",
    "d": "medium",
    "q": "An insurance company must document claim-routing rules involving policy status, loss amount, fraud indicators, prior claims, and jurisdiction. Analysts need to ensure that every relevant combination of conditions produces a defined routing action. Which artifact is MOST suitable?",
    "opts": [
    ...
    "a": 0,
    "exp": "Correct answer is supported by the concept coverage: Decision • Tables • Complex • Rules. Reference: Structured Analysis; Decision Logic.",
    "objective": "Systems Design & Analysis",
    "conceptCoverage": "Decision • Tables • Complex • Rules",
    "reference": "Structured Analysis; Decision Logic"
  },
  {
    "id": "SYS-087",
    ...
    "a": 2,
    "exp": "Correct answer is supported by the concept coverage: Audit • Trails • Accountability. Reference: System Controls; Audit Controls.",
    "objective": "Systems Design & Analysis",
    "conceptCoverage": "Audit • Trails • Accountability",
  ...
  },
  {
    ...
    "a": 1,
    "exp": "Correct answer is supported by the concept coverage: Data • Migration • Reconciliation. Reference: System Implementation; Data Conversion.",
    "objective": "Systems Design & Analysis",
    "conceptCoverage": "Data • Migration • Reconciliation",
  ...
  },
  {
    ...
    "fullTopic": "Systems Design & Analysis",
    "d": "medium",
    "q": "After deploying a new employee-expense system, executives find that processing time improved as expected, but adoption remains low among field personnel because the mobile interface was excluded from the original scope. During the review, what should leadership MOST appropriately assess?",
    "opts": [
    ...
    "a": 3,
    "exp": "Correct answer is supported by the concept coverage: Post-Implementation • Review • Scope • Governance. Reference: System Evaluation; Benefits Realization.",
    "objective": "Systems Design & Analysis",
    "conceptCoverage": "Post-Implementation • Review • Scope • Governance",
    "reference": "System Evaluation; Benefits Realization"
  },
  {
    "id": "SYS-090",
    ...
    "fullTopic": "Systems Design & Analysis",
    "d": "medium",
    "q": "Which SDLC phase focuses primarily on defining the business problem, gathering information requirements, assessing alternatives, and determining what the proposed information system must accomplish?",
    "opts": [
      "Systems design",
      "Implementation",
      "Systems analysis",
    ...
    "a": 2,
    "exp": "Correct answer is supported by the concept coverage: Recall • SDLC • Phases. Reference: Systems Development Life Cycle; Systems Analysis.",
    "objective": "Systems Design & Analysis",
    "conceptCoverage": "Recall • SDLC • Phases",
  ...
  },
  {
    ...
    "a": 1,
    "exp": "Correct answer is supported by the concept coverage: Requirements • Elicitation • Document • Analysis. Reference: Requirements Gathering; Business Process Analysis.",
    "objective": "Systems Design & Analysis",
    "conceptCoverage": "Requirements • Elicitation • Document • Analysis",
    "reference": "Requirements Gathering; Business Process Analysis"
  },
  {
    "id": "SYS-092",
    ...
    "fullTopic": "Systems Design & Analysis",
    "d": "medium",
    "q": "A project requirement for a customer-service portal states, “The system should quickly display relevant account information in an easy-to-use format.” Before approving the requirement, the project manager asks for revision. Which change would MOST improve its quality?",
    "opts": [
    ...
    "a": 3,
    "exp": "Correct answer is supported by the concept coverage: Requirements • Quality • Ambiguity. Reference: Requirements Specification; Acceptance Criteria.",
    "objective": "Systems Design & Analysis",
    "conceptCoverage": "Requirements • Quality • Ambiguity",
  ...
  },
  {
    ...
    "fullTopic": "Systems Design & Analysis",
    "d": "medium",
    "q": "A distribution company introduces handheld scanners that automatically capture package IDs, update delivery status, and transmit proof of delivery to the central system. Drivers still follow the same route-assignment process, delivery sequence, and exception-handling procedures used before implementation. Which type of organizational change is MOST accurately represented?",
    "opts": [
    ...
    "a": 0,
    "exp": "Correct answer is supported by the concept coverage: Business • Process • Automation. Reference: Organizational Change; Systems Analysis.",
    "objective": "Systems Design & Analysis",
    "conceptCoverage": "Business • Process • Automation",
  ...
  },
  {
    ...
    "fullTopic": "Systems Design & Analysis",
    "d": "medium",
    "q": "An analyst is modeling a university tuition-payment system. The model includes Student, Payment Processor, Student Account Database, and Record Payment. Which item should be represented as an external entity rather than a process or data store?",
    "opts": [
    ...
    "a": 2,
    "exp": "Correct answer is supported by the concept coverage: Data • Flow • Diagrams • External • Entities. Reference: Structured Analysis; Data Flow Diagram Components.",
    "objective": "Systems Design & Analysis",
    "conceptCoverage": "Data • Flow • Diagrams • External • Entities",
    "reference": "Structured Analysis; Data Flow Diagram Components"
  },
  {
    "id": "SYS-095",
    ...
    "fullTopic": "Systems Design & Analysis",
    "d": "medium",
    "q": "A nonprofit’s grant-management system allows program staff to submit reimbursement requests, finance staff to approve payments, and accounting staff to reconcile completed disbursements. Management wants to prevent any one employee from initiating, approving, and recording the same payment. Which design principle MOST directly supports this objective?",
    "opts": [
    ...
    "a": 1,
    "exp": "Correct answer is supported by the concept coverage: System • Controls • Segregation • of • Duties. Reference: Internal Controls; Authorization.",
    "objective": "Systems Design & Analysis",
    "conceptCoverage": "System • Controls • Segregation • of • Duties",
  ...
  },
  {
    ...
    "a": 3,
    "exp": "Correct answer is supported by the concept coverage: Prototype • Evaluation • Technical • Limitations. Reference: Alternative Development Approaches; Prototyping.",
    "objective": "Systems Design & Analysis",
    "conceptCoverage": "Prototype • Evaluation • Technical • Limitations",
    "reference": "Alternative Development Approaches; Prototyping"
  },
  {
    "id": "SYS-097",
    ...
    "fullTopic": "Systems Design & Analysis",
    "d": "medium",
    "q": "A consulting firm maintains records for Consultants and Projects. A consultant may be assigned to no projects during a given month, while every active project must have at least one assigned consultant. Which statement BEST describes the relationship constraint?",
    "opts": [
    ...
    "a": 2,
    "exp": "Correct answer is supported by the concept coverage: Entity • Relationship • Diagrams • Optionality. Reference: Data Modeling; Entity Relationships.",
    "objective": "Systems Design & Analysis",
    "conceptCoverage": "Entity • Relationship • Diagrams • Optionality",
  ...
  },
  {
    ...
    "a": 0,
    "exp": "Correct answer is supported by the concept coverage: Feasibility • Analysis • Economic • Feasibility. Reference: Systems Proposal; Cost-Benefit Analysis.",
    "objective": "Systems Design & Analysis",
    "conceptCoverage": "Feasibility • Analysis • Economic • Feasibility",
    "reference": "Systems Proposal; Cost-Benefit Analysis"
  },
  {
    "id": "SYS-099",
    ...
    "fullTopic": "Systems Design & Analysis",
    "d": "medium",
    "q": "A project team maintains a matrix linking each approved business requirement to design components, test cases, and implementation deliverables. During testing, a quality analyst identifies a requirement that has no associated test case. What is the MOST appropriate interpretation?",
    "opts": [
    ...
    "a": 1,
    "exp": "Correct answer is supported by the concept coverage: Requirements • Traceability • Testing. Reference: Requirements Management; Test Planning.",
    "objective": "Systems Design & Analysis",
    "conceptCoverage": "Requirements • Traceability • Testing",
  ...
  },
  {
    ...
    "fullTopic": "Systems Design & Analysis",
    "d": "medium",
    "q": "An airline needs to document refund decisions based on ticket type, cancellation timing, loyalty status, and whether a disruption was caused by the airline. Analysts must ensure that each relevant combination produces a defined outcome, such as full refund, travel credit, or no refund. Which artifact is MOST suitable?",
    "opts": [
  ...
  },
  {
    ...
    "a": 3,
    "exp": "Correct answer is supported by the concept coverage: Change • Management • Communication • Planning. Reference: Organizational Feasibility; Implementation.",
    "objective": "Systems Design & Analysis",
    "conceptCoverage": "Change • Management • Communication • Planning",
  ...
  },
  {
    ...
    "a": 0,
    "exp": "Correct answer is supported by the concept coverage: Recovery • Controls • Business • Continuity. Reference: System Controls; Recovery Planning.",
    "objective": "Systems Design & Analysis",
    "conceptCoverage": "Recovery • Controls • Business • Continuity",
  ...
  },
  {
    ...
    "fullTopic": "Systems Design & Analysis",
    "d": "medium",
    "q": "A product team is preparing its next development cycle for a claims-tracking application. Several backlog items are broad, lack acceptance criteria, and have unclear dependencies on external data sources. Before selecting items for the next iteration, what should the team do?",
    "opts": [
    ...
    "a": 2,
    "exp": "Correct answer is supported by the concept coverage: Agile • Development • Backlog • Refinement. Reference: Agile Development; Iterative Planning.",
    "objective": "Systems Design & Analysis",
    "conceptCoverage": "Agile • Development • Backlog • Refinement",
  ...
  },
  {
    ...
    "fullTopic": "Systems Design & Analysis",
    "d": "medium",
    "q": "Which activity is MOST clearly part of physical system design rather than logical system design?",
    "opts": [
    ...
    "a": 1,
    "exp": "Correct answer is supported by the concept coverage: Recall • Physical • Design. Reference: Systems Design; Physical Design.",
    "objective": "Systems Design & Analysis",
    "conceptCoverage": "Recall • Physical • Design",
    "reference": "Systems Design; Physical Design"
  },
  {
    "id": "SYS-105",
  ...
  },
  {
    ...
    "fullTopic": "Systems Design & Analysis",
    "d": "medium",
    "q": "A university is replacing its research-grant system. Faculty want flexible budget transfers between grant categories, while finance staff require approvals before any transfer exceeding a fixed threshold. Both groups agree that the current process is slow, but they disagree about when oversight is necessary. What should the analyst do before documenting the final requirement?",
    "opts": [
    ...
    "a": 2,
    "exp": "Correct answer is supported by the concept coverage: Requirements • Elicitation • Conflict • Resolution. Reference: Requirements Gathering; Stakeholder Analysis.",
    "objective": "Systems Design & Analysis",
    "conceptCoverage": "Requirements • Elicitation • Conflict • Resolution",
  ...
  },
  {
    ...
    "a": 0,
    "exp": "Correct answer is supported by the concept coverage: Data • Validation • Referential • Integrity. Reference: System Controls; Data Integrity.",
    "objective": "Systems Design & Analysis",
    "conceptCoverage": "Data • Validation • Referential • Integrity",
  ...
  },
  {
    ...
    "fullTopic": "Systems Design & Analysis",
    "d": "medium",
    "q": "A new privacy regulation requires a claims platform to retain consent records for a longer period. The project manager uses a traceability matrix to identify affected requirements, database fields, reports, interfaces, test cases, and operating procedures. What is the PRIMARY value of this activity?",
    "opts": [
    ...
    "a": 3,
    "exp": "Correct answer is supported by the concept coverage: Requirements • Traceability • Impact • Analysis. Reference: Requirements Management; Change Control.",
    "objective": "Systems Design & Analysis",
    "conceptCoverage": "Requirements • Traceability • Impact • Analysis",
  ...
  },
  {
    ...
    "a": 1,
    "exp": "Correct answer is supported by the concept coverage: Structured • Analysis • Process • Specifications. Reference: Structured Analysis; Process Modeling.",
    "objective": "Systems Design & Analysis",
    "conceptCoverage": "Structured • Analysis • Process • Specifications",
  ...
  },
  {
    ...
    "fullTopic": "Systems Design & Analysis",
    "d": "medium",
    "q": "A project team has completed requirements analysis for a new inventory application. Stakeholders approve the documented requirements, and the project manager establishes a formal baseline before design begins. What is the PRIMARY purpose of creating this baseline?",
    "opts": [
    ...
    "a": 2,
    "exp": "Correct answer is supported by the concept coverage: Requirements • Baseline • Scope • Stability. Reference: Requirements Management; Project Scope.",
    "objective": "Systems Design & Analysis",
    "conceptCoverage": "Requirements • Baseline • Scope • Stability",
    "reference": "Requirements Management; Project Scope"
  },
  {
    "id": "SYS-111",
    ...
    "a": 0,
    "exp": "Correct answer is supported by the concept coverage: Feasibility • Analysis • Operational • Metrics. Reference: Feasibility Study; Operational Feasibility.",
    "objective": "Systems Design & Analysis",
    "conceptCoverage": "Feasibility • Analysis • Operational • Metrics",
  ...
  },
  {
    ...
    "a": 3,
    "exp": "Correct answer is supported by the concept coverage: User • Acceptance • Testing • Acceptance • Criteria. Reference: Testing and Implementation; Validation.",
    "objective": "Systems Design & Analysis",
    "conceptCoverage": "User • Acceptance • Testing • Acceptance • Criteria",
    "reference": "Testing and Implementation; Validation"
  },
  {
    "id": "SYS-113",
    ...
    "fullTopic": "Systems Design & Analysis",
    "d": "medium",
    "q": "A retailer’s return policy changes frequently because of seasonal promotions, product categories, and regulatory requirements. The system currently embeds each rule directly within application code, making updates slow and error-prone. Which design choice would MOST improve maintainability?",
    "opts": [
    ...
    "a": 1,
    "exp": "Correct answer is supported by the concept coverage: Business • Rules • Rule • Maintenance. Reference: Requirements Specification; Business Rules.",
    "objective": "Systems Design & Analysis",
    "conceptCoverage": "Business • Rules • Rule • Maintenance",
    "reference": "Requirements Specification; Business Rules"
  },
  {
    "id": "SYS-114",
    ...
    "fullTopic": "Systems Design & Analysis",
    "d": "medium",
    "q": "An analyst’s data flow diagram shows a Customer entity sending an order directly into the Order Database without passing through any process. The analyst argues that the database simply records what the customer submits. What is the MOST appropriate revision?",
    "opts": [
    ...
    "a": 2,
    "exp": "Correct answer is supported by the concept coverage: Data • Flow • Diagrams • Data • Stores. Reference: Structured Analysis; DFD Rules.",
    "objective": "Systems Design & Analysis",
    "conceptCoverage": "Data • Flow • Diagrams • Data • Stores",
  ...
  },
  {
    ...
    "a": 0,
    "exp": "Correct answer is supported by the concept coverage: Build • vs. • Buy • Total • Cost • of • Ownership. Reference: Alternative Systems-Building Approaches; Systems Proposal.",
    "objective": "Systems Design & Analysis",
    "conceptCoverage": "Build • vs. • Buy • Total • Cost • of • Ownership",
  ...
  },
  {
    ...
    "a": 3,
    "exp": "Correct answer is supported by the concept coverage: Agile • Development • Definition • of • Done. Reference: Agile Development; Iterative Delivery.",
    "objective": "Systems Design & Analysis",
    "conceptCoverage": "Agile • Development • Definition • of • Done",
    "reference": "Agile Development; Iterative Delivery"
  },
  {
    "id": "SYS-117",
    ...
    "fullTopic": "Systems Design & Analysis",
    "d": "medium",
    "q": "A bank pilots a replacement loan-origination system at one branch. The pilot meets performance targets, but employees identify two workflow changes that improve processing speed and reduce duplicate data entry. What should the project team do before expanding deployment?",
    "opts": [
    ...
    "a": 1,
    "exp": "Correct answer is supported by the concept coverage: Conversion • Strategies • Pilot • Evaluation. Reference: System Implementation; Pilot Conversion.",
    "objective": "Systems Design & Analysis",
    "conceptCoverage": "Conversion • Strategies • Pilot • Evaluation",
  ...
  },
  {
    ...
    "fullTopic": "Systems Design & Analysis",
    "d": "medium",
    "q": "A chief operating officer requests a dashboard showing average order cycle time, fulfillment accuracy, inventory exceptions, and delayed shipments by region. Before selecting visualizations or technology, what should the analyst clarify FIRST?",
    "opts": [
    ...
    "a": 2,
    "exp": "Correct answer is supported by the concept coverage: Information • Requirements • Management • Reporting. Reference: Systems Analysis; Information Requirements.",
    "objective": "Systems Design & Analysis",
    "conceptCoverage": "Information • Requirements • Management • Reporting",
  ...
  },
  {
    ...
    "fullTopic": "Systems Design & Analysis",
    "d": "medium",
    "q": "In an entity relationship diagram, what term describes the minimum and maximum number of instances of one entity that can be associated with an instance of another entity?",
    "opts": [
      "Cardinality",
      "Normalization",
      "Encapsulation",
    ...
    "a": 0,
    "exp": "Correct answer is supported by the concept coverage: Recall • Entity • Relationship • Diagrams. Reference: Data Modeling; Entity Relationship Diagrams.",
    "objective": "Systems Design & Analysis",
    "conceptCoverage": "Recall • Entity • Relationship • Diagrams",
    "reference": "Data Modeling; Entity Relationship Diagrams"
  },
  {
    "id": "SYS-120",
    ...
    "fullTopic": "Systems Design & Analysis",
    "d": "medium",
    "q": "Six months after implementing a customer-service platform, executives find that call time has improved but first-contact resolution remains below the project target. Analysis shows that agents cannot easily access prior interaction history during complex calls. What is the MOST appropriate next step?",
    "opts": [
    ...
    "a": 1,
    "exp": "Correct answer is supported by the concept coverage: Post-Implementation • Review • Corrective • Action. Reference: System Evaluation; Benefits Realization.",
    "objective": "Systems Design & Analysis",
    "conceptCoverage": "Post-Implementation • Review • Corrective • Action",
    "reference": "System Evaluation; Benefits Realization"
  },
  {
    "id": "SYS-121",
    ...
    "fullTopic": "Systems Design & Analysis",
    "d": "medium",
    "q": "A regional utility is redesigning its outage-management system. Dispatchers, field crews, customer-service staff, and safety officers disagree about how outage priority should be assigned during severe weather. Leadership wants a facilitated process that resolves conflicting definitions, identifies exceptions, and produces jointly approved business rules within a limited timeframe. Which method is MOST appropriate?",
    "opts": [
    ...
    "a": 1,
    "exp": "Correct answer is supported by the concept coverage: Requirements • Elicitation • Joint • Application • Design. Reference: Requirements Gathering; Stakeholder Collaboration.",
    "objective": "Systems Design & Analysis",
    "conceptCoverage": "Requirements • Elicitation • Joint • Application • Design",
    "reference": "Requirements Gathering; Stakeholder Collaboration"
  },
  {
    "id": "SYS-122",
    ...
    "a": 3,
    "exp": "Correct answer is supported by the concept coverage: Data • Flow • Diagrams • Process • Boundaries. Reference: Structured Analysis; Data Flow Diagram Rules.",
    "objective": "Systems Design & Analysis",
    "conceptCoverage": "Data • Flow • Diagrams • Process • Boundaries",
  ...
  },
  {
    ...
    "a": 0,
    "exp": "Correct answer is supported by the concept coverage: Requirements • Traceability • Change • Impact. Reference: Requirements Management; Change Control.",
    "objective": "Systems Design & Analysis",
    "conceptCoverage": "Requirements • Traceability • Change • Impact",
    "reference": "Requirements Management; Change Control"
  },
  {
    "id": "SYS-124",
    ...
    "a": 2,
    "exp": "Correct answer is supported by the concept coverage: Feasibility • Analysis • Operational • Feasibility. Reference: Feasibility Study; Organizational Change.",
    "objective": "Systems Design & Analysis",
    "conceptCoverage": "Feasibility • Analysis • Operational • Feasibility",
    "reference": "Feasibility Study; Organizational Change"
  },
  {
    "id": "SYS-125",
    ...
    "a": 1,
    "exp": "Correct answer is supported by the concept coverage: Requirements • Prioritization • Dependencies. Reference: Requirements Management; Release Planning.",
    "objective": "Systems Design & Analysis",
    "conceptCoverage": "Requirements • Prioritization • Dependencies",
  ...
  },
  {
    ...
    "a": 0,
    "exp": "Correct answer is supported by the concept coverage: Prototyping • Requirement • Validation. Reference: Alternative Development Approaches; Prototyping.",
    "objective": "Systems Design & Analysis",
    "conceptCoverage": "Prototyping • Requirement • Validation",
    "reference": "Alternative Development Approaches; Prototyping"
  },
  {
    "id": "SYS-127",
    ...
    "fullTopic": "Systems Design & Analysis",
    "d": "medium",
    "q": "A procurement system requires users to select a supplier from an approved-vendor list before submitting a purchase request. It rejects expired supplier accounts, missing tax identifiers, and requests that exceed the requester’s allowed purchasing category. Which objective is MOST directly supported by these controls?",
    "opts": [
    ...
    "a": 2,
    "exp": "Correct answer is supported by the concept coverage: System • Controls • Input • Validation. Reference: Controls in System Design; Data Integrity.",
    "objective": "Systems Design & Analysis",
    "conceptCoverage": "System • Controls • Input • Validation",
  ...
  },
  {
    ...
    "a": 2,
    "exp": "Correct answer is supported by the concept coverage: Logical • vs. • Physical • Design. Reference: System Design; Logical and Physical Design.",
    "objective": "Systems Design & Analysis",
    "conceptCoverage": "Logical • vs. • Physical • Design",
  ...
  },
  {
    ...
    "fullTopic": "Systems Design & Analysis",
    "d": "medium",
    "q": "An insurance company must document claims-routing rules involving policy status, injury severity, fraud indicators, prior claims, and jurisdiction. Analysts need to ensure that every meaningful combination of conditions leads to a defined action, such as automatic payment, specialist review, or investigation. Which artifact is MOST suitable?",
    "opts": [
    ...
    "a": 0,
    "exp": "Correct answer is supported by the concept coverage: Decision • Tables • Complex • Business • Rules. Reference: Structured Analysis; Decision Logic.",
    "objective": "Systems Design & Analysis",
    "conceptCoverage": "Decision • Tables • Complex • Business • Rules",
    "reference": "Structured Analysis; Decision Logic"
  },
  {
    "id": "SYS-130",
  ...
  },
  {
    ...
    "a": 1,
    "exp": "Correct answer is supported by the concept coverage: Testing • Regression • Testing. Reference: System Maintenance; Testing.",
    "objective": "Systems Design & Analysis",
    "conceptCoverage": "Testing • Regression • Testing",
  ...
  },
  {
    ...
    "fullTopic": "Systems Design & Analysis",
    "d": "medium",
    "q": "A new developer must determine the permitted values, character length, business meaning, source, and update rules for a field named CLAIM_DISPOSITION. The developer also needs to know which processes create or modify that field. Which artifact should be reviewed FIRST?",
    "opts": [
  ...
  },
  {
    ...
    "fullTopic": "Systems Design & Analysis",
    "d": "medium",
    "q": "Which UML diagram is designed to show the time-ordered messages exchanged among objects or components during a transaction, such as validating a cart, authorizing payment, updating inventory, and sending an order confirmation?",
    "opts": [
      "Use-case diagram",
      "Sequence diagram",
      "Class diagram",
    ...
    "a": 1,
    "exp": "Correct answer is supported by the concept coverage: Recall • UML • Sequence • Diagrams. Reference: UML; Interaction Modeling.",
    "objective": "Systems Design & Analysis",
    "conceptCoverage": "Recall • UML • Sequence • Diagrams",
  ...
  },
  {
    ...
    "a": 3,
    "exp": "Correct answer is supported by the concept coverage: Recovery • Controls • Business • Continuity. Reference: System Controls; Recovery and Continuity Planning.",
    "objective": "Systems Design & Analysis",
    "conceptCoverage": "Recovery • Controls • Business • Continuity",
  ...
  },
  {
    ...
    "fullTopic": "Systems Design & Analysis",
    "d": "medium",
    "q": "A hospital is redesigning its discharge-planning system. Case managers want discharge orders to be released as soon as clinical criteria are met, while compliance staff require additional documentation for certain high-risk patients. Both groups agree that delays are costly, but they disagree about which cases require enhanced review. What should the systems analyst do FIRST?",
    "opts": [
    ...
    "a": 2,
    "exp": "Correct answer is supported by the concept coverage: Requirements • Conflict • Business • Rules. Reference: Requirements Analysis; Stakeholder Reconciliation.",
    "objective": "Systems Design & Analysis",
    "conceptCoverage": "Requirements • Conflict • Business • Rules",
  ...
  },
  {
    ...
    "a": 0,
    "exp": "Correct answer is supported by the concept coverage: Data • Flow • Diagrams • Balancing. Reference: Structured Analysis; DFD Decomposition.",
    "objective": "Systems Design & Analysis",
    "conceptCoverage": "Data • Flow • Diagrams • Balancing",
  ...
  },
  {
    ...
    "a": 3,
    "exp": "Correct answer is supported by the concept coverage: Financial • Feasibility • Total • Cost • of • Ownership. Reference: Feasibility Analysis; Cost-Benefit Evaluation.",
    "objective": "Systems Design & Analysis",
    "conceptCoverage": "Financial • Feasibility • Total • Cost • of • Ownership",
  ...
  },
  {
    ...
    "a": 1,
    "exp": "Correct answer is supported by the concept coverage: Requirements • Validation • Stakeholder • Walkthrough. Reference: Requirements Analysis; Requirements Review.",
    "objective": "Systems Design & Analysis",
    "conceptCoverage": "Requirements • Validation • Stakeholder • Walkthrough",
  ...
  },
  {
    ...
    "fullTopic": "Systems Design & Analysis",
    "d": "medium",
    "q": "Which UML diagram is MOST appropriate for showing how application components are deployed across servers, databases, network nodes, and execution environments?",
    "opts": [
      "Use-case diagram",
      "Activity diagram",
      "Deployment diagram",
    ...
    "a": 2,
    "exp": "Correct answer is supported by the concept coverage: Recall • UML • Deployment • Diagrams. Reference: UML; Physical Architecture Modeling.",
    "objective": "Systems Design & Analysis",
    "conceptCoverage": "Recall • UML • Deployment • Diagrams",
  ...
  },
  {
    ...
    "a": 3,
    "exp": "Correct answer is supported by the concept coverage: Integration • Testing • Interface • Failures. Reference: Testing and Implementation; Integration Testing.",
    "objective": "Systems Design & Analysis",
    "conceptCoverage": "Integration • Testing • Interface • Failures",
  ...
  },
  {
    ...
    "fullTopic": "Systems Design & Analysis",
    "d": "medium",
    "q": "After requirements for a customer-service platform are approved, an executive requests a new analytics dashboard that would require additional data integration and delay the planned launch. The feature may be valuable, but it was not included in the original baseline. What should the project manager do FIRST?",
    "opts": [
    ...
    "a": 0,
    "exp": "Correct answer is supported by the concept coverage: Change • Control • Project • Baseline. Reference: Requirements Management; Scope Governance.",
    "objective": "Systems Design & Analysis",
    "conceptCoverage": "Change • Control • Project • Baseline",
  ...
  },
  {
    ...
    "fullTopic": "Systems Design & Analysis",
    "d": "medium",
    "q": "A nonprofit database tracks Donors and Donations. A donor may not yet have made a donation, but every recorded donation must be associated with one donor. Which statement BEST represents the participation constraint?",
    "opts": [
    ...
    "a": 1,
    "exp": "Correct answer is supported by the concept coverage: Entity • Relationship • Diagrams • Optionality. Reference: Data Modeling; Cardinality and Participation.",
    "objective": "Systems Design & Analysis",
    "conceptCoverage": "Entity • Relationship • Diagrams • Optionality",
  ...
  },
  {
    ...
    "a": 2,
    "exp": "Correct answer is supported by the concept coverage: Outsourcing • Service-Level • Agreements. Reference: Outsourcing; Vendor Governance.",
    "objective": "Systems Design & Analysis",
    "conceptCoverage": "Outsourcing • Service-Level • Agreements",
  ...
  },
  {
    ...
    "a": 1,
    "exp": "Correct answer is supported by the concept coverage: Agile • Development • Backlog • Prioritization. Reference: Agile Development; Product Backlog.",
    "objective": "Systems Design & Analysis",
    "conceptCoverage": "Agile • Development • Backlog • Prioritization",
    "reference": "Agile Development; Product Backlog"
  },
  {
    "id": "SYS-147",
    ...
    "a": 0,
    "exp": "Correct answer is supported by the concept coverage: Recovery • Controls • Restore • Testing. Reference: System Controls; Business Continuity.",
    "objective": "Systems Design & Analysis",
    "conceptCoverage": "Recovery • Controls • Restore • Testing",
    "reference": "System Controls; Business Continuity"
  },
  {
    "id": "SYS-148",
    ...
    "a": 3,
    "exp": "Correct answer is supported by the concept coverage: Logical • Design • Interface • Requirements. Reference: Systems Design; Logical Design.",
    "objective": "Systems Design & Analysis",
    "conceptCoverage": "Logical • Design • Interface • Requirements",
    "reference": "Systems Design; Logical Design"
  },
  {
    "id": "SYS-149",
    ...
    "fullTopic": "Systems Design & Analysis",
    "d": "medium",
    "q": "Six months after deploying a new warehouse system, management finds that inventory accuracy improved, but fulfillment speed remains below target because employees still use a manual approval spreadsheet before releasing certain orders. What should leadership do MOST appropriately?",
    "opts": [
    ...
    "a": 2,
    "exp": "Correct answer is supported by the concept coverage: Post-Implementation • Review • Corrective • Planning. Reference: System Evaluation; Benefits Realization.",
    "objective": "Systems Design & Analysis",
    "conceptCoverage": "Post-Implementation • Review • Corrective • Planning",
    "reference": "System Evaluation; Benefits Realization"
  },
  {
    "id": "SYS-150",
    ...
    "a": 1,
    "exp": "Correct answer is supported by the concept coverage: Application • Packages • Configuration • vs. • Customization. Reference: Alternative Systems-Building Approaches; Application Packages.",
    "objective": "Systems Design & Analysis",
    "conceptCoverage": "Application • Packages • Configuration • vs. • Customization",
    "reference": "Alternative Systems-Building Approaches; Application Packages"
  },
  {
    "id": "SYS-151",
    ...
    "a": 2,
    "exp": "Correct answer is supported by the concept coverage: Requirements • Elicitation • Observation. Reference: Requirements Gathering; Business Process Analysis.",
    "objective": "Systems Design & Analysis",
    "conceptCoverage": "Requirements • Elicitation • Observation",
    "reference": "Requirements Gathering; Business Process Analysis"
  },
  {
    "id": "SYS-152",
    ...
    "fullTopic": "Systems Design & Analysis",
    "d": "medium",
    "q": "A team begins documenting a university financial-aid application. It first identifies the broad function “Process Financial Aid,” then divides it into Verify Eligibility, Calculate Award, Review Exceptions, and Notify Student. Which analysis technique is MOST clearly being used?",
    "opts": [
    ...
    "a": 0,
    "exp": "Correct answer is supported by the concept coverage: Functional • Decomposition • Structured • Analysis. Reference: Structured Analysis; Process Modeling.",
    "objective": "Systems Design & Analysis",
    "conceptCoverage": "Functional • Decomposition • Structured • Analysis",
    "reference": "Structured Analysis; Process Modeling"
  },
  {
    "id": "SYS-153",
    ...
    "a": 3,
    "exp": "Correct answer is supported by the concept coverage: Feasibility • Analysis • Legal • and • Regulatory • Constraints. Reference: Feasibility Study; Compliance Requirements.",
    "objective": "Systems Design & Analysis",
    "conceptCoverage": "Feasibility • Analysis • Legal • and • Regulatory • Constraints",
  ...
  },
  {
    ...
    "a": 1,
    "exp": "Correct answer is supported by the concept coverage: Data • Modeling • Candidate • Keys. Reference: Data Modeling; Entity Identification.",
    "objective": "Systems Design & Analysis",
    "conceptCoverage": "Data • Modeling • Candidate • Keys",
  ...
  },
  {
    ...
    "a": 2,
    "exp": "Correct answer is supported by the concept coverage: Requirements • Prioritization • Risk-Based • Planning. Reference: Requirements Management; Project Scope.",
    "objective": "Systems Design & Analysis",
    "conceptCoverage": "Requirements • Prioritization • Risk-Based • Planning",
    "reference": "Requirements Management; Project Scope"
  },
  {
    "id": "SYS-156",
    ...
    "fullTopic": "Systems Design & Analysis",
    "d": "medium",
    "q": "A systems analyst is preparing a context diagram for a new hotel-reservation platform. Which element should be placed outside the system boundary as an external entity rather than inside the reservation system?",
    "opts": [
    ...
    "a": 0,
    "exp": "Correct answer is supported by the concept coverage: System • Boundaries • Context • Diagrams. Reference: Structured Analysis; Context Diagram.",
    "objective": "Systems Design & Analysis",
    "conceptCoverage": "System • Boundaries • Context • Diagrams",
  ...
  },
  {
    ...
    "fullTopic": "Systems Design & Analysis",
    "d": "medium",
    "q": "A development team repeatedly postpones refactoring poorly structured code in order to complete new customer-facing features. Over time, changes take longer, defects increase, and developers struggle to estimate work accurately. Which action BEST addresses the underlying issue?",
    "opts": [
    ...
    "a": 3,
    "exp": "Correct answer is supported by the concept coverage: Agile • Development • Technical • Debt. Reference: Agile Development; Iterative Delivery.",
    "objective": "Systems Design & Analysis",
    "conceptCoverage": "Agile • Development • Technical • Debt",
    "reference": "Agile Development; Iterative Delivery"
  },
  {
    "id": "SYS-158",
    ...
    "a": 1,
    "exp": "Correct answer is supported by the concept coverage: Data • Migration • Transformation • Rules. Reference: System Implementation; Data Conversion.",
    "objective": "Systems Design & Analysis",
    "conceptCoverage": "Data • Migration • Transformation • Rules",
    "reference": "System Implementation; Data Conversion"
  },
  {
    "id": "SYS-159",
    ...
    "fullTopic": "Systems Design & Analysis",
    "d": "medium",
    "q": "A requirement for an emergency-notification platform states, “The system must handle large volumes of alerts during severe weather.” Which revision would BEST create a testable nonfunctional requirement?",
    "opts": [
    ...
    "a": 0,
    "exp": "Correct answer is supported by the concept coverage: Acceptance • Criteria • Nonfunctional • Requirements. Reference: Requirements Specification; Performance Criteria.",
    "objective": "Systems Design & Analysis",
    "conceptCoverage": "Acceptance • Criteria • Nonfunctional • Requirements",
  ...
  },
  {
    ...
    "fullTopic": "Systems Design & Analysis",
    "d": "medium",
    "q": "A chief financial officer requests a monthly dashboard showing revenue variance, overdue receivables, cash-flow projections, and regional performance. Before selecting charts or designing screen layouts, what should the analyst determine FIRST?",
    "opts": [
    ...
    "a": 2,
    "exp": "Correct answer is supported by the concept coverage: Output • Design • Management • Information. Reference: Systems Design; Output Requirements.",
    "objective": "Systems Design & Analysis",
    "conceptCoverage": "Output • Design • Management • Information",
  ...
  },
  {
    ...
    "fullTopic": "Systems Design & Analysis",
    "d": "medium",
    "q": "A payroll application permits reimbursement claims from $0.01 through $5,000.00 without supervisor approval, while any amount above $5,000.00 requires additional review. Which test set BEST applies boundary value analysis?",
    "opts": [
    ...
    "a": 1,
    "exp": "Correct answer is supported by the concept coverage: Testing • Boundary • Value • Analysis. Reference: Test Planning; Input Validation.",
    "objective": "Systems Design & Analysis",
    "conceptCoverage": "Testing • Boundary • Value • Analysis",
  ...
  },
  {
    ...
    "fullTopic": "Systems Design & Analysis",
    "d": "medium",
    "q": "A financial-services firm determines that its trading application must be restored within two hours after a major system outage to avoid unacceptable operational and regulatory consequences. Which disaster-recovery metric is the firm defining?",
    "opts": [
    ...
    "a": 3,
    "exp": "Correct answer is supported by the concept coverage: Disaster • Recovery • Recovery • Time • Objective. Reference: Business Continuity; Recovery Planning.",
    "objective": "Systems Design & Analysis",
    "conceptCoverage": "Disaster • Recovery • Recovery • Time • Objective",
  ...
  },
  {
    ...
    "fullTopic": "Systems Design & Analysis",
    "d": "medium",
    "q": "A health-insurance system works as designed, but a new federal reporting rule requires additional diagnosis fields and a modified submission format. Developers update the system to comply before the new rule takes effect. Which type of maintenance is MOST accurately represented?",
    "opts": [
    ...
    "a": 0,
    "exp": "Correct answer is supported by the concept coverage: System • Maintenance • Adaptive • Maintenance. Reference: System Maintenance; Maintenance Types.",
    "objective": "Systems Design & Analysis",
    "conceptCoverage": "System • Maintenance • Adaptive • Maintenance",
    "reference": "System Maintenance; Maintenance Types"
  },
  {
    "id": "SYS-164",
    ...
    "a": 2,
    "exp": "Correct answer is supported by the concept coverage: Build • vs. • Buy • Vendor • Lock-In. Reference: Alternative Systems-Building Approaches; Outsourcing.",
    "objective": "Systems Design & Analysis",
    "conceptCoverage": "Build • vs. • Buy • Vendor • Lock-In",
  ...
  },
  {
    ...
    "fullTopic": "Systems Design & Analysis",
    "d": "medium",
    "q": "Six months after a new procurement platform is deployed, invoice-processing time has improved, but the number of duplicate-payment exceptions remains unchanged. Review findings show that some departments continue entering invoice data outside the system before uploading it later. What should project leadership do MOST appropriately?",
    "opts": [
    ...
    "a": 1,
    "exp": "Correct answer is supported by the concept coverage: Post-Implementation • Review • Root • Cause • Analysis. Reference: System Evaluation; Benefits Realization.",
    "objective": "Systems Design & Analysis",
    "conceptCoverage": "Post-Implementation • Review • Root • Cause • Analysis",
    "reference": "System Evaluation; Benefits Realization"
  },
  {
    "id": "SYS-166",
    ...
    "a": 2,
    "exp": "Correct answer is supported by the concept coverage: Requirements • Traceability • Regulatory • Change. Reference: Requirements Management; Change Impact Analysis.",
    "objective": "Systems Design & Analysis",
    "conceptCoverage": "Requirements • Traceability • Regulatory • Change",
  ...
  },
  {
    ...
    "fullTopic": "Systems Design & Analysis",
    "d": "medium",
    "q": "Which artifact is MOST appropriate when analysts need to document a set of business rules in which several combinations of conditions lead to distinct actions?",
    "opts": [
    ...
    "a": 0,
    "exp": "Correct answer is supported by the concept coverage: Recall • Decision • Tables. Reference: Structured Analysis; Decision Logic.",
    "objective": "Systems Design & Analysis",
    "conceptCoverage": "Recall • Decision • Tables",
    "reference": "Structured Analysis; Decision Logic"
  },
  {
    "id": "SYS-168",
    ...
    "a": 3,
    "exp": "Correct answer is supported by the concept coverage: Business • Rules • Management • Maintainability. Reference: Requirements Specification; System Design.",
    "objective": "Systems Design & Analysis",
    "conceptCoverage": "Business • Rules • Management • Maintainability",
  ...
  },
  {
    ...
    "fullTopic": "Systems Design & Analysis",
    "d": "medium",
    "q": "A company compares two customer-service platforms. One requires a high initial implementation investment but low annual support costs. The other has minimal startup cost but recurring subscription, integration, and data-storage charges that increase with transaction volume. Which analysis is MOST appropriate?",
    "opts": [
    ...
    "a": 1,
    "exp": "Correct answer is supported by the concept coverage: Economic • Feasibility • Cost • Classification. Reference: Feasibility Analysis; Cost-Benefit Analysis.",
    "objective": "Systems Design & Analysis",
    "conceptCoverage": "Economic • Feasibility • Cost • Classification",
  ...
  },
  {
    ...
    "fullTopic": "Systems Design & Analysis",
    "d": "medium",
    "q": "A completed pharmacy application is tested in a controlled environment using integrated prescription, inventory, insurance, and notification workflows. Testers verify that the system performs required functions across modules before pharmacists begin formal acceptance testing. Which type of testing is MOST directly being performed?",
    "opts": [
    ...
    "a": 2,
    "exp": "Correct answer is supported by the concept coverage: System • Testing • vs. • User • Acceptance • Testing. Reference: Testing and Implementation; Validation.",
    "objective": "Systems Design & Analysis",
    "conceptCoverage": "System • Testing • vs. • User • Acceptance • Testing",
    "reference": "Testing and Implementation; Validation"
  },
  {
    "id": "SYS-171",
    ...
    "fullTopic": "Systems Design & Analysis",
    "d": "medium",
    "q": "A chief operating officer wants a dashboard for monitoring order delays. Before choosing charts, color schemes, or dashboard software, the analyst asks which decisions the executive will make, which metrics should trigger action, how current the information must be, and whether regional drill-down is needed. What is the analyst primarily determining?",
    "opts": [
    ...
    "a": 0,
    "exp": "Correct answer is supported by the concept coverage: Output • Design • Management • Information. Reference: Systems Design; Reporting Requirements.",
    "objective": "Systems Design & Analysis",
    "conceptCoverage": "Output • Design • Management • Information",
  ...
  },
  {
    ...
    "a": 1,
    "exp": "Correct answer is supported by the concept coverage: Agile • Development • Prototyping. Reference: Alternative Development Approaches; Agile Methods.",
    "objective": "Systems Design & Analysis",
    "conceptCoverage": "Agile • Development • Prototyping",
  ...
  },
  {
    ...
    "fullTopic": "Systems Design & Analysis",
    "d": "medium",
    "q": "A utility company plans to run its legacy billing system and a replacement platform for two complete billing cycles. The company will compare calculated charges, tax treatment, account balances, and exception handling before retiring the older application. Which trade-off BEST characterizes this approach?",
    "opts": [
    ...
    "a": 2,
    "exp": "Correct answer is supported by the concept coverage: Parallel • Conversion • Implementation • Risk. Reference: System Implementation; Conversion Strategies.",
    "objective": "Systems Design & Analysis",
    "conceptCoverage": "Parallel • Conversion • Implementation • Risk",
    "reference": "System Implementation; Conversion Strategies"
  },
  {
    "id": "SYS-175",
    ...
    "fullTopic": "Systems Design & Analysis",
    "d": "medium",
    "q": "A hospital prepares to migrate patient-contact information to a replacement scheduling system. Analysts find duplicate patient records, inconsistent phone-number formats, outdated addresses, and missing preferred-language values. Which activity should occur before final conversion?",
    "opts": [
    ...
    "a": 0,
    "exp": "Correct answer is supported by the concept coverage: Data • Cleansing • Data • Quality. Reference: Data Conversion; Data Preparation.",
    "objective": "Systems Design & Analysis",
    "conceptCoverage": "Data • Cleansing • Data • Quality",
  ...
  },
  {
    ...
    "fullTopic": "Systems Design & Analysis",
    "d": "medium",
    "q": "A financial institution determines that, after a major outage, it can tolerate losing no more than fifteen minutes of transaction data. Which metric is the institution defining?",
    "opts": [
    ...
    "a": 3,
    "exp": "Correct answer is supported by the concept coverage: Recall • Recovery • Point • Objective. Reference: Business Continuity; Recovery Planning.",
    "objective": "Systems Design & Analysis",
    "conceptCoverage": "Recall • Recovery • Point • Objective",
    "reference": "Business Continuity; Recovery Planning"
  },
  {
    "id": "SYS-177",
    ...
    "fullTopic": "Systems Design & Analysis",
    "d": "medium",
    "q": "A university has completed analysis for a research-administration platform. Leadership asks for a document that explains the business problem, compares feasible alternatives, estimates costs and benefits, identifies risks, and recommends an approach for approval. What should the analysis team prepare?",
    "opts": [
  ...
  },
  {
    ...
    "fullTopic": "Systems Design & Analysis",
    "d": "medium",
    "q": "A lender wants a visual representation of loan-review logic in which each branch reflects a sequence of conditions, such as credit score, collateral coverage, and requested amount, leading to approval, denial, or escalation. Which artifact would BEST meet this need?",
    "opts": [
    ...
    "a": 2,
    "exp": "Correct answer is supported by the concept coverage: Decision • Trees • Rule • Visualization. Reference: Structured Analysis; Decision Logic.",
    "objective": "Systems Design & Analysis",
    "conceptCoverage": "Decision • Trees • Rule • Visualization",
    "reference": "Structured Analysis; Decision Logic"
  },
  {
    "id": "SYS-179",
    ...
    "fullTopic": "Systems Design & Analysis",
    "d": "medium",
    "q": "Six months after implementing a purchasing platform, the organization achieves faster approval times but still experiences duplicate-payment exceptions. Review findings show that some departments create invoice spreadsheets outside the system, then upload summary information later. What should leadership do MOST appropriately?",
    "opts": [
  ...
  },
  {
    ...
    "fullTopic": "Systems Design & Analysis",
    "d": "medium",
    "q": "A software team maintains records of approved versions of requirements, design documents, source code, test cases, and deployment packages. Before a release, the team confirms that all components are compatible, approved, and traceable to the planned version. What practice is MOST directly represented?",
    "opts": [
    ...
    "a": 1,
    "exp": "Correct answer is supported by the concept coverage: Configuration • Management • Change • Governance. Reference: System Development Controls; Configuration Management.",
    "objective": "Systems Design & Analysis",
    "conceptCoverage": "Configuration • Management • Change • Governance",
    "reference": "System Development Controls; Configuration Management"
  },
  {
    "id": "OOP-001",
    "t": "OOP",
    "fullTopic": "Object-Oriented Programming Concepts",
    "d": "medium",
    "q": "A vehicle-rental application must track each vehicle’s mileage, fuel level, maintenance status, daily rate, and availability. It must also support operations such as reserve, return, calculateCharge, and scheduleMaintenance. Which design approach BEST applies object-oriented principles?",
    "opts": [
    ...
    "a": 1,
    "exp": "Correct answer is supported by the concept coverage: Classes • Objects • Attributes • Methods. Reference: Object-Oriented Analysis and Design.",
    "objective": "Object-Oriented Programming Concepts",
    "conceptCoverage": "Classes • Objects • Attributes • Methods",
  ...
  },
  {
    ...
    "fullTopic": "Object-Oriented Programming Concepts",
    "d": "medium",
    "q": "A payroll application stores an employee’s hourly rate as a private attribute. The rate can be changed only through an updatePayRate method that checks the manager’s authorization and confirms that the proposed rate falls within an approved range. What is the PRIMARY benefit of this design?",
    "opts": [
    ...
    "a": 3,
    "exp": "Correct answer is supported by the concept coverage: Encapsulation • Data • Integrity. Reference: Object-Oriented Design Principles.",
    "objective": "Object-Oriented Programming Concepts",
    "conceptCoverage": "Encapsulation • Data • Integrity",
  ...
  },
  {
    ...
    "fullTopic": "Object-Oriented Programming Concepts",
    "d": "medium",
    "q": "A university system includes Student, FacultyMember, and StaffMember classes. All three require a university ID, name, email address, and authentication behavior, but each role has unique responsibilities and data. Which design would MOST effectively reduce duplicated code?",
    "opts": [
    ...
    "a": 0,
    "exp": "Correct answer is supported by the concept coverage: Inheritance • Code • Reuse. Reference: Object-Oriented Analysis and Design.",
    "objective": "Object-Oriented Programming Concepts",
    "conceptCoverage": "Inheritance • Code • Reuse",
    "reference": "Object-Oriented Analysis and Design"
  },
  {
    "id": "OOP-004",
    ...
    "fullTopic": "Object-Oriented Programming Concepts",
    "d": "medium",
    "q": "An e-commerce application accepts credit-card payments, digital-wallet payments, and bank transfers. Each payment method must support a processPayment operation, but its authorization and confirmation steps differ. Which design approach BEST supports this requirement?",
    "opts": [
    ...
    "a": 2,
    "exp": "Correct answer is supported by the concept coverage: Polymorphism • Interfaces. Reference: Object-Oriented Programming Fundamentals.",
    "objective": "Object-Oriented Programming Concepts",
    "conceptCoverage": "Polymorphism • Interfaces",
  ...
  },
  {
    ...
    "fullTopic": "Object-Oriented Programming Concepts",
    "d": "medium",
    "q": "A hospital scheduling application allows staff to book appointments without exposing the internal logic that checks provider availability, applies visit-type restrictions, identifies conflicts, and selects appointment slots. Which object-oriented principle is MOST clearly illustrated?",
    "opts": [
    ...
    "a": 1,
    "exp": "Correct answer is supported by the concept coverage: Abstraction. Reference: Object-Oriented Analysis and Design.",
    "objective": "Object-Oriented Programming Concepts",
    "conceptCoverage": "Abstraction",
    "reference": "Object-Oriented Analysis and Design"
  },
  {
    "id": "OOP-006",
    ...
    "fullTopic": "Object-Oriented Programming Concepts",
    "d": "medium",
    "q": "A logistics system creates a Shipment object when an order is released for fulfillment. At creation, the application assigns a shipment number, sets the status to Pending, records a destination, and initializes an empty list of packages. Which class component is MOST appropriate for this work?",
    "opts": [
    ...
    "a": 3,
    "exp": "Correct answer is supported by the concept coverage: Constructors • Object • Initialization. Reference: Object-Oriented Programming Fundamentals.",
    "objective": "Object-Oriented Programming Concepts",
    "conceptCoverage": "Constructors • Object • Initialization",
    "reference": "Object-Oriented Programming Fundamentals"
  },
  {
    "id": "OOP-007",
    ...
    "fullTopic": "Object-Oriented Programming Concepts",
    "d": "medium",
    "q": "A restaurant point-of-sale system models an Order containing multiple OrderLine objects. When an order is permanently deleted, its line items should not remain as independent objects because they have no meaning outside the order that created them. Which relationship BEST represents this design?",
    "opts": [
    ...
    "a": 0,
    "exp": "Correct answer is supported by the concept coverage: Composition • Object • Lifecycles. Reference: Object-Oriented Analysis and Design.",
    "objective": "Object-Oriented Programming Concepts",
    "conceptCoverage": "Composition • Object • Lifecycles",
    "reference": "Object-Oriented Analysis and Design"
  },
  {
    "id": "OOP-008",
    ...
    "fullTopic": "Object-Oriented Programming Concepts",
    "d": "medium",
    "q": "A property-management application includes a general Lease class with a calculateMonthlyCharge method. CommercialLease objects must include common-area fees, while ResidentialLease objects include selected utilities. Which implementation is MOST appropriate?",
    "opts": [
    ...
    "a": 2,
    "exp": "Correct answer is supported by the concept coverage: Method • Overriding • Subclasses. Reference: Object-Oriented Programming Fundamentals.",
    "objective": "Object-Oriented Programming Concepts",
    "conceptCoverage": "Method • Overriding • Subclasses",
    "reference": "Object-Oriented Programming Fundamentals"
  },
  {
    "id": "OOP-009",
    ...
    "fullTopic": "Object-Oriented Programming Concepts",
    "d": "medium",
    "q": "Which access modifier is MOST appropriate when an attribute should be directly available only within its own class and accessed by other classes through controlled methods?",
    "opts": [
      "Public",
      "Private",
      "Static",
    ...
    "a": 1,
    "exp": "Correct answer is supported by the concept coverage: Recall • Access • Modifiers. Reference: Object-Oriented Programming Fundamentals.",
    "objective": "Object-Oriented Programming Concepts",
    "conceptCoverage": "Recall • Access • Modifiers",
    "reference": "Object-Oriented Programming Fundamentals"
  },
  {
    "id": "OOP-010",
    ...
    "a": 3,
    "exp": "Correct answer is supported by the concept coverage: Association • Many-to-Many • Relationships. Reference: Object-Oriented Analysis and Design.",
    "objective": "Object-Oriented Programming Concepts",
    "conceptCoverage": "Association • Many-to-Many • Relationships",
    "reference": "Object-Oriented Analysis and Design"
  },
  {
    "id": "OOP-011",
    ...
    "fullTopic": "Object-Oriented Programming Concepts",
    "d": "medium",
    "q": "A development team creates an Employee class that stores employee identity information, calculates payroll, manages building-access permissions, schedules training, produces tax filings, and creates expense reports. Which revision would MOST improve cohesion?",
    "opts": [
    ...
    "a": 0,
    "exp": "Correct answer is supported by the concept coverage: Cohesion • Class • Design. Reference: Object-Oriented Design Principles.",
    "objective": "Object-Oriented Programming Concepts",
    "conceptCoverage": "Cohesion • Class • Design",
    "reference": "Object-Oriented Design Principles"
  },
  {
    "id": "OOP-012",
    ...
    "fullTopic": "Object-Oriented Programming Concepts",
    "d": "medium",
    "q": "A shipping application’s OrderService directly creates and controls a specific third-party carrier API class throughout its code. When the company changes carriers, developers must revise numerous OrderService methods. Which redesign would MOST reduce coupling?",
    "opts": [
    ...
    "a": 2,
    "exp": "Correct answer is supported by the concept coverage: Coupling • Dependency • Inversion. Reference: Object-Oriented Design Principles.",
    "objective": "Object-Oriented Programming Concepts",
    "conceptCoverage": "Coupling • Dependency • Inversion",
    "reference": "Object-Oriented Design Principles"
  },
  {
    "id": "OOP-013",
    ...
    "fullTopic": "Object-Oriented Programming Concepts",
    "d": "medium",
    "q": "A retail application must maintain one shared counter that assigns the next available customer-service ticket number, regardless of how many Ticket objects exist. Which implementation is MOST appropriate?",
    "opts": [
    ...
    "a": 1,
    "exp": "Correct answer is supported by the concept coverage: Static • Members. Reference: Object-Oriented Programming Fundamentals.",
    "objective": "Object-Oriented Programming Concepts",
    "conceptCoverage": "Static • Members",
    "reference": "Object-Oriented Programming Fundamentals"
  },
  {
    "id": "OOP-014",
    ...
    "fullTopic": "Object-Oriented Programming Concepts",
    "d": "medium",
    "q": "A development team wants EmailNotification, SMSNotification, and PushNotification classes to guarantee that each provides a send method. The classes do not need to share stored data or a common implementation. Which construct BEST fits this requirement?",
    "opts": [
    ...
    "a": 3,
    "exp": "Correct answer is supported by the concept coverage: Recall • Interface • vs. • Abstract • Class. Reference: Object-Oriented Programming Fundamentals.",
    "objective": "Object-Oriented Programming Concepts",
    "conceptCoverage": "Recall • Interface • vs. • Abstract • Class",
    "reference": "Object-Oriented Programming Fundamentals"
  },
  {
    "id": "OOP-015",
    ...
    "a": 0,
    "exp": "Correct answer is supported by the concept coverage: Object-Oriented • Analysis • Domain • Modeling. Reference: Object-Oriented Analysis and Design.",
    "objective": "Object-Oriented Programming Concepts",
    "conceptCoverage": "Object-Oriented • Analysis • Domain • Modeling",
    "reference": "Object-Oriented Analysis and Design"
  },
  {
    "id": "OOP-016",
    ...
    "a": 1,
    "exp": "Correct answer is supported by the concept coverage: Encapsulation • Accessor • and • Mutator • Methods. Reference: Object-Oriented Programming Fundamentals.",
    "objective": "Object-Oriented Programming Concepts",
    "conceptCoverage": "Encapsulation • Accessor • and • Mutator • Methods",
    "reference": "Object-Oriented Programming Fundamentals"
  },
  {
    "id": "OOP-017",
    ...
    "fullTopic": "Object-Oriented Programming Concepts",
    "d": "medium",
    "q": "A logistics application has Truck, Van, and Drone delivery classes. All must store an identifier, current location, and delivery status, and all must provide a calculateEstimatedArrival operation. However, each vehicle type uses a different calculation method. Which design is MOST appropriate?",
    "opts": [
    ...
    "a": 0,
    "exp": "Correct answer is supported by the concept coverage: Abstract • Classes • Shared • Behavior. Reference: Object-Oriented Programming Fundamentals.",
    "objective": "Object-Oriented Programming Concepts",
    "conceptCoverage": "Abstract • Classes • Shared • Behavior",
    "reference": "Object-Oriented Programming Fundamentals"
  },
  {
    "id": "OOP-018",
    ...
    "a": 2,
    "exp": "Correct answer is supported by the concept coverage: Method • Overloading. Reference: Object-Oriented Programming Fundamentals.",
    "objective": "Object-Oriented Programming Concepts",
    "conceptCoverage": "Method • Overloading",
    "reference": "Object-Oriented Programming Fundamentals"
  },
  {
    "id": "OOP-019",
    ...
    "fullTopic": "Object-Oriented Programming Concepts",
    "d": "medium",
    "q": "A university system links Course objects with Instructor objects. An instructor may teach different courses over time, and a course may be reassigned to another instructor. Removing a course from the schedule should not delete the instructor record. Which relationship BEST represents this model?",
    "opts": [
    ...
    "a": 1,
    "exp": "Correct answer is supported by the concept coverage: Association • vs. • Composition. Reference: Object-Oriented Analysis and Design.",
    "objective": "Object-Oriented Programming Concepts",
    "conceptCoverage": "Association • vs. • Composition",
    "reference": "Object-Oriented Analysis and Design"
  },
  {
    "id": "OOP-020",
    ...
    "a": 0,
    "exp": "Correct answer is supported by the concept coverage: Polymorphism • Dynamic • Dispatch. Reference: Object-Oriented Programming Fundamentals.",
    "objective": "Object-Oriented Programming Concepts",
    "conceptCoverage": "Polymorphism • Dynamic • Dispatch",
    "reference": "Object-Oriented Programming Fundamentals"
  },
  {
    "id": "OOP-021",
    ...
    "fullTopic": "Object-Oriented Programming Concepts",
    "d": "medium",
    "q": "A developer creates a ReportManager class that retrieves data, formats reports, sends emails, schedules jobs, manages user permissions, and stores audit logs. Changes to any of these areas regularly require edits to the same class. Which redesign would MOST improve maintainability?",
    "opts": [
    ...
    "a": 2,
    "exp": "Correct answer is supported by the concept coverage: Single • Responsibility • Principle. Reference: Object-Oriented Design Principles.",
    "objective": "Object-Oriented Programming Concepts",
    "conceptCoverage": "Single • Responsibility • Principle",
    "reference": "Object-Oriented Design Principles"
  },
  {
    "id": "OOP-022",
    ...
    "fullTopic": "Object-Oriented Programming Concepts",
    "d": "medium",
    "q": "An e-commerce platform sends order notifications through a messaging provider. Management wants the ability to switch among email, SMS, and third-party messaging services without changing the order-processing logic. Which design approach BEST supports this requirement?",
    "opts": [
    ...
    "a": 1,
    "exp": "Correct answer is supported by the concept coverage: Interfaces • Loose • Coupling. Reference: Object-Oriented Design Principles.",
    "objective": "Object-Oriented Programming Concepts",
    "conceptCoverage": "Interfaces • Loose • Coupling",
    "reference": "Object-Oriented Design Principles"
  },
  {
    "id": "OOP-023",
    ...
    "fullTopic": "Object-Oriented Programming Concepts",
    "d": "medium",
    "q": "A medical-record system creates a Patient object only when a medical-record number, legal name, and date of birth have been provided in valid form. The development team wants to prevent creation of Patient objects that are missing required identifying information. Where should this validation MOST appropriately occur?",
    "opts": [
    ...
    "a": 0,
    "exp": "Correct answer is supported by the concept coverage: Constructors • Validation. Reference: Object-Oriented Programming Fundamentals.",
    "objective": "Object-Oriented Programming Concepts",
    "conceptCoverage": "Constructors • Validation",
    "reference": "Object-Oriented Programming Fundamentals"
  },
  {
    "id": "OOP-024",
    ...
    "fullTopic": "Object-Oriented Programming Concepts",
    "d": "medium",
    "q": "A developer updates a TaxCalculator class. The only other class requiring modification is InvoiceService, which directly invokes TaxCalculator methods. In a UML class diagram, which relationship MOST accurately captures this situation?",
    "opts": [
    ...
    "a": 2,
    "exp": "Correct answer is supported by the concept coverage: Class • Diagrams • Dependencies. Reference: UML Class Modeling.",
    "objective": "Object-Oriented Programming Concepts",
    "conceptCoverage": "Class • Diagrams • Dependencies",
  ...
  },
  {
    ...
    "a": 1,
    "exp": "Correct answer is supported by the concept coverage: Immutable • Objects. Reference: Object-Oriented Design Principles.",
    "objective": "Object-Oriented Programming Concepts",
    "conceptCoverage": "Immutable • Objects",
    "reference": "Object-Oriented Design Principles"
  },
  {
    "id": "OOP-026",
    ...
    "fullTopic": "Object-Oriented Programming Concepts",
    "d": "medium",
    "q": "Which relationship best describes a Department object that contains Employee objects, while employees can continue to exist even if the department is dissolved or reorganized?",
    "opts": [
      "Composition",
      "Inheritance",
      "Aggregation",
    ...
    "a": 2,
    "exp": "Correct answer is supported by the concept coverage: Recall • Aggregation. Reference: Object-Oriented Analysis and Design.",
    "objective": "Object-Oriented Programming Concepts",
    "conceptCoverage": "Recall • Aggregation",
    "reference": "Object-Oriented Analysis and Design"
  },
  {
    "id": "OOP-027",
    ...
    "fullTopic": "Object-Oriented Programming Concepts",
    "d": "medium",
    "q": "A retail application initially makes DiscountedOrder inherit from Order. Later, the business requires that any order may combine multiple discount strategies, including loyalty rewards, promotional codes, and volume discounts. Which redesign is MOST flexible?",
    "opts": [
    ...
    "a": 0,
    "exp": "Correct answer is supported by the concept coverage: Favor • Composition • Over • Inheritance. Reference: Object-Oriented Design Principles.",
    "objective": "Object-Oriented Programming Concepts",
    "conceptCoverage": "Favor • Composition • Over • Inheritance",
    "reference": "Object-Oriented Design Principles"
  },
  {
    "id": "OOP-028",
    ...
    "fullTopic": "Object-Oriented Programming Concepts",
    "d": "medium",
    "q": "A document-management system expects any object derived from Document to support open, save, and archive operations. A new ReadOnlyDocument subclass throws an exception whenever save is called, even though application code routinely treats it as a standard Document. Which design concern is MOST directly raised?",
    "opts": [
    ...
    "a": 0,
    "exp": "Correct answer is supported by the concept coverage: Liskov • Substitution • Principle. Reference: Object-Oriented Design Principles.",
    "objective": "Object-Oriented Programming Concepts",
    "conceptCoverage": "Liskov • Substitution • Principle",
    "reference": "Object-Oriented Design Principles"
  },
  {
    "id": "OOP-029",
    ...
    "fullTopic": "Object-Oriented Programming Concepts",
    "d": "medium",
    "q": "A hotel-booking system must determine whether a room is available for a requested date range. The development team is deciding whether the Reservation object, Room object, or a separate AvailabilityService should own this responsibility. Which criterion is MOST useful when assigning the responsibility?",
    "opts": [
    ...
    "a": 1,
    "exp": "Correct answer is supported by the concept coverage: Object-Oriented • Analysis • Responsibility • Assignment. Reference: Object-Oriented Analysis and Design.",
    "objective": "Object-Oriented Programming Concepts",
    "conceptCoverage": "Object-Oriented • Analysis • Responsibility • Assignment",
    "reference": "Object-Oriented Analysis and Design"
  },
  {
    "id": "OOP-030",
    ...
    "fullTopic": "Object-Oriented Programming Concepts",
    "d": "medium",
    "q": "Which statement BEST describes an abstract method in an object-oriented language?",
    "opts": [
    ...
    "a": 3,
    "exp": "Correct answer is supported by the concept coverage: Recall • Abstract • Methods. Reference: Object-Oriented Programming Fundamentals.",
    "objective": "Object-Oriented Programming Concepts",
    "conceptCoverage": "Recall • Abstract • Methods",
    "reference": "Object-Oriented Programming Fundamentals"
  },
  {
    "id": "OOP-031",
    ...
    "a": 2,
    "exp": "Correct answer is supported by the concept coverage: Encapsulation • Class • Invariants. Reference: Object-Oriented Design Principles.",
    "objective": "Object-Oriented Programming Concepts",
    "conceptCoverage": "Encapsulation • Class • Invariants",
    "reference": "Object-Oriented Design Principles"
  },
  {
    "id": "OOP-032",
    ...
    "a": 1,
    "exp": "Correct answer is supported by the concept coverage: Inheritance • vs. • Composition. Reference: Object-Oriented Design Principles.",
    "objective": "Object-Oriented Programming Concepts",
    "conceptCoverage": "Inheritance • vs. • Composition",
    "reference": "Object-Oriented Design Principles"
  },
  {
    "id": "OOP-033",
    ...
    "fullTopic": "Object-Oriented Programming Concepts",
    "d": "medium",
    "q": "A tax system processes individual, corporate, and nonprofit filings. Each filing type must calculateTax, but the calculation differs according to its own rules. The processing module should handle all filings without checking every object’s specific class. Which design BEST supports this requirement?",
    "opts": [
    ...
    "a": 0,
    "exp": "Correct answer is supported by the concept coverage: Polymorphism • Common • Interface. Reference: Object-Oriented Programming Fundamentals.",
    "objective": "Object-Oriented Programming Concepts",
    "conceptCoverage": "Polymorphism • Common • Interface",
    "reference": "Object-Oriented Programming Fundamentals"
  },
  {
    "id": "OOP-034",
    ...
    "a": 3,
    "exp": "Correct answer is supported by the concept coverage: Object • Identity • vs. • Equality. Reference: Object-Oriented Programming Fundamentals.",
    "objective": "Object-Oriented Programming Concepts",
    "conceptCoverage": "Object • Identity • vs. • Equality",
    "reference": "Object-Oriented Programming Fundamentals"
  },
  {
    "id": "OOP-035",
    ...
    "fullTopic": "Object-Oriented Programming Concepts",
    "d": "medium",
    "q": "An order-processing class directly creates a specific payment-provider object whenever an order is submitted. The company wants to test alternative providers and switch vendors without changing order-processing code. Which approach BEST supports this goal?",
    "opts": [
    ...
    "a": 1,
    "exp": "Correct answer is supported by the concept coverage: Dependency • Injection • Loose • Coupling. Reference: Object-Oriented Design Principles.",
    "objective": "Object-Oriented Programming Concepts",
    "conceptCoverage": "Dependency • Injection • Loose • Coupling",
    "reference": "Object-Oriented Design Principles"
  },
  {
    "id": "OOP-036",
    ...
    "fullTopic": "Object-Oriented Programming Concepts",
    "d": "medium",
    "q": "A shipping application has a base Delivery class with an estimatedArrival method. DroneDelivery, GroundDelivery, and FreightDelivery each calculate estimated arrival differently because of weather, traffic, routing restrictions, and loading time. Which implementation is MOST appropriate?",
    "opts": [
    ...
    "a": 2,
    "exp": "Correct answer is supported by the concept coverage: Method • Overriding • Dynamic • Behavior. Reference: Object-Oriented Programming Fundamentals.",
    "objective": "Object-Oriented Programming Concepts",
    "conceptCoverage": "Method • Overriding • Dynamic • Behavior",
    "reference": "Object-Oriented Programming Fundamentals"
  },
  {
    "id": "OOP-037",
    ...
    "fullTopic": "Object-Oriented Programming Concepts",
    "d": "medium",
    "q": "A project-management application contains Project objects and Milestone objects. A milestone has no business meaning outside the project that created it, and deleting a project should remove its associated milestones from the application. Which relationship is MOST appropriate?",
    "opts": [
  ...
  },
  {
    ...
    "fullTopic": "Object-Oriented Programming Concepts",
    "d": "medium",
    "q": "A Customer class stores contact information but also calculates invoices, sends marketing emails, manages support tickets, generates analytics reports, and performs database backups. The class is frequently modified for unrelated reasons. Which redesign would MOST improve cohesion?",
    "opts": [
    ...
    "a": 3,
    "exp": "Correct answer is supported by the concept coverage: Cohesion • Responsibility • Assignment. Reference: Object-Oriented Design Principles.",
    "objective": "Object-Oriented Programming Concepts",
    "conceptCoverage": "Cohesion • Responsibility • Assignment",
    "reference": "Object-Oriented Design Principles"
  },
  {
    "id": "OOP-039",
    ...
    "fullTopic": "Object-Oriented Programming Concepts",
    "d": "medium",
    "q": "A hospital application models InpatientVisit, OutpatientVisit, and EmergencyVisit. Each visit must have a patient ID, start time, and status, while each type calculates charges differently. The team also wants to prevent direct creation of a generic Visit object. Which design BEST fits these needs?",
    "opts": [
    ...
    "a": 1,
    "exp": "Correct answer is supported by the concept coverage: Abstract • Classes • Shared • State. Reference: Object-Oriented Programming Fundamentals.",
    "objective": "Object-Oriented Programming Concepts",
    "conceptCoverage": "Abstract • Classes • Shared • State",
    "reference": "Object-Oriented Programming Fundamentals"
  },
  {
    "id": "OOP-040",
    ...
    "fullTopic": "Object-Oriented Programming Concepts",
    "d": "medium",
    "q": "A library application needs one shared counter that generates the next available library-card number, regardless of how many Patron objects exist. Which implementation is MOST appropriate?",
    "opts": [
    ...
    "a": 2,
    "exp": "Correct answer is supported by the concept coverage: Recall • Static • Members. Reference: Object-Oriented Programming Fundamentals.",
    "objective": "Object-Oriented Programming Concepts",
    "conceptCoverage": "Recall • Static • Members",
    "reference": "Object-Oriented Programming Fundamentals"
  },
  {
    "id": "OOP-041",
    ...
    "fullTopic": "Object-Oriented Programming Concepts",
    "d": "medium",
    "q": "A payment object attempts to authorize a transaction through an external provider. If the provider is unavailable, the application should preserve the order, record the failure, and allow a later retry without marking the order as paid. Which design approach BEST supports this behavior?",
    "opts": [
    ...
    "a": 0,
    "exp": "Correct answer is supported by the concept coverage: Exception • Handling • Object • State. Reference: Object-Oriented Programming Fundamentals.",
    "objective": "Object-Oriented Programming Concepts",
    "conceptCoverage": "Exception • Handling • Object • State",
    "reference": "Object-Oriented Programming Fundamentals"
  },
  {
    "id": "OOP-042",
    ...
    "a": 3,
    "exp": "Correct answer is supported by the concept coverage: Interface • Segregation. Reference: Object-Oriented Design Principles.",
    "objective": "Object-Oriented Programming Concepts",
    "conceptCoverage": "Interface • Segregation",
    "reference": "Object-Oriented Design Principles"
  },
  {
    "id": "OOP-043",
    ...
    "fullTopic": "Object-Oriented Programming Concepts",
    "d": "medium",
    "q": "A consulting firm tracks Departments and Consultants. Each department can have many consultants, but consultants may transfer between departments and must remain in the system even if a department is reorganized or eliminated. Which relationship BEST describes this model?",
    "opts": [
    ...
    "a": 1,
    "exp": "Correct answer is supported by the concept coverage: Aggregation • Independent • Lifecycles. Reference: Object-Oriented Analysis and Design.",
    "objective": "Object-Oriented Programming Concepts",
    "conceptCoverage": "Aggregation • Independent • Lifecycles",
    "reference": "Object-Oriented Analysis and Design"
  },
  {
    "id": "OOP-044",
    ...
    "a": 2,
    "exp": "Correct answer is supported by the concept coverage: Open-Closed • Principle. Reference: Object-Oriented Design Principles.",
    "objective": "Object-Oriented Programming Concepts",
    "conceptCoverage": "Open-Closed • Principle",
    "reference": "Object-Oriented Design Principles"
  },
  {
    "id": "OOP-045",
    ...
    "fullTopic": "Object-Oriented Programming Concepts",
    "d": "medium",
    "q": "Which statement BEST describes the primary purpose of a constructor in an object-oriented class?",
    "opts": [
    ...
    "a": 0,
    "exp": "Correct answer is supported by the concept coverage: Recall • Constructors. Reference: Object-Oriented Programming Fundamentals.",
    "objective": "Object-Oriented Programming Concepts",
    "conceptCoverage": "Recall • Constructors",
    "reference": "Object-Oriented Programming Fundamentals"
  },
  {
    "id": "OOP-046",
    ...
    "a": 1,
    "exp": "Correct answer is supported by the concept coverage: Encapsulation • Invariants • Controlled • State • Changes. Reference: Object-Oriented Design Principles.",
    "objective": "Object-Oriented Programming Concepts",
    "conceptCoverage": "Encapsulation • Invariants • Controlled • State • Changes",
    "reference": "Object-Oriented Design Principles"
  },
  {
    "id": "OOP-047",
    ...
    "fullTopic": "Object-Oriented Programming Concepts",
    "d": "medium",
    "q": "A hospital application uses a single interface requiring objects to schedule appointments, submit insurance claims, prescribe medication, and generate clinical reports. Several objects need only one or two of these capabilities. Which redesign BEST improves the model?",
    "opts": [
    ...
    "a": 3,
    "exp": "Correct answer is supported by the concept coverage: Interface • Segregation • Role-Specific • Behavior. Reference: Object-Oriented Design Principles.",
    "objective": "Object-Oriented Programming Concepts",
    "conceptCoverage": "Interface • Segregation • Role-Specific • Behavior",
    "reference": "Object-Oriented Design Principles"
  },
  {
    "id": "OOP-048",
    ...
    "a": 0,
    "exp": "Correct answer is supported by the concept coverage: Inheritance • Generalization. Reference: Object-Oriented Analysis and Design.",
    "objective": "Object-Oriented Programming Concepts",
    "conceptCoverage": "Inheritance • Generalization",
    "reference": "Object-Oriented Analysis and Design"
  },
  {
    "id": "OOP-049",
    ...
    "a": 2,
    "exp": "Correct answer is supported by the concept coverage: Polymorphism • Method • Dispatch. Reference: Object-Oriented Programming Fundamentals.",
    "objective": "Object-Oriented Programming Concepts",
    "conceptCoverage": "Polymorphism • Method • Dispatch",
    "reference": "Object-Oriented Programming Fundamentals"
  },
  {
    "id": "OOP-050",
    ...
    "fullTopic": "Object-Oriented Programming Concepts",
    "d": "medium",
    "q": "A manufacturing system contains WorkOrder objects and WorkStep objects. Each WorkStep belongs to one WorkOrder and has no operational meaning if its parent work order is permanently canceled and removed. Which relationship MOST accurately represents this design?",
    "opts": [
    ...
    "a": 1,
    "exp": "Correct answer is supported by the concept coverage: Composition • Lifecycle • Dependency. Reference: Object-Oriented Analysis and Design.",
    "objective": "Object-Oriented Programming Concepts",
    "conceptCoverage": "Composition • Lifecycle • Dependency",
    "reference": "Object-Oriented Analysis and Design"
  },
  {
    "id": "OOP-051",
    ...
    "fullTopic": "Object-Oriented Programming Concepts",
    "d": "medium",
    "q": "A retail application includes a base TaxRule class with a calculateTax method. StateTaxRule and InternationalTaxRule each require different calculations because they apply different rates, exemptions, and jurisdictional rules. Which implementation is MOST appropriate?",
    "opts": [
    ...
    "a": 0,
    "exp": "Correct answer is supported by the concept coverage: Method • Overriding • Specialized • Behavior. Reference: Object-Oriented Programming Fundamentals.",
    "objective": "Object-Oriented Programming Concepts",
    "conceptCoverage": "Method • Overriding • Specialized • Behavior",
    "reference": "Object-Oriented Programming Fundamentals"
  },
  {
    "id": "OOP-052",
    ...
    "fullTopic": "Object-Oriented Programming Concepts",
    "d": "medium",
    "q": "An order-processing service directly creates a specific shipping-carrier API client whenever an order is confirmed. Developers want to run unit tests using a simulated carrier and change providers later without revising order-processing logic. Which redesign BEST supports this goal?",
    "opts": [
    ...
    "a": 3,
    "exp": "Correct answer is supported by the concept coverage: Dependency • Injection • Testability. Reference: Object-Oriented Design Principles.",
    "objective": "Object-Oriented Programming Concepts",
    "conceptCoverage": "Dependency • Injection • Testability",
    "reference": "Object-Oriented Design Principles"
  },
  {
    "id": "OOP-053",
    ...
    "fullTopic": "Object-Oriented Programming Concepts",
    "d": "medium",
    "q": "A clinic application models InPersonVisit, TelehealthVisit, and HomeVisit. Every visit requires a patient identifier, scheduled time, status, and cancellation behavior, but each type calculates charges differently. The team also wants to prevent creation of a generic Visit object. Which design BEST fits?",
    "opts": [
  ...
  },
  {
    ...
    "fullTopic": "Object-Oriented Programming Concepts",
    "d": "medium",
    "q": "A CustomerAccount class stores account details but also calculates invoices, sends notifications, performs fraud checks, generates analytics reports, and manages user permissions. Developers frequently modify the class for unrelated reasons. Which change would MOST improve maintainability?",
    "opts": [
    ...
    "a": 1,
    "exp": "Correct answer is supported by the concept coverage: Cohesion • Single • Responsibility • Principle. Reference: Object-Oriented Design Principles.",
    "objective": "Object-Oriented Programming Concepts",
    "conceptCoverage": "Cohesion • Single • Responsibility • Principle",
    "reference": "Object-Oriented Design Principles"
  },
  {
    "id": "OOP-055",
    ...
    "fullTopic": "Object-Oriented Programming Concepts",
    "d": "medium",
    "q": "A development team creates a new Invoice object only after assigning an invoice number, customer identifier, issue date, and initial status. Which class component is primarily responsible for establishing this valid initial state?",
    "opts": [
      "Constructor",
      "Accessor method",
      "Destructor",
  ...
  },
  {
    ...
    "fullTopic": "Object-Oriented Programming Concepts",
    "d": "medium",
    "q": "A customer-service system retrieves the same customer record in two separate application requests. The resulting Customer objects contain identical customer IDs, names, and contact details but exist at different memory locations. Which statement BEST distinguishes identity from equality?",
    "opts": [
  ...
  },
  {
    ...
    "fullTopic": "Object-Oriented Programming Concepts",
    "d": "medium",
    "q": "A consulting firm tracks Department objects and Consultant objects. A department may contain many consultants, but consultants can transfer to another department and must remain in the system if a department is dissolved. Which relationship BEST describes this model?",
    "opts": [
  ...
  },
  {
    ...
    "fullTopic": "Object-Oriented Programming Concepts",
    "d": "medium",
    "q": "A payment service attempts to authorize an order through an external provider. If the provider is unavailable, the application must preserve the order, record the failure, and allow a later retry without incorrectly recording the order as paid. Which approach BEST supports this behavior?",
    "opts": [
  ...
  },
  {
    ...
    "fullTopic": "Object-Oriented Programming Concepts",
    "d": "medium",
    "q": "A hotel-reservation application includes Reservation, Payment, and Invoice objects. When a reservation is confirmed, the Reservation object currently calculates taxes, applies payment rules, generates invoices, and emails guests. The development team wants responsibilities assigned to the components best equipped to perform them. Which redesign is MOST appropriate?",
    "opts": [
    ...
    "a": 1,
    "exp": "Correct answer is supported by the concept coverage: Delegation • Responsibility • Assignment. Reference: Object-Oriented Design Principles.",
    "objective": "Object-Oriented Programming Concepts",
    "conceptCoverage": "Delegation • Responsibility • Assignment",
    "reference": "Object-Oriented Design Principles"
  },
  {
    "id": "OOP-062",
    ...
    "a": 3,
    "exp": "Correct answer is supported by the concept coverage: Factory • Pattern • Object • Creation. Reference: Object-Oriented Programming Fundamentals.",
    "objective": "Object-Oriented Programming Concepts",
    "conceptCoverage": "Factory • Pattern • Object • Creation",
    "reference": "Object-Oriented Programming Fundamentals"
  },
  {
    "id": "OOP-063",
    ...
    "a": 0,
    "exp": "Correct answer is supported by the concept coverage: Immutability • Auditability. Reference: Object-Oriented Design Principles.",
    "objective": "Object-Oriented Programming Concepts",
    "conceptCoverage": "Immutability • Auditability",
    "reference": "Object-Oriented Design Principles"
  },
  {
    "id": "OOP-064",
    ...
    "a": 2,
    "exp": "Correct answer is supported by the concept coverage: Association • Class • Relationship • Attributes. Reference: Object-Oriented Analysis and Design.",
    "objective": "Object-Oriented Programming Concepts",
    "conceptCoverage": "Association • Class • Relationship • Attributes",
    "reference": "Object-Oriented Analysis and Design"
  },
  {
    "id": "OOP-065",
    ...
    "a": 1,
    "exp": "Correct answer is supported by the concept coverage: Encapsulation • Validation • Methods. Reference: Object-Oriented Programming Fundamentals.",
    "objective": "Object-Oriented Programming Concepts",
    "conceptCoverage": "Encapsulation • Validation • Methods",
    "reference": "Object-Oriented Programming Fundamentals"
  },
  {
    "id": "OOP-066",
    ...
    "fullTopic": "Object-Oriented Programming Concepts",
    "d": "medium",
    "q": "A financial-reporting system must export reports as PDF, CSV, or spreadsheet files. The reporting module should be able to request an export without knowing the technical details of each format. Which design BEST supports this objective?",
    "opts": [
    ...
    "a": 3,
    "exp": "Correct answer is supported by the concept coverage: Interfaces • Substitutability. Reference: Object-Oriented Design Principles.",
    "objective": "Object-Oriented Programming Concepts",
    "conceptCoverage": "Interfaces • Substitutability",
    "reference": "Object-Oriented Design Principles"
  },
  {
    "id": "OOP-067",
    ...
    "a": 0,
    "exp": "Correct answer is supported by the concept coverage: Constructors • Class • Invariants. Reference: Object-Oriented Programming Fundamentals.",
    "objective": "Object-Oriented Programming Concepts",
    "conceptCoverage": "Constructors • Class • Invariants",
    "reference": "Object-Oriented Programming Fundamentals"
  },
  {
    "id": "OOP-068",
    ...
    "a": 2,
    "exp": "Correct answer is supported by the concept coverage: Inheritance • “Is-a” • Relationship. Reference: Object-Oriented Analysis and Design.",
    "objective": "Object-Oriented Programming Concepts",
    "conceptCoverage": "Inheritance • “Is-a” • Relationship",
    "reference": "Object-Oriented Analysis and Design"
  },
  {
    "id": "OOP-069",
    ...
    "a": 1,
    "exp": "Correct answer is supported by the concept coverage: Coupling • Interface-Based • Design. Reference: Object-Oriented Design Principles.",
    "objective": "Object-Oriented Programming Concepts",
    "conceptCoverage": "Coupling • Interface-Based • Design",
    "reference": "Object-Oriented Design Principles"
  },
  {
    "id": "OOP-070",
    ...
    "fullTopic": "Object-Oriented Programming Concepts",
    "d": "medium",
    "q": "A web application creates temporary objects while generating a complex analytics report. Once the report is sent to the user, those temporary objects are no longer referenced by any active component. In an environment with automatic memory management, what generally happens next?",
    "opts": [
    ...
    "a": 3,
    "exp": "Correct answer is supported by the concept coverage: Object • Lifecycle • Garbage • Collection. Reference: Object-Oriented Programming Fundamentals.",
    "objective": "Object-Oriented Programming Concepts",
    "conceptCoverage": "Object • Lifecycle • Garbage • Collection",
    "reference": "Object-Oriented Programming Fundamentals"
  },
  {
    "id": "OOP-071",
    ...
    "fullTopic": "Object-Oriented Programming Concepts",
    "d": "medium",
    "q": "A base Notification class defines a send method. EmailNotification provides its own send implementation using an email server, while SMSNotification provides a different send implementation using a messaging gateway. Which concept is MOST directly illustrated?",
    "opts": [
    ...
    "a": 0,
    "exp": "Correct answer is supported by the concept coverage: Overriding • vs. • Overloading. Reference: Object-Oriented Programming Fundamentals.",
    "objective": "Object-Oriented Programming Concepts",
    "conceptCoverage": "Overriding • vs. • Overloading",
    "reference": "Object-Oriented Programming Fundamentals"
  },
  {
    "id": "OOP-072",
    ...
    "fullTopic": "Object-Oriented Programming Concepts",
    "d": "medium",
    "q": "A class diagram for an online marketplace indicates that each Order is associated with exactly one Customer, while each Customer may be associated with zero or many Orders. Which notation concept expresses these quantities on the association?",
    "opts": [
    ...
    "a": 2,
    "exp": "Correct answer is supported by the concept coverage: Class • Diagrams • Multiplicity. Reference: UML Class Modeling.",
    "objective": "Object-Oriented Programming Concepts",
    "conceptCoverage": "Class • Diagrams • Multiplicity",
    "reference": "UML Class Modeling"
  },
  {
    "id": "OOP-073",
    ...
    "fullTopic": "Object-Oriented Programming Concepts",
    "d": "medium",
    "q": "A document-management system handles Draft, Submitted, Approved, and Archived documents. Each state permits different actions: drafts can be edited, submitted documents can be reviewed, approved documents can be published, and archived documents are read-only. The current design uses a large conditional statement throughout the application. Which redesign would MOST improve maintainability?",
    "opts": [
    ...
    "a": 1,
    "exp": "Correct answer is supported by the concept coverage: State • Pattern • Behavior • by • State. Reference: Object-Oriented Design Principles.",
    "objective": "Object-Oriented Programming Concepts",
    "conceptCoverage": "State • Pattern • Behavior • by • State",
    "reference": "Object-Oriented Design Principles"
  },
  {
    "id": "OOP-074",
    ...
    "fullTopic": "Object-Oriented Programming Concepts",
    "d": "medium",
    "q": "In an object-oriented language, which access level is commonly used when a member should be available within its own class and to subclasses, but not generally accessible to unrelated classes?",
    "opts": [
      "Public",
      "Private",
      "Static",
    ...
    "a": 3,
    "exp": "Correct answer is supported by the concept coverage: Recall • Protected • Access. Reference: Object-Oriented Programming Fundamentals.",
    "objective": "Object-Oriented Programming Concepts",
    "conceptCoverage": "Recall • Protected • Access",
    "reference": "Object-Oriented Programming Fundamentals"
  },
  {
    "id": "OOP-075",
    ...
    "fullTopic": "Object-Oriented Programming Concepts",
    "d": "medium",
    "q": "A transferFunds method requires that the source account exist, the transfer amount be positive, and the account have sufficient available funds before the method executes. These conditions are checked before any balance changes occur. What are these conditions MOST accurately called?",
    "opts": [
    ...
    "a": 2,
    "exp": "Correct answer is supported by the concept coverage: Design • by • Contract • Preconditions. Reference: Object-Oriented Design Principles.",
    "objective": "Object-Oriented Programming Concepts",
    "conceptCoverage": "Design • by • Contract • Preconditions",
    "reference": "Object-Oriented Design Principles"
  },
  {
    "id": "OOP-076",
    ...
    "fullTopic": "Object-Oriented Programming Concepts",
    "d": "medium",
    "q": "A retailer’s checkout system calculates shipping charges using standard, expedited, same-day, and regional-carrier rules. The applicable rule may change based on customer selection, delivery location, and inventory availability. Developers want to avoid placing all shipping logic in one large conditional statement. Which design BEST supports this requirement?",
    "opts": [
    ...
    "a": 1,
    "exp": "Correct answer is supported by the concept coverage: Strategy • Pattern • Runtime • Behavior • Selection. Reference: Object-Oriented Design Principles.",
    "objective": "Object-Oriented Programming Concepts",
    "conceptCoverage": "Strategy • Pattern • Runtime • Behavior • Selection",
    "reference": "Object-Oriented Design Principles"
  },
  {
    "id": "OOP-077",
    ...
    "fullTopic": "Object-Oriented Programming Concepts",
    "d": "medium",
    "q": "A proposal-management application duplicates an existing Proposal object to create a new draft. Each proposal contains a mutable list of attached documents. The new draft should begin with copies of the attachments, but editing or removing an attachment in the draft must not alter the original proposal’s attachments. Which approach is MOST appropriate?",
    "opts": [
    ...
    "a": 2,
    "exp": "Correct answer is supported by the concept coverage: Deep • Copy • vs. • Shared • References. Reference: Object-Oriented Programming Fundamentals.",
    "objective": "Object-Oriented Programming Concepts",
    "conceptCoverage": "Deep • Copy • vs. • Shared • References",
    "reference": "Object-Oriented Programming Fundamentals"
  },
  {
    "id": "OOP-078",
  ...
  },
  {
    ...
    "a": 3,
    "exp": "Correct answer is supported by the concept coverage: Observer • Pattern • Event-Driven • Design. Reference: Object-Oriented Design Principles.",
    "objective": "Object-Oriented Programming Concepts",
    "conceptCoverage": "Observer • Pattern • Event-Driven • Design",
    "reference": "Object-Oriented Design Principles"
  },
  {
    "id": "OOP-080",
    ...
    "fullTopic": "Object-Oriented Programming Concepts",
    "d": "medium",
    "q": "A clinical-order class contains methods for validating dosage, calculating a refill date, formatting an internal audit message, and submitting the final order. External components should be able to submit an order but should not call low-level audit-formatting logic directly. Which design BEST reflects appropriate method visibility?",
    "opts": [
    ...
    "a": 1,
    "exp": "Correct answer is supported by the concept coverage: Method • Visibility • API • Design. Reference: Object-Oriented Programming Fundamentals.",
    "objective": "Object-Oriented Programming Concepts",
    "conceptCoverage": "Method • Visibility • API • Design",
    "reference": "Object-Oriented Programming Fundamentals"
  },
  {
    "id": "OOP-081",
    ...
    "a": 2,
    "exp": "Correct answer is supported by the concept coverage: Template • Method • Pattern • Shared • Algorithm • Structure. Reference: Object-Oriented Design Principles.",
    "objective": "Object-Oriented Programming Concepts",
    "conceptCoverage": "Template • Method • Pattern • Shared • Algorithm • Structure",
    "reference": "Object-Oriented Design Principles"
  },
  {
    "id": "OOP-082",
    ...
    "fullTopic": "Object-Oriented Programming Concepts",
    "d": "medium",
    "q": "A payroll system represents money using a MonetaryAmount object containing a currency and amount. Developers want arithmetic operations, such as add or subtract, to avoid altering an existing amount unexpectedly when the same value is used by multiple calculations. Which design is MOST appropriate?",
    "opts": [
    ...
    "a": 0,
    "exp": "Correct answer is supported by the concept coverage: Immutable • Value • Objects. Reference: Object-Oriented Design Principles.",
    "objective": "Object-Oriented Programming Concepts",
    "conceptCoverage": "Immutable • Value • Objects",
    "reference": "Object-Oriented Design Principles"
  },
  {
    "id": "OOP-083",
    ...
    "fullTopic": "Object-Oriented Programming Concepts",
    "d": "medium",
    "q": "A booking system models Reservation and Guest. A Reservation must retrieve information about its Guest, but Guest objects do not need to access a list of reservations for the feature currently being designed. Which relationship representation is MOST appropriate?",
    "opts": [
    ...
    "a": 3,
    "exp": "Correct answer is supported by the concept coverage: Association • Direction • Navigability. Reference: UML Class Modeling.",
    "objective": "Object-Oriented Programming Concepts",
    "conceptCoverage": "Association • Direction • Navigability",
    "reference": "UML Class Modeling"
  },
  {
    "id": "OOP-084",
    ...
    "fullTopic": "Object-Oriented Programming Concepts",
    "d": "medium",
    "q": "A document-review system must support actions such as approve, reject, assign reviewer, and request revision. Users also need the ability to undo certain actions, and the application must maintain an audit trail of what operations occurred. Which design BEST supports these requirements?",
    "opts": [
    ...
    "a": 1,
    "exp": "Correct answer is supported by the concept coverage: Command • Pattern • Undo • Operations. Reference: Object-Oriented Design Principles.",
    "objective": "Object-Oriented Programming Concepts",
    "conceptCoverage": "Command • Pattern • Undo • Operations",
    "reference": "Object-Oriented Design Principles"
  },
  {
    "id": "OOP-085",
    ...
    "a": 2,
    "exp": "Correct answer is supported by the concept coverage: Composition • Root • Dependency • Management. Reference: Object-Oriented Design Principles.",
    "objective": "Object-Oriented Programming Concepts",
    "conceptCoverage": "Composition • Root • Dependency • Management",
    "reference": "Object-Oriented Design Principles"
  },
  {
    "id": "OOP-086",
    ...
    "fullTopic": "Object-Oriented Programming Concepts",
    "d": "medium",
    "q": "A SeatReservation object may be in Available, Held, Confirmed, or Cancelled status. A confirmed reservation must have a payment authorization code, while a cancelled reservation must not remain linked to an active boarding pass. Which practice BEST protects these rules throughout the object’s lifecycle?",
    "opts": [
    ...
    "a": 0,
    "exp": "Correct answer is supported by the concept coverage: Class • Invariants • State • Consistency. Reference: Object-Oriented Design Principles.",
    "objective": "Object-Oriented Programming Concepts",
    "conceptCoverage": "Class • Invariants • State • Consistency",
    "reference": "Object-Oriented Design Principles"
  },
  {
    "id": "OOP-087",
    ...
    "fullTopic": "Object-Oriented Programming Concepts",
    "d": "medium",
    "q": "A class contains three methods named calculateFee: one accepts an account ID, one accepts an account ID and transaction amount, and one accepts an account ID, transaction amount, and fee category. What concept is illustrated?",
    "opts": [
      "Method overriding",
      "Encapsulation",
      "Inheritance",
    ...
    "a": 3,
    "exp": "Correct answer is supported by the concept coverage: Recall • Method • Overloading. Reference: Object-Oriented Programming Fundamentals.",
    "objective": "Object-Oriented Programming Concepts",
    "conceptCoverage": "Recall • Method • Overloading",
    "reference": "Object-Oriented Programming Fundamentals"
  },
  {
    "id": "OOP-088",
    ...
    "a": 1,
    "exp": "Correct answer is supported by the concept coverage: Adapter • Pattern • Legacy • Integration. Reference: Object-Oriented Design Principles.",
    "objective": "Object-Oriented Programming Concepts",
    "conceptCoverage": "Adapter • Pattern • Legacy • Integration",
    "reference": "Object-Oriented Design Principles"
  },
  {
    "id": "OOP-089",
    ...
    "fullTopic": "Object-Oriented Programming Concepts",
    "d": "medium",
    "q": "An order-processing component retrieves a customer’s address by calling order.getCustomer().getProfile().getAddress().getPostalCode(). Developers want to reduce fragile chains of object navigation and minimize knowledge of distant object structures. Which revision BEST reflects the Law of Demeter?",
    "opts": [
    ...
    "a": 2,
    "exp": "Correct answer is supported by the concept coverage: Demeter • Principle • Limited • Knowledge. Reference: Object-Oriented Design Principles.",
    "objective": "Object-Oriented Programming Concepts",
    "conceptCoverage": "Demeter • Principle • Limited • Knowledge",
    "reference": "Object-Oriented Design Principles"
  },
  {
    "id": "OOP-090",
    ...
    "fullTopic": "Object-Oriented Programming Concepts",
    "d": "medium",
    "q": "Which term refers to the collection of current attribute values held by an object at a particular point in time?",
    "opts": [
      "Object state",
      "Class hierarchy",
      "Method signature",
    ...
    "a": 0,
    "exp": "Correct answer is supported by the concept coverage: Recall • Object • State. Reference: Object-Oriented Programming Fundamentals.",
    "objective": "Object-Oriented Programming Concepts",
    "conceptCoverage": "Recall • Object • State",
    "reference": "Object-Oriented Programming Fundamentals"
  },
  {
    "id": "OOP-091",
    ...
    "a": 1,
    "exp": "Correct answer is supported by the concept coverage: Encapsulation • Information • Hiding. Reference: Object-Oriented Programming Fundamentals.",
    "objective": "Object-Oriented Programming Concepts",
    "conceptCoverage": "Encapsulation • Information • Hiding",
    "reference": "Object-Oriented Programming Fundamentals"
  },
  {
    "id": "OOP-092",
    ...
    "a": 3,
    "exp": "Correct answer is supported by the concept coverage: Builder • Pattern • Complex • Object • Construction. Reference: Object-Oriented Design Principles.",
    "objective": "Object-Oriented Programming Concepts",
    "conceptCoverage": "Builder • Pattern • Complex • Object • Construction",
    "reference": "Object-Oriented Design Principles"
  },
  {
    "id": "OOP-093",
    ...
    "fullTopic": "Object-Oriented Programming Concepts",
    "d": "medium",
    "q": "A business application includes Employee, Contractor, and Intern records. All require a name, contact information, organization identifier, and login behavior, but each has different compensation and access rules. Which design BEST uses inheritance appropriately?",
    "opts": [
    ...
    "a": 0,
    "exp": "Correct answer is supported by the concept coverage: Inheritance • Base-Class • Reuse. Reference: Object-Oriented Analysis and Design.",
    "objective": "Object-Oriented Programming Concepts",
    "conceptCoverage": "Inheritance • Base-Class • Reuse",
    "reference": "Object-Oriented Analysis and Design"
  },
  {
    "id": "OOP-094",
    ...
    "a": 2,
    "exp": "Correct answer is supported by the concept coverage: Polymorphism • Subtype • Behavior. Reference: Object-Oriented Programming Fundamentals.",
    "objective": "Object-Oriented Programming Concepts",
    "conceptCoverage": "Polymorphism • Subtype • Behavior",
    "reference": "Object-Oriented Programming Fundamentals"
  },
  {
    "id": "OOP-095",
    ...
    "fullTopic": "Object-Oriented Programming Concepts",
    "d": "medium",
    "q": "A payment application supports fraud screening through several optional checks, including address verification, device reputation, velocity monitoring, and sanctions screening. Different payment channels require different combinations of checks, and rules may change frequently. Which design is MOST flexible?",
    "opts": [
    ...
    "a": 1,
    "exp": "Correct answer is supported by the concept coverage: Composition • Reusable • Components. Reference: Object-Oriented Design Principles.",
    "objective": "Object-Oriented Programming Concepts",
    "conceptCoverage": "Composition • Reusable • Components",
    "reference": "Object-Oriented Design Principles"
  },
  {
    "id": "OOP-096",
    ...
    "fullTopic": "Object-Oriented Programming Concepts",
    "d": "medium",
    "q": "A base Notification class contains a formatMessage method. EmailNotification must format messages using HTML, SMSNotification must shorten messages to character limits, and PushNotification must include a title and compact body. Which implementation is MOST appropriate?",
    "opts": [
    ...
    "a": 0,
    "exp": "Correct answer is supported by the concept coverage: Method • Overriding • Inheritance. Reference: Object-Oriented Programming Fundamentals.",
    "objective": "Object-Oriented Programming Concepts",
    "conceptCoverage": "Method • Overriding • Inheritance",
    "reference": "Object-Oriented Programming Fundamentals"
  },
  {
    "id": "OOP-097",
    ...
    "fullTopic": "Object-Oriented Programming Concepts",
    "d": "medium",
    "q": "A customer-management system stores Customer objects in a hash-based collection. Developers define two Customer objects as equal whenever they have the same immutable customer ID, even if other fields such as mailing address differ. Which additional design requirement is MOST important?",
    "opts": [
    ...
    "a": 3,
    "exp": "Correct answer is supported by the concept coverage: Equality • Hashing. Reference: Object-Oriented Programming Fundamentals.",
    "objective": "Object-Oriented Programming Concepts",
    "conceptCoverage": "Equality • Hashing",
    "reference": "Object-Oriented Programming Fundamentals"
  },
  {
    "id": "OOP-098",
    ...
    "a": 2,
    "exp": "Correct answer is supported by the concept coverage: Class • Responsibilities • Domain • Modeling. Reference: Object-Oriented Analysis and Design.",
    "objective": "Object-Oriented Programming Concepts",
    "conceptCoverage": "Class • Responsibilities • Domain • Modeling",
    "reference": "Object-Oriented Analysis and Design"
  },
  {
    "id": "OOP-099",
    ...
    "fullTopic": "Object-Oriented Programming Concepts",
    "d": "medium",
    "q": "An order-processing service depends on a tax-calculation component. During unit testing, developers want to simulate tax outcomes without contacting the external tax provider. Which design approach BEST supports this objective?",
    "opts": [
    ...
    "a": 1,
    "exp": "Correct answer is supported by the concept coverage: Interfaces • Test • Doubles. Reference: Object-Oriented Design Principles.",
    "objective": "Object-Oriented Programming Concepts",
    "conceptCoverage": "Interfaces • Test • Doubles",
    "reference": "Object-Oriented Design Principles"
  },
  {
    "id": "OOP-100",
    ...
    "fullTopic": "Object-Oriented Programming Concepts",
    "d": "medium",
    "q": "An insurance application processes all claim types through the same sequence: verify submission, evaluate coverage, calculate payment, record the decision, and notify the claimant. Only the evaluation and payment calculations differ between claim categories. Which design BEST captures this need?",
    "opts": [
    ...
    "a": 0,
    "exp": "Correct answer is supported by the concept coverage: Template • Method • Pattern. Reference: Object-Oriented Design Principles.",
    "objective": "Object-Oriented Programming Concepts",
    "conceptCoverage": "Template • Method • Pattern",
    "reference": "Object-Oriented Design Principles"
  },
  {
    "id": "OOP-101",
    ...
    "fullTopic": "Object-Oriented Programming Concepts",
    "d": "medium",
    "q": "A university models a StudentOrganization and its Members. Students may join or leave organizations, belong to several organizations, and remain in the university system even if an organization dissolves. Which relationship BEST represents this model?",
    "opts": [
    ...
    "a": 3,
    "exp": "Correct answer is supported by the concept coverage: Aggregation • vs. • Composition. Reference: Object-Oriented Analysis and Design.",
    "objective": "Object-Oriented Programming Concepts",
    "conceptCoverage": "Aggregation • vs. • Composition",
    "reference": "Object-Oriented Analysis and Design"
  },
  {
    "id": "OOP-102",
    ...
    "fullTopic": "Object-Oriented Programming Concepts",
    "d": "medium",
    "q": "Which statement BEST describes an abstract class?",
    "opts": [
    ...
    "a": 2,
    "exp": "Correct answer is supported by the concept coverage: Recall • Abstract • Classes. Reference: Object-Oriented Programming Fundamentals.",
    "objective": "Object-Oriented Programming Concepts",
    "conceptCoverage": "Recall • Abstract • Classes",
    "reference": "Object-Oriented Programming Fundamentals"
  },
  {
    "id": "OOP-103",
    ...
    "a": 1,
    "exp": "Correct answer is supported by the concept coverage: Exception • Handling • Fail-Safe • Design. Reference: Object-Oriented Programming Fundamentals.",
    "objective": "Object-Oriented Programming Concepts",
    "conceptCoverage": "Exception • Handling • Fail-Safe • Design",
    "reference": "Object-Oriented Programming Fundamentals"
  },
  {
    "id": "OOP-104",
    ...
    "fullTopic": "Object-Oriented Programming Concepts",
    "d": "medium",
    "q": "A reporting service directly depends on a specific PDF library. When the organization adds spreadsheet and web-export options, many reporting methods must be revised. Which redesign BEST follows the dependency inversion principle?",
    "opts": [
    ...
    "a": 0,
    "exp": "Correct answer is supported by the concept coverage: Dependency • Inversion. Reference: Object-Oriented Design Principles.",
    "objective": "Object-Oriented Programming Concepts",
    "conceptCoverage": "Dependency • Inversion",
    "reference": "Object-Oriented Design Principles"
  },
  {
    "id": "OOP-105",
    ...
    "fullTopic": "Object-Oriented Programming Concepts",
    "d": "medium",
    "q": "Which term refers to creating a new object from a class definition?",
    "opts": [
      "Encapsulation",
      "Instantiation",
      "Generalization",
    ...
    "a": 1,
    "exp": "Correct answer is supported by the concept coverage: Recall • Object • Instantiation. Reference: Object-Oriented Programming Fundamentals.",
    "objective": "Object-Oriented Programming Concepts",
    "conceptCoverage": "Recall • Object • Instantiation",
    "reference": "Object-Oriented Programming Fundamentals"
  },
  {
    "id": "DIM-001",
    "t": "Data",
    "fullTopic": "Data & Information Management",
    "d": "medium",
    "q": "A retailer stores customer name, address, loyalty tier, and order details in one large table. When a customer changes address, employees must update multiple rows because the customer has placed several orders. Occasionally, some rows are updated while others are missed. Which database-design problem is MOST directly illustrated?",
    "opts": [
    ...
    "a": 1,
    "exp": "Correct answer is supported by the concept coverage: Normalization • Update • Anomalies. Reference: Database Design; Normalization.",
    "objective": "Data & Information Management",
    "conceptCoverage": "Normalization • Update • Anomalies",
  ...
  },
  {
    ...
    "a": 3,
    "exp": "Correct answer is supported by the concept coverage: Primary • Keys • Entity • Integrity. Reference: Relational Databases; Keys.",
    "objective": "Data & Information Management",
    "conceptCoverage": "Primary • Keys • Entity • Integrity",
  ...
  },
  {
    ...
    "fullTopic": "Data & Information Management",
    "d": "medium",
    "q": "A clinic database contains a Patient table and an Appointment table. Every appointment must be associated with one existing patient, but each patient may have many appointments. Which design BEST enforces this relationship?",
    "opts": [
    ...
    "a": 0,
    "exp": "Correct answer is supported by the concept coverage: Foreign • Keys • Referential • Integrity. Reference: Relational Databases; Relationships.",
    "objective": "Data & Information Management",
    "conceptCoverage": "Foreign • Keys • Referential • Integrity",
  ...
  },
  {
    ...
    "a": 2,
    "exp": "Correct answer is supported by the concept coverage: ACID • Properties • Atomicity. Reference: Transaction Processing; ACID.",
    "objective": "Data & Information Management",
    "conceptCoverage": "ACID • Properties • Atomicity",
  ...
  },
  {
    ...
    "fullTopic": "Data & Information Management",
    "d": "medium",
    "q": "Two employees attempt to reserve the last available conference room for overlapping times. Without controls, both employees may see the room as available and complete reservations. Which transaction-processing objective MOST directly prevents this problem?",
    "opts": [
    ...
    "a": 1,
    "exp": "Correct answer is supported by the concept coverage: ACID • Properties • Isolation. Reference: Transaction Processing; Concurrency Control.",
    "objective": "Data & Information Management",
    "conceptCoverage": "ACID • Properties • Isolation",
  ...
  },
  {
    ...
    "a": 3,
    "exp": "Correct answer is supported by the concept coverage: OLTP • vs. • OLAP. Reference: Data Management; Analytical Systems.",
    "objective": "Data & Information Management",
    "conceptCoverage": "OLTP • vs. • OLAP",
  ...
  },
  {
    ...
    "a": 0,
    "exp": "Correct answer is supported by the concept coverage: Data • Warehouse • ETL. Reference: Data Warehousing; ETL Processes.",
    "objective": "Data & Information Management",
    "conceptCoverage": "Data • Warehouse • ETL",
  ...
  },
  {
    ...
    "a": 2,
    "exp": "Correct answer is supported by the concept coverage: Data • Governance • Data • Ownership. Reference: Data Governance; Information Management.",
    "objective": "Data & Information Management",
    "conceptCoverage": "Data • Governance • Data • Ownership",
  ...
  },
  {
    ...
    "fullTopic": "Data & Information Management",
    "d": "medium",
    "q": "A customer-support database contains millions of service requests. Agents frequently search by account number and open-case status, but those searches now take several seconds during peak periods. The data itself is accurate, and the organization does not want to change the underlying business rules. Which action would MOST directly improve retrieval performance?",
    "opts": [
    ...
    "a": 1,
    "exp": "Correct answer is supported by the concept coverage: Indexing • Query • Performance. Reference: Database Performance; Indexes.",
    "objective": "Data & Information Management",
    "conceptCoverage": "Indexing • Query • Performance",
  ...
  },
  {
    ...
    "fullTopic": "Data & Information Management",
    "d": "medium",
    "q": "A web application builds database queries by directly combining user-entered search text with SQL commands. Security staff warn that an attacker could enter specially constructed input that changes the intended query and exposes unauthorized records. Which safeguard is MOST appropriate?",
    "opts": [
    ...
    "a": 3,
    "exp": "Correct answer is supported by the concept coverage: SQL • Injection • Input • Validation. Reference: Database Security; Application Security.",
    "objective": "Data & Information Management",
    "conceptCoverage": "SQL • Injection • Input • Validation",
  ...
  },
  {
    ...
    "fullTopic": "Data & Information Management",
    "d": "medium",
    "q": "Which goal is MOST closely associated with database normalization?",
    "opts": [
    ...
    "a": 0,
    "exp": "Correct answer is supported by the concept coverage: Recall • Database • Normal • Forms. Reference: Relational Database Design; Normalization.",
    "objective": "Data & Information Management",
    "conceptCoverage": "Recall • Database • Normal • Forms",
  ...
  },
  {
    ...
    "fullTopic": "Data & Information Management",
    "d": "medium",
    "q": "A nonprofit imports donor records from several fundraising events. Most records include a valid email address, but many are missing donation amounts or have amounts entered in the wrong currency. Before using the data for financial reporting, which data-quality concerns are MOST directly present?",
    "opts": [
    ...
    "a": 2,
    "exp": "Correct answer is supported by the concept coverage: Data • Quality • Completeness • vs. • Accuracy. Reference: Data Quality Management.",
    "objective": "Data & Information Management",
    "conceptCoverage": "Data • Quality • Completeness • vs. • Accuracy",
  ...
  },
  {
    ...
    "fullTopic": "Data & Information Management",
    "d": "medium",
    "q": "A financial firm determines that after an outage it can tolerate losing no more than ten minutes of transaction data. It configures frequent transaction-log backups and replication so the most recent recoverable data is always within that limit. Which recovery-planning objective is the organization addressing?",
    "opts": [
    ...
    "a": 1,
    "exp": "Correct answer is supported by the concept coverage: Backup • Strategy • Recovery • Point • Objective. Reference: Data Recovery; Business Continuity.",
    "objective": "Data & Information Management",
    "conceptCoverage": "Backup • Strategy • Recovery • Point • Objective",
  ...
  },
  {
    ...
    "fullTopic": "Data & Information Management",
    "d": "medium",
    "q": "An e-commerce company collects product information from thousands of sellers. Different product categories include widely varying attributes: clothing may have size and fabric fields, while electronics may have voltage, storage capacity, and connectivity details. The company needs flexible storage without requiring every product record to contain the same fixed columns. Which approach is MOST appropriate?",
    "opts": [
    ...
    "a": 3,
    "exp": "Correct answer is supported by the concept coverage: NoSQL • Databases • Flexible • Schemas. Reference: Database Models; NoSQL.",
    "objective": "Data & Information Management",
    "conceptCoverage": "NoSQL • Databases • Flexible • Schemas",
  ...
  },
  {
    ...
    "fullTopic": "Data & Information Management",
    "d": "medium",
    "q": "Which SQL category is primarily used to create, alter, or remove database structures such as tables, columns, and indexes?",
    "opts": [
    ...
    "a": 0,
    "exp": "Correct answer is supported by the concept coverage: Recall • Data • Definition • Language. Reference: SQL; Database Management Systems.",
    "objective": "Data & Information Management",
    "conceptCoverage": "Recall • Data • Definition • Language",
  ...
  },
  {
    ...
    "a": 2,
    "exp": "Correct answer is supported by the concept coverage: Composite • Keys • Associative • Tables. Reference: Relational Database Design; Keys and Relationships.",
    "objective": "Data & Information Management",
    "conceptCoverage": "Composite • Keys • Associative • Tables",
  ...
  },
  {
    ...
    "fullTopic": "Data & Information Management",
    "d": "medium",
    "q": "A clinic stores AppointmentID, PatientID, PatientName, ProviderID, ProviderName, and AppointmentDate in one table. Analysts note that PatientName depends on PatientID and ProviderName depends on ProviderID, rather than directly on AppointmentID. What database-design concern is MOST directly raised?",
    "opts": [
    ...
    "a": 0,
    "exp": "Correct answer is supported by the concept coverage: Functional • Dependencies • Third • Normal • Form. Reference: Relational Database Design; Normalization.",
    "objective": "Data & Information Management",
    "conceptCoverage": "Functional • Dependencies • Third • Normal • Form",
    "reference": "Relational Database Design; Normalization"
  },
  {
    "id": "DIM-018",
    ...
    "fullTopic": "Data & Information Management",
    "d": "medium",
    "q": "A retailer wants a report showing every customer who has placed at least one order, along with the details of those orders. Customers without orders should not appear in the report. Which SQL join BEST matches this requirement?",
    "opts": [
    ...
    "a": 1,
    "exp": "Correct answer is supported by the concept coverage: SQL • Joins. Reference: SQL; Relational Queries.",
    "objective": "Data & Information Management",
    "conceptCoverage": "SQL • Joins",
  ...
  },
  {
    ...
    "a": 3,
    "exp": "Correct answer is supported by the concept coverage: Database • Transactions • Consistency. Reference: Transaction Processing; ACID Properties.",
    "objective": "Data & Information Management",
    "conceptCoverage": "Database • Transactions • Consistency",
  ...
  },
  {
    ...
    "a": 0,
    "exp": "Correct answer is supported by the concept coverage: Data • Warehouses • Slowly • Changing • Dimensions. Reference: Data Warehousing; Historical Analysis.",
    "objective": "Data & Information Management",
    "conceptCoverage": "Data • Warehouses • Slowly • Changing • Dimensions",
  ...
  },
  {
    ...
    "fullTopic": "Data & Information Management",
    "d": "medium",
    "q": "A global manufacturer maintains separate customer records in sales, support, billing, and shipping systems. The same organization may appear under slightly different names and identifiers in each system, causing duplicate outreach and inconsistent account reporting. Which initiative would MOST directly address this issue?",
    "opts": [
    ...
    "a": 1,
    "exp": "Correct answer is supported by the concept coverage: Data • Governance • Master • Data • Management. Reference: Data Governance; Master Data Management.",
    "objective": "Data & Information Management",
    "conceptCoverage": "Data • Governance • Master • Data • Management",
  ...
  },
  {
    ...
    "fullTopic": "Data & Information Management",
    "d": "medium",
    "q": "A finance analyst needs a report showing total monthly reimbursement expense for each department. The source table contains one record per reimbursement request, with DepartmentID, SubmissionDate, and ApprovedAmount. Which SQL capability is MOST directly needed?",
    "opts": [
    ...
    "a": 0,
    "exp": "Correct answer is supported by the concept coverage: SQL • Aggregation • GROUP • BY. Reference: SQL; Aggregate Queries.",
    "objective": "Data & Information Management",
    "conceptCoverage": "SQL • Aggregation • GROUP • BY",
  ...
  },
  {
    ...
    "a": 2,
    "exp": "Correct answer is supported by the concept coverage: Data • Security • Least • Privilege. Reference: Database Security; Access Control.",
    "objective": "Data & Information Management",
    "conceptCoverage": "Data • Security • Least • Privilege",
  ...
  },
  {
    ...
    "fullTopic": "Data & Information Management",
    "d": "medium",
    "q": "A business-intelligence team generates a dashboard that repeatedly combines large sales, product, customer, and calendar tables. The queries are accurate but slow, and the dashboard data is refreshed nightly rather than updated transaction by transaction. Which approach may reasonably improve reporting performance while accepting controlled redundancy?",
    "opts": [
    ...
    "a": 0,
    "exp": "Correct answer is supported by the concept coverage: Denormalization • Reporting • Performance. Reference: Database Design; Performance Trade-offs.",
    "objective": "Data & Information Management",
    "conceptCoverage": "Denormalization • Reporting • Performance",
  ...
  },
  {
    ...
    "a": 1,
    "exp": "Correct answer is supported by the concept coverage: Data • Quality • Timeliness. Reference: Data Quality Management.",
    "objective": "Data & Information Management",
    "conceptCoverage": "Data • Quality • Timeliness",
    "reference": "Data Quality Management"
  },
  {
    "id": "DIM-026",
    ...
    "fullTopic": "Data & Information Management",
    "d": "medium",
    "q": "A law firm performs a full backup of its document repository each Sunday and incremental backups every evening that capture only files changed since the last backup. On Thursday morning, the repository must be restored after hardware failure. Which restoration sequence is typically required?",
    "opts": [
    ...
    "a": 1,
    "exp": "Correct answer is supported by the concept coverage: Database • Backup • Full • vs. • Incremental • Backup. Reference: Data Recovery; Backup Strategies.",
    "objective": "Data & Information Management",
    "conceptCoverage": "Database • Backup • Full • vs. • Incremental • Backup",
  ...
  },
  {
    ...
    "fullTopic": "Data & Information Management",
    "d": "medium",
    "q": "A hospital wants analysts to query a simplified dataset containing patient age group, diagnosis category, encounter date, and length of stay, while preventing them from accessing names, addresses, and medical-record numbers. Which database feature BEST supports this requirement?",
    "opts": [
    ...
    "a": 0,
    "exp": "Correct answer is supported by the concept coverage: Database • Views • Data • Access. Reference: SQL; Views and Security.",
    "objective": "Data & Information Management",
    "conceptCoverage": "Database • Views • Data • Access",
  ...
  },
  {
    ...
    "fullTopic": "Data & Information Management",
    "d": "medium",
    "q": "Which SQL category includes commands such as SELECT, INSERT, UPDATE, and DELETE?",
    "opts": [
      "Data Control Language",
      "Data Definition Language",
      "Data Manipulation Language",
    ...
    "a": 2,
    "exp": "Correct answer is supported by the concept coverage: Recall • Data • Manipulation • Language. Reference: SQL; Database Management Systems.",
    "objective": "Data & Information Management",
    "conceptCoverage": "Recall • Data • Manipulation • Language",
    "reference": "SQL; Database Management Systems"
  },
  {
    "id": "DIM-029",
    ...
    "fullTopic": "Data & Information Management",
    "d": "medium",
    "q": "Two procurement employees open the same purchase request. One changes the quantity from 10 to 12, while the other changes it from 10 to 15. Without appropriate concurrency controls, the second save may overwrite the first employee’s change without warning. Which problem is MOST directly illustrated?",
    "opts": [
    ...
    "a": 0,
    "exp": "Correct answer is supported by the concept coverage: Concurrency • Control • Lost • Updates. Reference: Transaction Processing; Concurrency.",
    "objective": "Data & Information Management",
    "conceptCoverage": "Concurrency • Control • Lost • Updates",
  ...
  },
  {
    ...
    "a": 1,
    "exp": "Correct answer is supported by the concept coverage: Data • Lakes • Schema-on-Read. Reference: Modern Data Platforms; Data Lakes.",
    "objective": "Data & Information Management",
    "conceptCoverage": "Data • Lakes • Schema-on-Read",
  ...
  },
  {
    ...
    "a": 1,
    "exp": "Correct answer is supported by the concept coverage: Second • Normal • Form • Partial • Dependency. Reference: Relational Database Design; Normalization.",
    "objective": "Data & Information Management",
    "conceptCoverage": "Second • Normal • Form • Partial • Dependency",
    "reference": "Relational Database Design; Normalization"
  },
  {
    "id": "DIM-032",
    ...
    "a": 3,
    "exp": "Correct answer is supported by the concept coverage: Unique • Constraints • Data • Integrity. Reference: Relational Database Design; Integrity Constraints.",
    "objective": "Data & Information Management",
    "conceptCoverage": "Unique • Constraints • Data • Integrity",
  ...
  },
  {
    ...
    "fullTopic": "Data & Information Management",
    "d": "medium",
    "q": "A retailer needs a report listing every product in its catalog, including products that have never been ordered, along with any matching order-line information when sales exist. Which SQL join BEST satisfies this requirement?",
    "opts": [
    ...
    "a": 0,
    "exp": "Correct answer is supported by the concept coverage: SQL • Joins • Outer • Joins. Reference: SQL; Relational Queries.",
    "objective": "Data & Information Management",
    "conceptCoverage": "SQL • Joins • Outer • Joins",
    "reference": "SQL; Relational Queries"
  },
  {
    "id": "DIM-034",
    ...
    "fullTopic": "Data & Information Management",
    "d": "medium",
    "q": "A bank confirms a mortgage payment and displays a successful receipt to the customer. Seconds later, the database server loses power. When service is restored, the completed payment remains recorded and the account balance reflects the transaction. Which ACID property is MOST directly demonstrated?",
    "opts": [
    ...
    "a": 2,
    "exp": "Correct answer is supported by the concept coverage: ACID • Properties • Durability. Reference: Transaction Processing; ACID Properties.",
    "objective": "Data & Information Management",
    "conceptCoverage": "ACID • Properties • Durability",
    "reference": "Transaction Processing; ACID Properties"
  },
  {
    "id": "DIM-035",
    ...
    "fullTopic": "Data & Information Management",
    "d": "medium",
    "q": "A financial-services firm publishes a dashboard showing loan-default rates by region. Before executives use it for strategic planning, they ask where each metric originated, which transformations were applied, which source system supplied it, and who approved the calculation. What capability is MOST directly needed?",
    "opts": [
    ...
    "a": 1,
    "exp": "Correct answer is supported by the concept coverage: Data • Lineage • Governance. Reference: Data Governance; Metadata Management.",
    "objective": "Data & Information Management",
    "conceptCoverage": "Data • Lineage • Governance",
  ...
  },
  {
    ...
    "fullTopic": "Data & Information Management",
    "d": "medium",
    "q": "A hospital loads laboratory data into an enterprise data warehouse. During validation, analysts discover that one source system records glucose in milligrams per deciliter while another stores millimoles per liter. The warehouse currently combines both values without conversion. What should occur before analytical reporting proceeds?",
    "opts": [
    ...
    "a": 3,
    "exp": "Correct answer is supported by the concept coverage: ETL • Data • Transformation • Errors. Reference: Data Warehousing; ETL Processes.",
    "objective": "Data & Information Management",
    "conceptCoverage": "ETL • Data • Transformation • Errors",
    "reference": "Data Warehousing; ETL Processes"
  },
  {
    "id": "DIM-037",
    ...
    "fullTopic": "Data & Information Management",
    "d": "medium",
    "q": "A payment processor stores ten years of transaction history in one table containing billions of records. Most operational queries retrieve only transactions from the current month, while compliance audits periodically examine older periods. Which approach may MOST directly improve performance and administration?",
    "opts": [
    ...
    "a": 0,
    "exp": "Correct answer is supported by the concept coverage: Partitioning • Large-Table • Performance. Reference: Database Performance; Data Partitioning.",
    "objective": "Data & Information Management",
    "conceptCoverage": "Partitioning • Large-Table • Performance",
  ...
  },
  {
    ...
    "fullTopic": "Data & Information Management",
    "d": "medium",
    "q": "A business-intelligence team routinely scans billions of sales records but usually retrieves only a few attributes, such as transaction date, product category, revenue, and region. The workload is primarily read-heavy aggregation rather than frequent row-by-row updates. Which storage approach is MOST appropriate?",
    "opts": [
    ...
    "a": 2,
    "exp": "Correct answer is supported by the concept coverage: Row-Oriented • vs. • Column-Oriented • Storage. Reference: Analytical Databases; Data Warehousing.",
    "objective": "Data & Information Management",
    "conceptCoverage": "Row-Oriented • vs. • Column-Oriented • Storage",
  ...
  },
  {
    ...
    "fullTopic": "Data & Information Management",
    "d": "medium",
    "q": "A customer-support team needs to verify the last four digits of a customer’s payment card during service calls, but representatives should not be able to view the complete card number. Which control BEST supports this operational requirement?",
    "opts": [
    ...
    "a": 1,
    "exp": "Correct answer is supported by the concept coverage: Data • Masking • Privacy • Controls. Reference: Database Security; Privacy Protection.",
    "objective": "Data & Information Management",
    "conceptCoverage": "Data • Masking • Privacy • Controls",
  ...
  },
  {
    ...
    "fullTopic": "Data & Information Management",
    "d": "medium",
    "q": "A web application stores user passwords. Security architects want to verify future login attempts without retaining passwords in a form that can be directly recovered if the credential database is compromised. Which approach is MOST appropriate?",
    "opts": [
    ...
    "a": 3,
    "exp": "Correct answer is supported by the concept coverage: Hashing • vs. • Encryption. Reference: Database Security; Credential Protection.",
    "objective": "Data & Information Management",
    "conceptCoverage": "Hashing • vs. • Encryption",
  ...
  },
  {
    ...
    "fullTopic": "Data & Information Management",
    "d": "medium",
    "q": "A university database contains a GraduationDate field. For some students, the field is blank because they are still enrolled; for others, it is blank because historical records were imported without graduation information. Why should the institution distinguish these cases?",
    "opts": [
    ...
    "a": 0,
    "exp": "Correct answer is supported by the concept coverage: NULL • Values • Data • Semantics. Reference: Relational Databases; Data Quality.",
    "objective": "Data & Information Management",
    "conceptCoverage": "NULL • Values • Data • Semantics",
  ...
  },
  {
    ...
    "fullTopic": "Data & Information Management",
    "d": "medium",
    "q": "A global manufacturer has hundreds of data sets across finance, supply chain, sales, and engineering systems. Analysts frequently recreate reports because they cannot determine what data already exists, who owns it, how current it is, or whether it is approved for reuse. Which initiative would MOST directly address this problem?",
    "opts": [
    ...
    "a": 2,
    "exp": "Correct answer is supported by the concept coverage: Data • Catalogs • Discoverability. Reference: Data Governance; Metadata Management.",
    "objective": "Data & Information Management",
    "conceptCoverage": "Data • Catalogs • Discoverability",
    "reference": "Data Governance; Metadata Management"
  },
  {
    "id": "DIM-043",
    ...
    "fullTopic": "Data & Information Management",
    "d": "medium",
    "q": "A purchasing application creates a purchase order, reserves budget funds, updates inventory forecasts, and records an audit event. If any step fails, the organization wants all related database changes undone so no partial transaction remains. Which transaction-control approach BEST supports this requirement?",
    "opts": [
    ...
    "a": 1,
    "exp": "Correct answer is supported by the concept coverage: SQL • Transactions • Commit • and • Rollback. Reference: SQL; Transaction Control.",
    "objective": "Data & Information Management",
    "conceptCoverage": "SQL • Transactions • Commit • and • Rollback",
  ...
  },
  {
    ...
    "a": 0,
    "exp": "Correct answer is supported by the concept coverage: Data • Retention • Records • Management. Reference: Data Governance; Information Lifecycle Management.",
    "objective": "Data & Information Management",
    "conceptCoverage": "Data • Retention • Records • Management",
  ...
  },
  {
    ...
    "fullTopic": "Data & Information Management",
    "d": "medium",
    "q": "Which constraint ensures that a foreign-key value in one table must correspond to an existing primary-key value in a related table, unless the relationship permits a null reference?",
    "opts": [
      "Domain integrity",
      "Entity integrity",
    ...
    "a": 2,
    "exp": "Correct answer is supported by the concept coverage: Recall • Referential • Integrity. Reference: Relational Databases; Integrity Constraints.",
    "objective": "Data & Information Management",
    "conceptCoverage": "Recall • Referential • Integrity",
  ...
  },
  {
    ...
    "a": 1,
    "exp": "Correct answer is supported by the concept coverage: Third • Normal • Form • Transitive • Dependencies. Reference: Relational Database Design; Normalization.",
    "objective": "Data & Information Management",
    "conceptCoverage": "Third • Normal • Form • Transitive • Dependencies",
    "reference": "Relational Database Design; Normalization"
  },
  {
    "id": "DIM-047",
    ...
    "a": 3,
    "exp": "Correct answer is supported by the concept coverage: SQL • Filtering • WHERE • Clause. Reference: SQL; Query Construction.",
    "objective": "Data & Information Management",
    "conceptCoverage": "SQL • Filtering • WHERE • Clause",
  ...
  },
  {
    ...
    "fullTopic": "Data & Information Management",
    "d": "medium",
    "q": "A retailer designs a sales warehouse for executive reporting. Analysts want to measure revenue, quantity sold, and discount amount by date, store, product, and customer segment. Which structure BEST fits a dimensional model?",
    "opts": [
    ...
    "a": 2,
    "exp": "Correct answer is supported by the concept coverage: Data • Warehousing • Fact • and • Dimension • Tables. Reference: Data Warehousing; Dimensional Modeling.",
    "objective": "Data & Information Management",
    "conceptCoverage": "Data • Warehousing • Fact • and • Dimension • Tables",
  ...
  },
  {
    ...
    "fullTopic": "Data & Information Management",
    "d": "medium",
    "q": "A hospital wants quality-improvement analysts to study readmission patterns by diagnosis category, age group, and length of stay. The analysts should not see patient names, dates of birth, addresses, or medical-record numbers. Which solution BEST supports this requirement?",
    "opts": [
    ...
    "a": 0,
    "exp": "Correct answer is supported by the concept coverage: Database • Views • Principle • of • Least • Privilege. Reference: SQL; Views and Access Control.",
    "objective": "Data & Information Management",
    "conceptCoverage": "Database • Views • Principle • of • Least • Privilege",
  ...
  },
  {
    ...
    "fullTopic": "Data & Information Management",
    "d": "medium",
    "q": "A distributor wants to identify every supplier that has not provided any shipments during the current quarter. The Supplier table contains all approved suppliers, while the Shipment table contains only suppliers that have submitted shipments. Which query approach is MOST appropriate?",
    "opts": [
    ...
    "a": 3,
    "exp": "Correct answer is supported by the concept coverage: SQL • Joins • Unmatched • Records. Reference: SQL; Outer Joins.",
    "objective": "Data & Information Management",
    "conceptCoverage": "SQL • Joins • Unmatched • Records",
  ...
  },
  {
    ...
    "a": 1,
    "exp": "Correct answer is supported by the concept coverage: Data • Quality • Consistency. Reference: Data Quality Management.",
    "objective": "Data & Information Management",
    "conceptCoverage": "Data • Quality • Consistency",
    "reference": "Data Quality Management"
  },
  {
    "id": "DIM-052",
    ...
    "fullTopic": "Data & Information Management",
    "d": "medium",
    "q": "A billing clerk updates a customer’s account balance but has not yet completed the transaction. Before the clerk commits or rolls back the change, another employee’s report reads the temporary balance and uses it to make a collection decision. Which concurrency problem is MOST directly illustrated?",
    "opts": [
    ...
    "a": 2,
    "exp": "Correct answer is supported by the concept coverage: Transaction • Isolation • Dirty • Reads. Reference: Transaction Processing; Concurrency Control.",
    "objective": "Data & Information Management",
    "conceptCoverage": "Transaction • Isolation • Dirty • Reads",
    "reference": "Transaction Processing; Concurrency Control"
  },
  {
    "id": "DIM-053",
    ...
    "a": 0,
    "exp": "Correct answer is supported by the concept coverage: Data • Governance • Data • Stewardship. Reference: Data Governance; Roles and Responsibilities.",
    "objective": "Data & Information Management",
    "conceptCoverage": "Data • Governance • Data • Stewardship",
  ...
  },
  {
    ...
    "fullTopic": "Data & Information Management",
    "d": "medium",
    "q": "A customer-support platform contains millions of case records. Agents frequently search for open cases using AccountID and CaseStatus, but searches are slow during peak hours. Analysts determine that the most common query filters on both fields together. Which action would MOST directly improve performance?",
    "opts": [
    ...
    "a": 1,
    "exp": "Correct answer is supported by the concept coverage: Index • Design • Query • Optimization. Reference: Database Performance; Indexes.",
    "objective": "Data & Information Management",
    "conceptCoverage": "Index • Design • Query • Optimization",
    "reference": "Database Performance; Indexes"
  },
  {
    "id": "DIM-055",
    ...
    "fullTopic": "Data & Information Management",
    "d": "medium",
    "q": "A research organization maintains participant identifiers, consent forms, laboratory results, and de-identified statistical data. Study coordinators need access to participant contact data, laboratory staff need limited access to sample identifiers, and statisticians need only de-identified records. Which access approach BEST supports this requirement?",
    "opts": [
    ...
    "a": 3,
    "exp": "Correct answer is supported by the concept coverage: Database • Security • Role-Based • Access • Control. Reference: Access Control; Database Security.",
    "objective": "Data & Information Management",
    "conceptCoverage": "Database • Security • Role-Based • Access • Control",
  ...
  },
  {
    ...
    "a": 2,
    "exp": "Correct answer is supported by the concept coverage: Data • Lake • vs. • Data • Warehouse. Reference: Modern Data Platforms; Analytical Data Management.",
    "objective": "Data & Information Management",
    "conceptCoverage": "Data • Lake • vs. • Data • Warehouse",
  ...
  },
  {
    ...
    "fullTopic": "Data & Information Management",
    "d": "medium",
    "q": "Which database constraint is MOST appropriate when a field must contain a value within a permitted range, such as an employee performance score from 1 through 5?",
    "opts": [
    ...
    "a": 0,
    "exp": "Correct answer is supported by the concept coverage: Recall • Database • Constraints. Reference: Relational Databases; Integrity Constraints.",
    "objective": "Data & Information Management",
    "conceptCoverage": "Recall • Database • Constraints",
    "reference": "Relational Databases; Integrity Constraints"
  },
  {
    "id": "DIM-058",
    ...
    "fullTopic": "Data & Information Management",
    "d": "medium",
    "q": "A law firm performs a full backup every Sunday and a differential backup every evening. On Friday afternoon, a server failure requires restoration. Differential backups contain all changes made since the most recent full backup. Which restoration sequence is typically required?",
    "opts": [
    ...
    "a": 2,
    "exp": "Correct answer is supported by the concept coverage: Backup • Strategies • Differential • Backups. Reference: Data Recovery; Backup and Restore.",
    "objective": "Data & Information Management",
    "conceptCoverage": "Backup • Strategies • Differential • Backups",
  ...
  },
  {
    ...
    "fullTopic": "Data & Information Management",
    "d": "medium",
    "q": "A sales manager needs a report showing product categories whose total quarterly revenue exceeds $500,000. The source table contains one row per sales transaction. Which SQL capability is MOST directly needed after grouping transactions by category?",
    "opts": [
    ...
    "a": 1,
    "exp": "Correct answer is supported by the concept coverage: SQL • Aggregation • HAVING • Clause. Reference: SQL; Aggregate Queries.",
    "objective": "Data & Information Management",
    "conceptCoverage": "SQL • Aggregation • HAVING • Clause",
    "reference": "SQL; Aggregate Queries"
  },
  {
    "id": "DIM-060",
    ...
    "fullTopic": "Data & Information Management",
    "d": "medium",
    "q": "A consulting firm stores public marketing materials, internal operating procedures, client financial records, and legal case documents. Security leadership wants controls that reflect the sensitivity and handling requirements of each information type. What should the organization establish FIRST?",
    "opts": [
    ...
    "a": 3,
    "exp": "Correct answer is supported by the concept coverage: Data • Classification • Information • Security. Reference: Data Governance; Information Classification.",
    "objective": "Data & Information Management",
    "conceptCoverage": "Data • Classification • Information • Security",
  ...
  },
  {
    ...
    "a": 2,
    "exp": "Correct answer is supported by the concept coverage: First • Normal • Form • Atomic • Values. Reference: Relational Database Design; Normalization.",
    "objective": "Data & Information Management",
    "conceptCoverage": "First • Normal • Form • Atomic • Values",
    "reference": "Relational Database Design; Normalization"
  },
  {
    "id": "DIM-062",
    ...
    "a": 0,
    "exp": "Correct answer is supported by the concept coverage: Surrogate • Keys • Natural • Keys. Reference: Relational Database Design; Keys.",
    "objective": "Data & Information Management",
    "conceptCoverage": "Surrogate • Keys • Natural • Keys",
  ...
  },
  {
    ...
    "fullTopic": "Data & Information Management",
    "d": "medium",
    "q": "An executive dashboard initially shows total revenue by region. A vice president selects the Midwest, then drills into individual states, stores, product categories, and specific promotional periods to investigate a revenue decline. Which analytical capability is MOST directly being used?",
    "opts": [
    ...
    "a": 3,
    "exp": "Correct answer is supported by the concept coverage: OLAP • Drill-Down • Analysis. Reference: Data Warehousing; Analytical Processing.",
    "objective": "Data & Information Management",
    "conceptCoverage": "OLAP • Drill-Down • Analysis",
  ...
  },
  {
    ...
    "fullTopic": "Data & Information Management",
    "d": "medium",
    "q": "A finance application runs the same complex revenue query every morning across several years of transaction data. The calculation joins multiple tables and aggregates millions of rows, but the underlying data changes only overnight. Which approach would MOST reasonably improve dashboard response time?",
    "opts": [
    ...
    "a": 1,
    "exp": "Correct answer is supported by the concept coverage: Materialized • Views • Reporting • Performance. Reference: Database Performance; Reporting Optimization.",
    "objective": "Data & Information Management",
    "conceptCoverage": "Materialized • Views • Reporting • Performance",
  ...
  },
  {
    ...
    "fullTopic": "Data & Information Management",
    "d": "medium",
    "q": "A public-health agency publishes a dashboard showing vaccination rates by county. Before relying on the figures, analysts need to know which source registries supplied the data, when records were extracted, what transformations occurred, and which quality checks were performed. What capability is MOST directly needed?",
    "opts": [
    ...
    "a": 2,
    "exp": "Correct answer is supported by the concept coverage: Data • Provenance • Auditability. Reference: Data Governance; Metadata and Lineage.",
    "objective": "Data & Information Management",
    "conceptCoverage": "Data • Provenance • Auditability",
  ...
  },
  {
    ...
    "fullTopic": "Data & Information Management",
    "d": "medium",
    "q": "Two purchasing-system transactions each lock a different supplier record. Transaction A then waits for the record locked by Transaction B, while Transaction B waits for the record locked by Transaction A. Neither transaction can continue without intervention. Which problem is MOST directly illustrated?",
    "opts": [
    ...
    "a": 0,
    "exp": "Correct answer is supported by the concept coverage: Deadlocks • Concurrency • Control. Reference: Transaction Processing; Concurrency.",
    "objective": "Data & Information Management",
    "conceptCoverage": "Deadlocks • Concurrency • Control",
    "reference": "Transaction Processing; Concurrency"
  },
  {
    "id": "DIM-067",
    ...
    "a": 1,
    "exp": "Correct answer is supported by the concept coverage: Master • Data • Management • Golden • Record. Reference: Data Governance; Master Data Management.",
    "objective": "Data & Information Management",
    "conceptCoverage": "Master • Data • Management • Golden • Record",
    "reference": "Data Governance; Master Data Management"
  },
  {
    "id": "DIM-068",
    ...
    "a": 3,
    "exp": "Correct answer is supported by the concept coverage: Encryption • in • Transit • Data • Security. Reference: Database Security; Information Protection.",
    "objective": "Data & Information Management",
    "conceptCoverage": "Encryption • in • Transit • Data • Security",
  ...
  },
  {
    ...
    "fullTopic": "Data & Information Management",
    "d": "medium",
    "q": "A retailer’s customer dimension includes region. When a customer moves from the Northeast to the Southwest, executives still want historical sales reports to reflect the region assigned when each purchase occurred. Which data-warehouse approach BEST supports this reporting need?",
    "opts": [
    ...
    "a": 2,
    "exp": "Correct answer is supported by the concept coverage: Slowly • Changing • Dimensions • Historical • Reporting. Reference: Data Warehousing; Dimensional Modeling.",
    "objective": "Data & Information Management",
    "conceptCoverage": "Slowly • Changing • Dimensions • Historical • Reporting",
    "reference": "Data Warehousing; Dimensional Modeling"
  },
  {
    "id": "DIM-070",
    ...
    "fullTopic": "Data & Information Management",
    "d": "medium",
    "q": "An employee database stores employment status using values such as Active, Leave, Retired, and Terminated. Managers want to prevent accidental entries such as “Actve,” “Temporary,” or blank values when those are not permitted by organizational policy. Which control MOST directly supports this requirement?",
    "opts": [
    ...
    "a": 0,
    "exp": "Correct answer is supported by the concept coverage: Data • Validation • Domain • Integrity. Reference: Relational Databases; Integrity Constraints.",
    "objective": "Data & Information Management",
    "conceptCoverage": "Data • Validation • Domain • Integrity",
    "reference": "Relational Databases; Integrity Constraints"
  },
  {
    "id": "DIM-071",
    ...
    "fullTopic": "Data & Information Management",
    "d": "medium",
    "q": "A sales director needs a report that shows each salesperson’s monthly revenue, the regional average for that month, and the salesperson’s rank within the region. The director does not want to collapse individual salesperson rows into one row per region. Which SQL capability is MOST appropriate?",
    "opts": [
    ...
    "a": 1,
    "exp": "Correct answer is supported by the concept coverage: SQL • Window • Functions • Analytical • Queries. Reference: SQL; Advanced Querying.",
    "objective": "Data & Information Management",
    "conceptCoverage": "SQL • Window • Functions • Analytical • Queries",
  ...
  },
  {
    ...
    "fullTopic": "Data & Information Management",
    "d": "medium",
    "q": "A law firm’s document system has a standard retention rule that deletes closed-case records after seven years. A client becomes involved in litigation during year six, and relevant records may be needed as evidence. What should the firm do MOST appropriately?",
    "opts": [
    ...
    "a": 3,
    "exp": "Correct answer is supported by the concept coverage: Data • Retention • Legal • Hold. Reference: Information Lifecycle Management; Records Management.",
    "objective": "Data & Information Management",
    "conceptCoverage": "Data • Retention • Legal • Hold",
  ...
  },
  {
    ...
    "fullTopic": "Data & Information Management",
    "d": "medium",
    "q": "A customer-service table contains tens of millions of records. Nearly every row has Status = 'Closed', while only a small fraction have Status = 'Open'. Agents frequently search for open cases assigned to a particular queue. Which index-design consideration is MOST relevant?",
    "opts": [
    ...
    "a": 2,
    "exp": "Correct answer is supported by the concept coverage: Query • Optimization • Index • Selectivity. Reference: Database Performance; Indexes.",
    "objective": "Data & Information Management",
    "conceptCoverage": "Query • Optimization • Index • Selectivity",
    "reference": "Database Performance; Indexes"
  },
  {
    "id": "DIM-074",
    ...
    "fullTopic": "Data & Information Management",
    "d": "medium",
    "q": "Which SQL statement category is primarily used to grant or revoke permissions on database objects such as tables, views, and procedures?",
    "opts": [
      "Data Control Language",
      "Data Definition Language",
      "Data Manipulation Language",
    ...
    "a": 0,
    "exp": "Correct answer is supported by the concept coverage: Recall • Data • Manipulation • vs. • Data • Control. Reference: SQL; Database Management Systems.",
    "objective": "Data & Information Management",
    "conceptCoverage": "Recall • Data • Manipulation • vs. • Data • Control",
    "reference": "SQL; Database Management Systems"
  },
  {
    "id": "DIM-075",
    ...
    "fullTopic": "Data & Information Management",
    "d": "medium",
    "q": "A retail database contains a field for delivery date. Most records contain a value, but some include impossible dates, such as February 30, while others contain text values where a valid date should appear. Which data-quality dimension is MOST directly compromised?",
    "opts": [
    ...
    "a": 1,
    "exp": "Correct answer is supported by the concept coverage: Data • Quality • Validity. Reference: Data Quality Management.",
    "objective": "Data & Information Management",
    "conceptCoverage": "Data • Quality • Validity",
    "reference": "Data Quality Management"
  },
  {
    "id": "DIM-076",
    ...
    "fullTopic": "Data & Information Management",
    "d": "medium",
    "q": "A university stores instructor information only in a CourseAssignment table. A newly hired instructor cannot be entered into the database until the instructor is assigned to at least one course section. The university wants to store instructor records independently of current teaching assignments. Which design issue is MOST directly illustrated?",
    "opts": [
    ...
    "a": 1,
    "exp": "Correct answer is supported by the concept coverage: Database • Normalization • Insertion • Anomalies. Reference: Relational Database Design; Normalization.",
    "objective": "Data & Information Management",
    "conceptCoverage": "Database • Normalization • Insertion • Anomalies",
    "reference": "Relational Database Design; Normalization"
  },
  {
    "id": "DIM-077",
    ...
    "fullTopic": "Data & Information Management",
    "d": "medium",
    "q": "An Employee table contains EmployeeID, EmployeeName, and ManagerID, where ManagerID references another EmployeeID in the same table. A human-resources analyst needs a report showing each employee alongside the name of that employee’s manager. Which SQL technique is MOST appropriate?",
    "opts": [
    ...
    "a": 3,
    "exp": "Correct answer is supported by the concept coverage: SQL • Joins • Self • Joins. Reference: SQL; Relational Queries.",
    "objective": "Data & Information Management",
    "conceptCoverage": "SQL • Joins • Self • Joins",
    "reference": "SQL; Relational Queries"
  },
  {
    "id": "DIM-078",
    ...
    "a": 0,
    "exp": "Correct answer is supported by the concept coverage: Transaction • Processing • Atomicity. Reference: Transaction Processing; ACID Properties.",
    "objective": "Data & Information Management",
    "conceptCoverage": "Transaction • Processing • Atomicity",
    "reference": "Transaction Processing; ACID Properties"
  },
  {
    "id": "DIM-079",
    ...
    "fullTopic": "Data & Information Management",
    "d": "medium",
    "q": "A retailer is designing a sales fact table for trend reporting. Executives want to analyze revenue by individual transaction, product, store, customer segment, and calendar date. Before selecting measures and dimension keys, what should the data-warehouse team define FIRST?",
    "opts": [
    ...
    "a": 2,
    "exp": "Correct answer is supported by the concept coverage: Data • Warehouse • Grain. Reference: Data Warehousing; Fact Tables.",
    "objective": "Data & Information Management",
    "conceptCoverage": "Data • Warehouse • Grain",
  ...
  },
  {
    ...
    "fullTopic": "Data & Information Management",
    "d": "medium",
    "q": "A health system finds that no department is accountable for correcting inaccurate provider-directory information shared across scheduling, billing, and patient-portal systems. Errors persist because each team assumes another group owns the data. Which action would MOST directly address the problem?",
    "opts": [
    ...
    "a": 1,
    "exp": "Correct answer is supported by the concept coverage: Data • Governance • Data • Ownership. Reference: Data Governance; Stewardship.",
    "objective": "Data & Information Management",
    "conceptCoverage": "Data • Governance • Data • Ownership",
  ...
  },
  {
    ...
    "fullTopic": "Data & Information Management",
    "d": "medium",
    "q": "A web-based claims portal lets users search for claims by policy number. Developers build SQL statements by concatenating the user’s entered value directly into the query string. Which revision MOST directly reduces the risk that malicious input could alter the intended query?",
    "opts": [
    ...
    "a": 0,
    "exp": "Correct answer is supported by the concept coverage: SQL • Injection • Secure • Query • Construction. Reference: Database Security; Application Security.",
    "objective": "Data & Information Management",
    "conceptCoverage": "SQL • Injection • Secure • Query • Construction",
    "reference": "Database Security; Application Security"
  },
  {
    "id": "DIM-082",
    ...
    "a": 3,
    "exp": "Correct answer is supported by the concept coverage: Data • Quality • Uniqueness. Reference: Data Quality Management.",
    "objective": "Data & Information Management",
    "conceptCoverage": "Data • Quality • Uniqueness",
    "reference": "Data Quality Management"
  },
  {
    "id": "DIM-083",
    ...
    "a": 2,
    "exp": "Correct answer is supported by the concept coverage: Views • Security • and • Simplification. Reference: SQL; Views.",
    "objective": "Data & Information Management",
    "conceptCoverage": "Views • Security • and • Simplification",
    "reference": "SQL; Views"
  },
  {
    "id": "DIM-084",
    ...
    "fullTopic": "Data & Information Management",
    "d": "medium",
    "q": "A purchasing application allows multiple employees to edit supplier contracts. The database team wants to reduce the chance that two transactions each hold a lock needed by the other, causing both to wait indefinitely. Which strategy MOST directly helps prevent this situation?",
    "opts": [
    ...
    "a": 1,
    "exp": "Correct answer is supported by the concept coverage: Concurrency • Control • Deadlock • Prevention. Reference: Transaction Processing; Concurrency.",
    "objective": "Data & Information Management",
    "conceptCoverage": "Concurrency • Control • Deadlock • Prevention",
    "reference": "Transaction Processing; Concurrency"
  },
  {
    "id": "DIM-085",
    ...
    "fullTopic": "Data & Information Management",
    "d": "medium",
    "q": "A retailer wants sales reports to show the sales territory assigned to each store at the time a transaction occurred, even after the store is reassigned to a different regional manager. Which approach BEST preserves this historical reporting requirement?",
    "opts": [
    ...
    "a": 3,
    "exp": "Correct answer is supported by the concept coverage: Slowly • Changing • Dimensions • Historical • Accuracy. Reference: Data Warehousing; Dimensional Modeling.",
    "objective": "Data & Information Management",
    "conceptCoverage": "Slowly • Changing • Dimensions • Historical • Accuracy",
    "reference": "Data Warehousing; Dimensional Modeling"
  },
  {
    "id": "DIM-086",
    ...
    "fullTopic": "Data & Information Management",
    "d": "medium",
    "q": "Which SQL statement is primarily used to modify the definition of an existing table, such as adding a new column or changing a column’s data type?",
    "opts": [
      "ALTER TABLE",
      "UPDATE",
      "SELECT",
    ...
    "a": 0,
    "exp": "Correct answer is supported by the concept coverage: Recall • SQL • DDL. Reference: SQL; Database Management Systems.",
    "objective": "Data & Information Management",
    "conceptCoverage": "Recall • SQL • DDL",
    "reference": "SQL; Database Management Systems"
  },
  {
    "id": "DIM-087",
    ...
    "fullTopic": "Data & Information Management",
    "d": "medium",
    "q": "A financial organization stores sensitive account information in a database hosted by a third-party cloud provider. Security leaders want protection if storage media, database files, or backups are accessed without authorization. Which control MOST directly addresses this risk?",
    "opts": [
    ...
    "a": 2,
    "exp": "Correct answer is supported by the concept coverage: Data • Encryption • At • Rest. Reference: Database Security; Information Protection.",
    "objective": "Data & Information Management",
    "conceptCoverage": "Data • Encryption • At • Rest",
    "reference": "Database Security; Information Protection"
  },
  {
    "id": "DIM-088",
    ...
    "fullTopic": "Data & Information Management",
    "d": "medium",
    "q": "A company database stores PurchaseOrder records that reference Supplier records. A database administrator considers enabling cascading deletion so deleting a supplier would automatically delete all associated purchase orders. Which concern is MOST appropriate?",
    "opts": [
    ...
    "a": 1,
    "exp": "Correct answer is supported by the concept coverage: Referential • Integrity • Cascading • Actions. Reference: Relational Databases; Foreign Keys.",
    "objective": "Data & Information Management",
    "conceptCoverage": "Referential • Integrity • Cascading • Actions",
  ...
  },
  {
    ...
    "fullTopic": "Data & Information Management",
    "d": "medium",
    "q": "A firm performs a full database backup every Saturday night and incremental backups each weekday evening. On Friday morning, the database fails. Incremental backups capture only changes since the most recent backup of any type. Which restoration sequence is typically required?",
    "opts": [
    ...
    "a": 3,
    "exp": "Correct answer is supported by the concept coverage: Backup • and • Recovery • Incremental • Backups. Reference: Data Recovery; Backup Strategies.",
    "objective": "Data & Information Management",
    "conceptCoverage": "Backup • and • Recovery • Incremental • Backups",
    "reference": "Data Recovery; Backup Strategies"
  },
  {
    "id": "DIM-090",
    ...
    "fullTopic": "Data & Information Management",
    "d": "medium",
    "q": "A consulting firm stores public brochures, internal procedures, confidential client financial data, and privileged legal documents. Leadership wants access, retention, sharing, and protection requirements to vary according to the sensitivity of each information type. What should the firm establish FIRST?",
    "opts": [
    ...
    "a": 0,
    "exp": "Correct answer is supported by the concept coverage: Data • Classification • Handling • Controls. Reference: Data Governance; Information Security.",
    "objective": "Data & Information Management",
    "conceptCoverage": "Data • Classification • Handling • Controls",
  ...
  },
  {
    ...
    "a": 1,
    "exp": "Correct answer is supported by the concept coverage: Database • Normalization • Deletion • Anomalies. Reference: Relational Database Design; Normalization.",
    "objective": "Data & Information Management",
    "conceptCoverage": "Database • Normalization • Deletion • Anomalies",
    "reference": "Relational Database Design; Normalization"
  },
  {
    "id": "DIM-092",
    ...
    "fullTopic": "Data & Information Management",
    "d": "medium",
    "q": "A hospital needs a report showing each physician and all active clinical trials in which the physician participates. Physicians may participate in multiple trials, and each trial may include multiple physicians. The database uses a PhysicianTrial table containing PhysicianID, TrialID, role, and start date. Which query approach is MOST appropriate?",
    "opts": [
    ...
    "a": 2,
    "exp": "Correct answer is supported by the concept coverage: SQL • Joins • Many-to-Many • Relationships. Reference: SQL; Relational Queries.",
    "objective": "Data & Information Management",
    "conceptCoverage": "SQL • Joins • Many-to-Many • Relationships",
    "reference": "SQL; Relational Queries"
  },
  {
    "id": "DIM-093",
    ...
    "a": 0,
    "exp": "Correct answer is supported by the concept coverage: ACID • Properties • Isolation • Levels. Reference: Transaction Processing; Concurrency Control.",
    "objective": "Data & Information Management",
    "conceptCoverage": "ACID • Properties • Isolation • Levels",
    "reference": "Transaction Processing; Concurrency Control"
  },
  {
    "id": "DIM-094",
    ...
    "a": 3,
    "exp": "Correct answer is supported by the concept coverage: Data • Warehouses • Star • Schemas. Reference: Dimensional Modeling; Fact and Dimension Tables.",
    "objective": "Data & Information Management",
    "conceptCoverage": "Data • Warehouses • Star • Schemas",
  ...
  },
  {
    ...
    "a": 1,
    "exp": "Correct answer is supported by the concept coverage: Data • Governance • Business • Glossaries. Reference: Data Governance; Metadata Management.",
    "objective": "Data & Information Management",
    "conceptCoverage": "Data • Governance • Business • Glossaries",
    "reference": "Data Governance; Metadata Management"
  },
  {
    "id": "DIM-096",
    ...
    "fullTopic": "Data & Information Management",
    "d": "medium",
    "q": "A healthcare organization wants to report the number of unique patients who had at least one emergency-department visit during each calendar month. The Visits table includes PatientID, VisitDate, VisitType, and FacilityID, and individual patients may have multiple visits in one month. Which SQL technique is MOST directly needed?",
    "opts": [
    ...
    "a": 0,
    "exp": "Correct answer is supported by the concept coverage: SQL • Aggregation • DISTINCT • Counts. Reference: SQL; Aggregate Queries.",
    "objective": "Data & Information Management",
    "conceptCoverage": "SQL • Aggregation • DISTINCT • Counts",
    "reference": "SQL; Aggregate Queries"
  },
  {
    "id": "DIM-097",
    ...
    "a": 2,
    "exp": "Correct answer is supported by the concept coverage: Role-Based • Access • Control • Separation • of • Duties. Reference: Database Security; Access Management.",
    "objective": "Data & Information Management",
    "conceptCoverage": "Role-Based • Access • Control • Separation • of • Duties",
  ...
  },
  {
    ...
    "fullTopic": "Data & Information Management",
    "d": "medium",
    "q": "A call-center application displays customer account information to support representatives. Representatives need to confirm the last four digits of a bank account but should never see the complete account number, even while viewing live customer records. Which control BEST meets this requirement?",
    "opts": [
    ...
    "a": 3,
    "exp": "Correct answer is supported by the concept coverage: Data • Masking • Dynamic • Privacy • Controls. Reference: Database Security; Privacy Protection.",
    "objective": "Data & Information Management",
    "conceptCoverage": "Data • Masking • Dynamic • Privacy • Controls",
    "reference": "Database Security; Privacy Protection"
  },
  {
    "id": "DIM-099",
    ...
    "fullTopic": "Data & Information Management",
    "d": "medium",
    "q": "A manufacturer integrates order data from regional subsidiaries. One system identifies a customer using a numeric code, another uses an alphanumeric account ID, and a third uses separate country and local-account fields. The integration team wants downstream applications to process customer records through a consistent enterprise format. What is the MOST appropriate approach?",
    "opts": [
    ...
    "a": 1,
    "exp": "Correct answer is supported by the concept coverage: Data • Integration • Canonical • Data • Models. Reference: Enterprise Data Integration; Data Architecture.",
    "objective": "Data & Information Management",
    "conceptCoverage": "Data • Integration • Canonical • Data • Models",
  ...
  },
  {
    ...
    "fullTopic": "Data & Information Management",
    "d": "medium",
    "q": "A patient-registration system accepts a validly formatted postal code for a patient’s address. Later, staff discover that the postal code belongs to a different city than the one recorded in the address field. Which data-quality issue is MOST directly demonstrated?",
    "opts": [
    ...
    "a": 2,
    "exp": "Correct answer is supported by the concept coverage: Data • Quality • Accuracy • vs. • Validity. Reference: Data Quality Management.",
    "objective": "Data & Information Management",
    "conceptCoverage": "Data • Quality • Accuracy • vs. • Validity",
    "reference": "Data Quality Management"
  },
  {
    "id": "DIM-101",
    ...
    "a": 0,
    "exp": "Correct answer is supported by the concept coverage: Database • Replication • Availability. Reference: Database Architecture; High Availability.",
    "objective": "Data & Information Management",
    "conceptCoverage": "Database • Replication • Availability",
  ...
  },
  {
    ...
    "a": 3,
    "exp": "Correct answer is supported by the concept coverage: SQL • Views • Updatable • vs. • Read-Only • Data. Reference: SQL; Views and Data Access.",
    "objective": "Data & Information Management",
    "conceptCoverage": "SQL • Views • Updatable • vs. • Read-Only • Data",
  ...
  },
  {
    ...
    "a": 1,
    "exp": "Correct answer is supported by the concept coverage: Data • Retention • Archiving. Reference: Information Lifecycle Management; Records Management.",
    "objective": "Data & Information Management",
    "conceptCoverage": "Data • Retention • Archiving",
    "reference": "Information Lifecycle Management; Records Management"
  },
  {
    "id": "DIM-104",
    ...
    "fullTopic": "Data & Information Management",
    "d": "medium",
    "q": "Which SQL command makes the changes in the current transaction permanent?",
    "opts": [
      "ROLLBACK",
      "SAVEPOINT",
      "COMMIT",
    ...
    "a": 2,
    "exp": "Correct answer is supported by the concept coverage: Recall • SQL • Transaction • Control. Reference: SQL; Transaction Management.",
    "objective": "Data & Information Management",
    "conceptCoverage": "Recall • SQL • Transaction • Control",
  ...
  },
  {
    ...
    "fullTopic": "Data & Information Management",
    "d": "medium",
    "q": "A nonprofit database allows volunteers to enter donation records before a donor profile has been selected. This creates transaction rows with no donor identifier, making it impossible to determine who made certain contributions. Which design control would MOST directly prevent this issue?",
    "opts": [
    ...
    "a": 0,
    "exp": "Correct answer is supported by the concept coverage: Database • Design • Entity • Integrity. Reference: Relational Databases; Integrity Constraints.",
    "objective": "Data & Information Management",
    "conceptCoverage": "Database • Design • Entity • Integrity",
    "reference": "Relational Databases; Integrity Constraints"
  },
  {
    "id": "PM-001",
    "t": "Project",
    "fullTopic": "IT Project Management",
    "d": "medium",
    "q": "A regional hospital is considering a new operating-room scheduling system. Before detailed requirements gathering begins, executives want a document that formally identifies the business problem, project sponsor, high-level objectives, major constraints, initial budget assumptions, and authority to begin the work. Which project artifact is MOST appropriate?",
    "opts": [
    ...
    "a": 1,
    "exp": "Correct answer is supported by the concept coverage: Project • Charter • Sponsor • Authorization. Reference: Project Initiation; Project Charter.",
    "objective": "IT Project Management",
    "conceptCoverage": "Project • Charter • Sponsor • Authorization",
  ...
  },
  {
    ...
    "a": 3,
    "exp": "Correct answer is supported by the concept coverage: Work • Breakdown • Structure • Scope • Planning. Reference: Project Planning; Work Breakdown Structure.",
    "objective": "IT Project Management",
    "conceptCoverage": "Work • Breakdown • Structure • Scope • Planning",
  ...
  },
  {
    ...
    "fullTopic": "IT Project Management",
    "d": "medium",
    "q": "A software project has several linked activities. If a delay in database migration would delay interface testing, user acceptance testing, and final deployment, the project manager identifies the migration activity as having zero schedule flexibility. What does this MOST directly indicate?",
    "opts": [
    ...
    "a": 0,
    "exp": "Correct answer is supported by the concept coverage: Critical • Path • Schedule • Management. Reference: Project Scheduling; Critical Path Method.",
    "objective": "IT Project Management",
    "conceptCoverage": "Critical • Path • Schedule • Management",
  ...
  },
  {
    ...
    "a": 2,
    "exp": "Correct answer is supported by the concept coverage: Scope • Baseline • Change • Control. Reference: Scope Management; Change Governance.",
    "objective": "IT Project Management",
    "conceptCoverage": "Scope • Baseline • Change • Control",
  ...
  },
  {
    ...
    "a": 1,
    "exp": "Correct answer is supported by the concept coverage: Risk • Register • Risk • Ownership. Reference: Risk Management; Risk Planning.",
    "objective": "IT Project Management",
    "conceptCoverage": "Risk • Register • Risk • Ownership",
  ...
  },
  {
    ...
    "a": 3,
    "exp": "Correct answer is supported by the concept coverage: Risk • Response • Strategies. Reference: Risk Management; Response Planning.",
    "objective": "IT Project Management",
    "conceptCoverage": "Risk • Response • Strategies",
  ...
  },
  {
    ...
    "a": 2,
    "exp": "Correct answer is supported by the concept coverage: Stakeholder • Analysis • Communication • Planning. Reference: Stakeholder Management; Communication Planning.",
    "objective": "IT Project Management",
    "conceptCoverage": "Stakeholder • Analysis • Communication • Planning",
  ...
  },
  {
    ...
    "fullTopic": "IT Project Management",
    "d": "medium",
    "q": "A project plan identifies “Requirements Approved,” “Data Migration Complete,” “User Acceptance Testing Complete,” and “Production Go-Live” as major checkpoints. These items have no planned duration but are used to assess whether the project has reached important decision points. What are these items MOST accurately called?",
    "opts": [
    ...
    "a": 0,
    "exp": "Correct answer is supported by the concept coverage: Milestones • Schedule • Tracking. Reference: Project Scheduling; Milestones.",
    "objective": "IT Project Management",
    "conceptCoverage": "Milestones • Schedule • Tracking",
  ...
  },
  {
    ...
    "a": 3,
    "exp": "Correct answer is supported by the concept coverage: Resource • Constraints • Schedule • Trade-Offs. Reference: Project Scheduling; Resource Management.",
    "objective": "IT Project Management",
    "conceptCoverage": "Resource • Constraints • Schedule • Trade-Offs",
  ...
  },
  {
    ...
    "fullTopic": "IT Project Management",
    "d": "medium",
    "q": "A project has planned to complete 60% of its work by the end of the month. The team has actually completed 45% of the planned scope, although spending is close to the original budget. Which conclusion is MOST appropriate?",
    "opts": [
    ...
    "a": 1,
    "exp": "Correct answer is supported by the concept coverage: Earned • Value • Schedule • Performance. Reference: Project Monitoring and Control; Earned Value Management.",
    "objective": "IT Project Management",
    "conceptCoverage": "Earned • Value • Schedule • Performance",
  ...
  },
  {
    ...
    "fullTopic": "IT Project Management",
    "d": "medium",
    "q": "A development team is preparing for its next iteration of a claims-processing application. Several backlog items have unclear acceptance criteria, uncertain dependencies, and incomplete estimates. Before selecting work for the upcoming sprint, what should the team do?",
    "opts": [
    ...
    "a": 2,
    "exp": "Correct answer is supported by the concept coverage: Agile • Project • Management • Product • Backlog. Reference: Agile Planning; Product Backlog.",
    "objective": "IT Project Management",
    "conceptCoverage": "Agile • Project • Management • Product • Backlog",
  ...
  },
  {
    ...
    "fullTopic": "IT Project Management",
    "d": "medium",
    "q": "Which project-management tool is MOST commonly used to display activities against a calendar timeline, including planned durations, start dates, finish dates, and overlapping work?",
    "opts": [
      "Gantt chart",
      "Risk register",
      "Stakeholder matrix",
    ...
    "a": 0,
    "exp": "Correct answer is supported by the concept coverage: Recall • Gantt • Charts. Reference: Project Scheduling; Gantt Charts.",
    "objective": "IT Project Management",
    "conceptCoverage": "Recall • Gantt • Charts",
  ...
  },
  {
    ...
    "a": 3,
    "exp": "Correct answer is supported by the concept coverage: Quality • Management • Acceptance • Criteria. Reference: Quality Planning; Project Validation.",
    "objective": "IT Project Management",
    "conceptCoverage": "Quality • Management • Acceptance • Criteria",
  ...
  },
  {
    ...
    "a": 1,
    "exp": "Correct answer is supported by the concept coverage: Project • Closeout • Lessons • Learned. Reference: Project Closeout; Continuous Improvement.",
    "objective": "IT Project Management",
    "conceptCoverage": "Project • Closeout • Lessons • Learned",
  ...
  },
  {
    ...
    "fullTopic": "IT Project Management",
    "d": "medium",
    "q": "A project team discovers that a planned interface with an external vendor cannot meet required security standards without substantial redesign. The issue exceeds the project manager’s delegated authority because it may affect budget, launch timing, and contractual obligations. What should the project manager do MOST appropriately?",
    "opts": [
    ...
    "a": 3,
    "exp": "Correct answer is supported by the concept coverage: Project • Governance • Escalation. Reference: Governance; Issue Management.",
    "objective": "IT Project Management",
    "conceptCoverage": "Project • Governance • Escalation",
  ...
  },
  {
    ...
    "a": 2,
    "exp": "Correct answer is supported by the concept coverage: Project • Scope • Statement • Deliverables. Reference: Scope Management; Project Planning.",
    "objective": "IT Project Management",
    "conceptCoverage": "Project • Scope • Statement • Deliverables",
  ...
  },
  {
    ...
    "a": 0,
    "exp": "Correct answer is supported by the concept coverage: Dependencies • Finish-to-Start • Relationships. Reference: Project Scheduling; Activity Dependencies.",
    "objective": "IT Project Management",
    "conceptCoverage": "Dependencies • Finish-to-Start • Relationships",
  ...
  },
  {
    ...
    "fullTopic": "IT Project Management",
    "d": "medium",
    "q": "A retailer plans to launch a new point-of-sale system before the holiday season. The project team identifies a risk that store-network instability may interrupt payment processing during rollout. What response BEST represents risk mitigation rather than avoidance, transfer, or simple acceptance?",
    "opts": [
    ...
    "a": 3,
    "exp": "Correct answer is supported by the concept coverage: Risk • Mitigation • Contingency • Planning. Reference: Risk Management; Response Strategies.",
    "objective": "IT Project Management",
    "conceptCoverage": "Risk • Mitigation • Contingency • Planning",
  ...
  },
  {
    ...
    "fullTopic": "IT Project Management",
    "d": "medium",
    "q": "A hospital project involves IT, nursing, pharmacy, compliance, and vendor staff. Team members repeatedly ask who has authority to approve medication-workflow changes, who performs training, who must be consulted on policy, and who only needs status updates. Which tool would MOST directly clarify these responsibilities?",
    "opts": [
    ...
    "a": 1,
    "exp": "Correct answer is supported by the concept coverage: RACI • Matrix • Accountability. Reference: Project Governance; Responsibility Assignment.",
    "objective": "IT Project Management",
    "conceptCoverage": "RACI • Matrix • Accountability",
  ...
  },
  {
    ...
    "a": 2,
    "exp": "Correct answer is supported by the concept coverage: Schedule • Compression • Fast • Tracking. Reference: Project Scheduling; Schedule Compression.",
    "objective": "IT Project Management",
    "conceptCoverage": "Schedule • Compression • Fast • Tracking",
  ...
  },
  {
    ...
    "a": 0,
    "exp": "Correct answer is supported by the concept coverage: Project • Baseline • Performance • Measurement. Reference: Project Monitoring and Control; Baselines.",
    "objective": "IT Project Management",
    "conceptCoverage": "Project • Baseline • Performance • Measurement",
  ...
  },
  {
    ...
    "fullTopic": "IT Project Management",
    "d": "medium",
    "q": "A project has completed work valued at $240,000 according to the approved plan, but actual spending for that work totals $300,000. Which conclusion is MOST appropriate?",
    "opts": [
    ...
    "a": 1,
    "exp": "Correct answer is supported by the concept coverage: Earned • Value • Cost • Performance. Reference: Project Monitoring and Control; Earned Value Management.",
    "objective": "IT Project Management",
    "conceptCoverage": "Earned • Value • Cost • Performance",
    "reference": "Project Monitoring and Control; Earned Value Management"
  },
  {
    "id": "PM-023",
    ...
    "fullTopic": "IT Project Management",
    "d": "medium",
    "q": "A product team is selecting work for a two-week sprint. The team wants a concise statement describing the business outcome the sprint should achieve, helping members make trade-offs if unexpected work emerges. Which Agile concept MOST directly serves this purpose?",
    "opts": [
    ...
    "a": 3,
    "exp": "Correct answer is supported by the concept coverage: Agile • Planning • Sprint • Goal. Reference: Agile Project Management; Sprint Planning.",
    "objective": "IT Project Management",
    "conceptCoverage": "Agile • Planning • Sprint • Goal",
  ...
  },
  {
    ...
    "a": 2,
    "exp": "Correct answer is supported by the concept coverage: Procurement • Management • Make-or-Buy • Analysis. Reference: Project Procurement; Vendor Selection.",
    "objective": "IT Project Management",
    "conceptCoverage": "Procurement • Management • Make-or-Buy • Analysis",
  ...
  },
  {
    ...
    "fullTopic": "IT Project Management",
    "d": "medium",
    "q": "During testing, a vendor informs the project team that a required interface cannot meet encryption standards without significant redesign. The issue threatens compliance, budget, and launch timing, and the project manager lacks authority to alter the vendor contract. What should the project manager do FIRST?",
    "opts": [
    ...
    "a": 0,
    "exp": "Correct answer is supported by the concept coverage: Issue • Management • Escalation. Reference: Governance; Issue and Decision Management.",
    "objective": "IT Project Management",
    "conceptCoverage": "Issue • Management • Escalation",
  ...
  },
  {
    ...
    "fullTopic": "IT Project Management",
    "d": "medium",
    "q": "A development organization reviews coding practices, peer-review procedures, test standards, and defect-prevention activities throughout a project. Separately, testers inspect completed software for errors and compare results with acceptance criteria. Which statement BEST distinguishes these activities?",
    "opts": [
    ...
    "a": 1,
    "exp": "Correct answer is supported by the concept coverage: Quality • Assurance • vs. • Quality • Control. Reference: Quality Management; Process and Deliverable Quality.",
    "objective": "IT Project Management",
    "conceptCoverage": "Quality • Assurance • vs. • Quality • Control",
  ...
  },
  {
    ...
    "fullTopic": "IT Project Management",
    "d": "medium",
    "q": "Which Agile artifact typically displays remaining work over the duration of a sprint or release, helping the team assess whether it is progressing toward completion?",
    "opts": [
      "Risk register",
      "Product roadmap",
      "Stakeholder matrix",
    ...
    "a": 3,
    "exp": "Correct answer is supported by the concept coverage: Recall • Burndown • Charts. Reference: Agile Project Management; Monitoring Progress.",
    "objective": "IT Project Management",
    "conceptCoverage": "Recall • Burndown • Charts",
  ...
  },
  {
    ...
    "fullTopic": "IT Project Management",
    "d": "medium",
    "q": "A company is implementing a new expense-management system. Finance leaders support the initiative, but field employees are concerned that the new mobile submission process will increase scrutiny and reduce flexibility. Which action would MOST likely improve stakeholder engagement and adoption?",
    "opts": [
    ...
    "a": 2,
    "exp": "Correct answer is supported by the concept coverage: Stakeholder • Engagement • Resistance • Management. Reference: Stakeholder Management; Change Enablement.",
    "objective": "IT Project Management",
    "conceptCoverage": "Stakeholder • Engagement • Resistance • Management",
  ...
  },
  {
    ...
    "fullTopic": "IT Project Management",
    "d": "medium",
    "q": "A project schedule assigns the same database architect to three tasks planned for the same week. The architect cannot work on all three simultaneously, and two activities are not on the critical path. What action BEST reflects resource leveling?",
    "opts": [
    ...
    "a": 0,
    "exp": "Correct answer is supported by the concept coverage: Resource • Leveling • Schedule • Trade-Offs. Reference: Resource Management; Schedule Optimization.",
    "objective": "IT Project Management",
    "conceptCoverage": "Resource • Leveling • Schedule • Trade-Offs",
  ...
  },
  {
    ...
    "a": 1,
    "exp": "Correct answer is supported by the concept coverage: Project • Closeout • Contract • Closure. Reference: Project Closeout; Procurement Management.",
    "objective": "IT Project Management",
    "conceptCoverage": "Project • Closeout • Contract • Closure",
  ...
  },
  {
    ...
    "a": 0,
    "exp": "Correct answer is supported by the concept coverage: Risk • Response • Contingency • Reserves. Reference: Risk Management; Cost and Schedule Planning.",
    "objective": "IT Project Management",
    "conceptCoverage": "Risk • Response • Contingency • Reserves",
  ...
  },
  {
    ...
    "fullTopic": "IT Project Management",
    "d": "medium",
    "q": "A software project schedules user-training preparation to begin five business days before final system testing is expected to finish. Training materials can be drafted using stable workflows, but final examples cannot be completed until testing confirms the system behavior. What scheduling concept is MOST directly represented?",
    "opts": [
    ...
    "a": 1,
    "exp": "Correct answer is supported by the concept coverage: Project • Schedule • Lead • and • Lag. Reference: Project Scheduling; Activity Relationships.",
    "objective": "IT Project Management",
    "conceptCoverage": "Project • Schedule • Lead • and • Lag",
  ...
  },
  {
    ...
    "a": 2,
    "exp": "Correct answer is supported by the concept coverage: Scope • Creep • Change • Governance. Reference: Scope Management; Integrated Change Control.",
    "objective": "IT Project Management",
    "conceptCoverage": "Scope • Creep • Change • Governance",
  ...
  },
  {
    ...
    "fullTopic": "IT Project Management",
    "d": "medium",
    "q": "A product team completed 32 story points in Sprint 1, 29 in Sprint 2, 31 in Sprint 3, and 30 in Sprint 4. The product owner wants a practical estimate of how much work the team can likely complete in an upcoming sprint, assuming similar staffing and complexity. Which measure is MOST useful?",
    "opts": [
    ...
    "a": 1,
    "exp": "Correct answer is supported by the concept coverage: Agile • Metrics • Velocity. Reference: Agile Project Management; Iteration Planning.",
    "objective": "IT Project Management",
    "conceptCoverage": "Agile • Metrics • Velocity",
  ...
  },
  {
    ...
    "a": 0,
    "exp": "Correct answer is supported by the concept coverage: Quality • Management • Cost • of • Quality. Reference: Quality Planning; Defect Prevention.",
    "objective": "IT Project Management",
    "conceptCoverage": "Quality • Management • Cost • of • Quality",
  ...
  },
  {
    ...
    "a": 2,
    "exp": "Correct answer is supported by the concept coverage: Stakeholder • Power-Interest • Analysis. Reference: Stakeholder Management; Engagement Planning.",
    "objective": "IT Project Management",
    "conceptCoverage": "Stakeholder • Power-Interest • Analysis",
  ...
  },
  {
    ...
    "fullTopic": "IT Project Management",
    "d": "medium",
    "q": "A project is projected to finish late. The project manager determines that one critical-path testing activity could be shortened by hiring an experienced external testing firm, although this would increase project cost. Which schedule-compression technique is MOST directly being considered?",
    "opts": [
    ...
    "a": 1,
    "exp": "Correct answer is supported by the concept coverage: Schedule • Compression • Crashing. Reference: Project Scheduling; Schedule Compression.",
    "objective": "IT Project Management",
    "conceptCoverage": "Schedule • Compression • Crashing",
    "reference": "Project Scheduling; Schedule Compression"
  },
  {
    "id": "PM-038",
    ...
    "fullTopic": "IT Project Management",
    "d": "medium",
    "q": "A project team uses weekly status reports, but leadership complains that serious issues are sometimes discovered too late. The project manager wants a process that requires immediate notification when security defects, budget overruns, or schedule delays exceed preapproved limits. What should be added?",
    "opts": [
    ...
    "a": 0,
    "exp": "Correct answer is supported by the concept coverage: Project • Communications • Escalation • Thresholds. Reference: Communication Management; Governance.",
    "objective": "IT Project Management",
    "conceptCoverage": "Project • Communications • Escalation • Thresholds",
  ...
  },
  {
    ...
    "fullTopic": "IT Project Management",
    "d": "medium",
    "q": "A project manager discovers that one database administrator is scheduled for two noncritical tasks during the same week. Both tasks have available float, and the project completion date does not need to change. Which action BEST reflects resource smoothing?",
    "opts": [
    ...
    "a": 1,
    "exp": "Correct answer is supported by the concept coverage: Resource • Management • Resource • Smoothing. Reference: Resource Management; Schedule Optimization.",
    "objective": "IT Project Management",
    "conceptCoverage": "Resource • Management • Resource • Smoothing",
    "reference": "Resource Management; Schedule Optimization"
  },
  {
    "id": "PM-040",
    ...
    "fullTopic": "IT Project Management",
    "d": "medium",
    "q": "A project has a planned value of $400,000 by the end of the quarter, but the value of completed work is only $320,000. Actual cost is $330,000. Which conclusion about schedule performance is MOST appropriate?",
    "opts": [
    ...
    "a": 2,
    "exp": "Correct answer is supported by the concept coverage: Earned • Value • Schedule • Variance. Reference: Project Monitoring and Control; Earned Value Management.",
    "objective": "IT Project Management",
    "conceptCoverage": "Earned • Value • Schedule • Variance",
    "reference": "Project Monitoring and Control; Earned Value Management"
  },
  {
    "id": "PM-041",
    ...
    "fullTopic": "IT Project Management",
    "d": "medium",
    "q": "At the end of a sprint, a software team discusses why testing was delayed, identifies that acceptance criteria were often unclear, and agrees to refine backlog items earlier before future sprint planning. Which Agile event is MOST directly represented?",
    "opts": [
    ...
    "a": 3,
    "exp": "Correct answer is supported by the concept coverage: Agile • Retrospectives • Continuous • Improvement. Reference: Agile Project Management; Retrospectives.",
    "objective": "IT Project Management",
    "conceptCoverage": "Agile • Retrospectives • Continuous • Improvement",
  ...
  },
  {
    ...
    "fullTopic": "IT Project Management",
    "d": "medium",
    "q": "A government agency needs a vendor to build a secure public-records portal. The agency wants prospective vendors to describe their technical approach, implementation plan, staffing model, security controls, pricing, prior experience, and support commitments before selection. Which procurement document is MOST appropriate?",
    "opts": [
    ...
    "a": 0,
    "exp": "Correct answer is supported by the concept coverage: Procurement • Request • for • Proposal. Reference: Procurement Management; Vendor Selection.",
    "objective": "IT Project Management",
    "conceptCoverage": "Procurement • Request • for • Proposal",
  ...
  },
  {
    ...
    "a": 1,
    "exp": "Correct answer is supported by the concept coverage: Project • Governance • Decision • Rights. Reference: Governance; Steering Committees.",
    "objective": "IT Project Management",
    "conceptCoverage": "Project • Governance • Decision • Rights",
  ...
  },
  {
    ...
    "fullTopic": "IT Project Management",
    "d": "medium",
    "q": "A new inventory application has been deployed successfully. Before closing the project, the team transfers system documentation, support procedures, monitoring responsibilities, known-issue logs, and vendor contacts to the operations group. What is the PRIMARY purpose of this activity?",
    "opts": [
    ...
    "a": 1,
    "exp": "Correct answer is supported by the concept coverage: Project • Closeout • Operational • Handover. Reference: Project Closeout; Transition to Operations.",
    "objective": "IT Project Management",
    "conceptCoverage": "Project • Closeout • Operational • Handover",
  ...
  },
  {
    ...
    "fullTopic": "IT Project Management",
    "d": "medium",
    "q": "A project team rates each identified risk according to the likelihood that it will occur and the severity of its potential effect on project objectives. What is this analysis MOST commonly used to determine?",
    "opts": [
    ...
    "a": 0,
    "exp": "Correct answer is supported by the concept coverage: Recall • Risk • Probability • and • Impact. Reference: Risk Management; Risk Assessment.",
    "objective": "IT Project Management",
    "conceptCoverage": "Recall • Risk • Probability • and • Impact",
  ...
  },
  {
    ...
    "fullTopic": "IT Project Management",
    "d": "medium",
    "q": "A regional bank is considering a replacement fraud-monitoring platform. Executives want to understand the current problem, expected benefits, strategic alignment, estimated investment, major risks, and consequences of taking no action before authorizing a project. Which artifact would MOST directly support this decision?",
    "opts": [
    ...
    "a": 0,
    "exp": "Correct answer is supported by the concept coverage: Project • Initiation • Business • Case. Reference: Project Initiation; Business Case Development.",
    "objective": "IT Project Management",
    "conceptCoverage": "Project • Initiation • Business • Case",
  ...
  },
  {
    ...
    "a": 1,
    "exp": "Correct answer is supported by the concept coverage: Scope • Validation • Deliverable • Acceptance. Reference: Scope Management; Validation.",
    "objective": "IT Project Management",
    "conceptCoverage": "Scope • Validation • Deliverable • Acceptance",
  ...
  },
  {
    ...
    "a": 2,
    "exp": "Correct answer is supported by the concept coverage: Schedule • Estimation • Three-Point • Estimating. Reference: Project Scheduling; Estimation Techniques.",
    "objective": "IT Project Management",
    "conceptCoverage": "Schedule • Estimation • Three-Point • Estimating",
  ...
  },
  {
    ...
    "fullTopic": "IT Project Management",
    "d": "medium",
    "q": "A company is implementing a cloud-based customer-service platform. Leadership is concerned about the financial impact of prolonged service outages. The vendor agreement includes service-level commitments, financial credits for missed uptime targets, and contractual responsibility for maintaining service availability. Which risk-response strategy is MOST directly represented?",
    "opts": [
    ...
    "a": 3,
    "exp": "Correct answer is supported by the concept coverage: Risk • Transfer • Contractual • Allocation. Reference: Risk Management; Risk Response Strategies.",
    "objective": "IT Project Management",
    "conceptCoverage": "Risk • Transfer • Contractual • Allocation",
  ...
  },
  {
    ...
    "a": 1,
    "exp": "Correct answer is supported by the concept coverage: Project • Monitoring • Variance • Analysis. Reference: Project Monitoring and Control; Performance Reporting.",
    "objective": "IT Project Management",
    "conceptCoverage": "Project • Monitoring • Variance • Analysis",
  ...
  },
  {
    ...
    "fullTopic": "IT Project Management",
    "d": "medium",
    "q": "A development team is considering a user story for the next sprint. The story has a clear business objective but lacks acceptance criteria, has unresolved integration questions, and cannot be estimated reliably. Which action BEST aligns with a definition-of-ready approach?",
    "opts": [
    ...
    "a": 0,
    "exp": "Correct answer is supported by the concept coverage: Agile • Planning • Definition • of • Ready. Reference: Agile Project Management; Backlog Refinement.",
    "objective": "IT Project Management",
    "conceptCoverage": "Agile • Planning • Definition • of • Ready",
  ...
  },
  {
    ...
    "fullTopic": "IT Project Management",
    "d": "medium",
    "q": "A project sponsor wants weekly summaries of progress, risks, budget status, major decisions, and upcoming milestones. Technical leads, however, need detailed issue logs, dependency updates, and test-readiness information. What should the project manager do?",
    "opts": [
    ...
    "a": 3,
    "exp": "Correct answer is supported by the concept coverage: Communications • Management • Status • Reporting. Reference: Project Communications; Stakeholder Reporting.",
    "objective": "IT Project Management",
    "conceptCoverage": "Communications • Management • Status • Reporting",
  ...
  },
  {
    ...
    "a": 2,
    "exp": "Correct answer is supported by the concept coverage: Agile • Estimation • Story • Points. Reference: Agile Project Management; Estimation.",
    "objective": "IT Project Management",
    "conceptCoverage": "Agile • Estimation • Story • Points",
  ...
  },
  {
    ...
    "fullTopic": "IT Project Management",
    "d": "medium",
    "q": "A university is selecting a vendor for a new learning-management system. The project team evaluates price, security controls, accessibility, implementation methodology, integration capability, support model, vendor stability, and references from similar institutions. What is the PRIMARY purpose of using these criteria?",
    "opts": [
    ...
    "a": 1,
    "exp": "Correct answer is supported by the concept coverage: Project • Procurement • Source • Selection • Criteria. Reference: Procurement Management; Vendor Evaluation.",
    "objective": "IT Project Management",
    "conceptCoverage": "Project • Procurement • Source • Selection • Criteria",
  ...
  },
  {
    ...
    "fullTopic": "IT Project Management",
    "d": "medium",
    "q": "A project team previously identified the possibility that an external interface might fail security testing. During testing, the interface actually fails and blocks release approval until remediation occurs. How should the project manager treat this situation?",
    "opts": [
    ...
    "a": 3,
    "exp": "Correct answer is supported by the concept coverage: Issue • Log • Risk • vs. • Issue. Reference: Project Monitoring and Control; Issue Management.",
    "objective": "IT Project Management",
    "conceptCoverage": "Issue • Log • Risk • vs. • Issue",
  ...
  },
  {
    ...
    "fullTopic": "IT Project Management",
    "d": "medium",
    "q": "A project receives formal approval to add a required data-conversion activity, extending the implementation schedule by three weeks. The sponsor, steering committee, and project manager approve the change through established governance. What should happen NEXT?",
    "opts": [
    ...
    "a": 0,
    "exp": "Correct answer is supported by the concept coverage: Schedule • Baseline • Change • Control. Reference: Project Scheduling; Baseline Management.",
    "objective": "IT Project Management",
    "conceptCoverage": "Schedule • Baseline • Change • Control",
  ...
  },
  {
    ...
    "fullTopic": "IT Project Management",
    "d": "medium",
    "q": "Two senior developers disagree about whether to use an external authentication service or build one internally. The conflict is delaying a design decision, but both developers have relevant expertise and are willing to discuss trade-offs. Which conflict-management approach is MOST appropriate?",
    "opts": [
    ...
    "a": 2,
    "exp": "Correct answer is supported by the concept coverage: Team • Development • Conflict • Resolution. Reference: Resource Management; Team Management.",
    "objective": "IT Project Management",
    "conceptCoverage": "Team • Development • Conflict • Resolution",
  ...
  },
  {
    ...
    "fullTopic": "IT Project Management",
    "d": "medium",
    "q": "A project team maintains a matrix linking business requirements to design specifications, development tasks, test cases, and user-acceptance criteria. During a quality review, a required business rule is found to have no related test case. What is the MOST appropriate conclusion?",
    "opts": [
    ...
    "a": 1,
    "exp": "Correct answer is supported by the concept coverage: Requirements • Traceability • Quality • Assurance. Reference: Quality Management; Traceability.",
    "objective": "IT Project Management",
    "conceptCoverage": "Requirements • Traceability • Quality • Assurance",
  ...
  },
  {
    ...
    "fullTopic": "IT Project Management",
    "d": "medium",
    "q": "Which statement BEST describes an activity on the critical path of a project schedule?",
    "opts": [
    ...
    "a": 3,
    "exp": "Correct answer is supported by the concept coverage: Recall • Critical • Path. Reference: Project Scheduling; Critical Path Method.",
    "objective": "IT Project Management",
    "conceptCoverage": "Recall • Critical • Path",
    "reference": "Project Scheduling; Critical Path Method"
  },
  {
    "id": "PM-060",
    ...
    "fullTopic": "IT Project Management",
    "d": "medium",
    "q": "A company completes implementation of a new procurement platform. The project team has transferred support documentation and completed contract closure, but the sponsor also wants accountability for measuring expected savings and process improvements over the next year. What should the organization establish?",
    "opts": [
    ...
    "a": 0,
    "exp": "Correct answer is supported by the concept coverage: Project • Closeout • Benefits • Transition. Reference: Project Closeout; Benefits Realization.",
    "objective": "IT Project Management",
    "conceptCoverage": "Project • Closeout • Benefits • Transition",
  ...
  },
  {
    ...
    "a": 1,
    "exp": "Correct answer is supported by the concept coverage: Project • Assumptions • Constraint • Management. Reference: Project Planning; Assumptions and Constraints.",
    "objective": "IT Project Management",
    "conceptCoverage": "Project • Assumptions • Constraint • Management",
  ...
  },
  {
    ...
    "a": 3,
    "exp": "Correct answer is supported by the concept coverage: Scope • Management • Requirements • Decomposition. Reference: Scope Planning; Work Breakdown Structure.",
    "objective": "IT Project Management",
    "conceptCoverage": "Scope • Management • Requirements • Decomposition",
  ...
  },
  {
    ...
    "fullTopic": "IT Project Management",
    "d": "medium",
    "q": "A project team identifies two risks for a replacement billing system. One has a high probability but minor operational effect; the other has a low probability but could prevent regulatory reporting. The team wants to determine which risks deserve the most attention and response planning. Which approach is MOST appropriate?",
    "opts": [
    ...
    "a": 0,
    "exp": "Correct answer is supported by the concept coverage: Risk • Analysis • Probability-Impact • Matrix. Reference: Risk Management; Risk Assessment.",
    "objective": "IT Project Management",
    "conceptCoverage": "Risk • Analysis • Probability-Impact • Matrix",
    "reference": "Risk Management; Risk Assessment"
  },
  {
    "id": "PM-064",
    ...
    "fullTopic": "IT Project Management",
    "d": "medium",
    "q": "A product owner is communicating plans for a customer-portal modernization effort. Executives need to understand strategic themes, anticipated outcomes, and the likely sequence of major releases over the next year, but they do not need detailed task assignments for the next sprint. Which artifact is MOST appropriate?",
    "opts": [
    ...
    "a": 2,
    "exp": "Correct answer is supported by the concept coverage: Agile • Project • Management • Product • Roadmaps. Reference: Agile Planning; Product Roadmaps.",
    "objective": "IT Project Management",
    "conceptCoverage": "Agile • Project • Management • Product • Roadmaps",
  ...
  },
  {
    ...
    "fullTopic": "IT Project Management",
    "d": "medium",
    "q": "A project schedule shows that data migration must finish before integrated testing can begin, but user-training development can begin while migration is still in progress. Which statement BEST describes the relationship between data migration and integrated testing?",
    "opts": [
    ...
    "a": 1,
    "exp": "Correct answer is supported by the concept coverage: Project • Scheduling • Dependencies. Reference: Project Scheduling; Network Diagrams.",
    "objective": "IT Project Management",
    "conceptCoverage": "Project • Scheduling • Dependencies",
  ...
  },
  {
    ...
    "a": 0,
    "exp": "Correct answer is supported by the concept coverage: Project • Quality • Defect • Prevention. Reference: Quality Management; Quality Assurance.",
    "objective": "IT Project Management",
    "conceptCoverage": "Project • Quality • Defect • Prevention",
  ...
  },
  {
    ...
    "fullTopic": "IT Project Management",
    "d": "medium",
    "q": "A public agency needs a vendor to deliver a well-defined software module with stable requirements and clear acceptance criteria. The agency wants predictable cost and prefers to place more cost-overrun risk on the vendor. Which contract approach is MOST appropriate?",
    "opts": [
    ...
    "a": 3,
    "exp": "Correct answer is supported by the concept coverage: Procurement • Management • Contract • Types. Reference: Procurement Management; Contracting.",
    "objective": "IT Project Management",
    "conceptCoverage": "Procurement • Management • Contract • Types",
  ...
  },
  {
    ...
    "a": 2,
    "exp": "Correct answer is supported by the concept coverage: Stakeholder • Management • Engagement • Strategy. Reference: Stakeholder Management; Engagement Planning.",
    "objective": "IT Project Management",
    "conceptCoverage": "Stakeholder • Management • Engagement • Strategy",
    "reference": "Stakeholder Management; Engagement Planning"
  },
  {
    "id": "PM-069",
    ...
    "fullTopic": "IT Project Management",
    "d": "medium",
    "q": "A project has earned value of $500,000 and actual cost of $575,000 at the end of a reporting period. The planned value is $520,000. What is the MOST appropriate interpretation of cost performance?",
    "opts": [
    ...
    "a": 1,
    "exp": "Correct answer is supported by the concept coverage: Earned • Value • Cost • Variance. Reference: Project Monitoring and Control; Earned Value Management.",
    "objective": "IT Project Management",
    "conceptCoverage": "Earned • Value • Cost • Variance",
    "reference": "Project Monitoring and Control; Earned Value Management"
  },
  {
    "id": "PM-070",
    ...
    "fullTopic": "IT Project Management",
    "d": "medium",
    "q": "Which component is typically included in a project scope baseline?",
    "opts": [
    ...
    "a": 0,
    "exp": "Correct answer is supported by the concept coverage: Recall • Project • Scope • Baseline. Reference: Scope Management; Baselines.",
    "objective": "IT Project Management",
    "conceptCoverage": "Recall • Project • Scope • Baseline",
  ...
  },
  {
    ...
    "a": 2,
    "exp": "Correct answer is supported by the concept coverage: Agile • Delivery • Definition • of • Done. Reference: Agile Project Management; Quality Criteria.",
    "objective": "IT Project Management",
    "conceptCoverage": "Agile • Delivery • Definition • of • Done",
  ...
  },
  {
    ...
    "fullTopic": "IT Project Management",
    "d": "medium",
    "q": "During user acceptance testing, several departments report that the same approval workflow produces inconsistent results. The issue is active, affects a planned launch date, and may require changes to both business rules and system configuration. What should the project manager do FIRST?",
    "opts": [
    ...
    "a": 3,
    "exp": "Correct answer is supported by the concept coverage: Issue • Management • Root • Cause • Analysis. Reference: Project Monitoring and Control; Issue Management.",
    "objective": "IT Project Management",
    "conceptCoverage": "Issue • Management • Root • Cause • Analysis",
    "reference": "Project Monitoring and Control; Issue Management"
  },
  {
    "id": "PM-073",
    ...
    "fullTopic": "IT Project Management",
    "d": "medium",
    "q": "A project requires a cybersecurity architect for threat modeling, secure-design review, and pre-release testing. The architect is available only part-time and is also assigned to another high-priority initiative. What should the project manager do MOST appropriately during planning?",
    "opts": [
    ...
    "a": 1,
    "exp": "Correct answer is supported by the concept coverage: Resource • Management • Skills • Planning. Reference: Resource Management; Team Planning.",
    "objective": "IT Project Management",
    "conceptCoverage": "Resource • Management • Skills • Planning",
  ...
  },
  {
    ...
    "fullTopic": "IT Project Management",
    "d": "medium",
    "q": "A project manager schedules a closeout session after deployment of a new inventory system. Team members review which estimates were accurate, which vendors performed well, why defects escaped earlier testing, and how communication affected adoption. What is the PRIMARY purpose of this session?",
    "opts": [
  ...
  },
  {
    ...
    "fullTopic": "IT Project Management",
    "d": "medium",
    "q": "Which term describes the amount and type of risk an organization is willing to accept in pursuit of its objectives?",
    "opts": [
      "Risk exposure",
      "Risk threshold",
      "Risk appetite",
    ...
    "a": 2,
    "exp": "Correct answer is supported by the concept coverage: Recall • Risk • Appetite. Reference: Risk Management; Governance.",
    "objective": "IT Project Management",
    "conceptCoverage": "Recall • Risk • Appetite",
  ...
  },
  {
    ...
    "fullTopic": "IT Project Management",
    "d": "medium",
    "q": "A manufacturer approves a new warehouse-management system with a fixed launch date before peak season. Midway through development, leaders request additional mobile features but do not authorize more funding or time. What should the project manager communicate MOST clearly?",
    "opts": [
    ...
    "a": 1,
    "exp": "Correct answer is supported by the concept coverage: Project • Constraints • Triple • Constraint. Reference: Project Planning; Scope, Schedule, and Cost.",
    "objective": "IT Project Management",
    "conceptCoverage": "Project • Constraints • Triple • Constraint",
  ...
  },
  {
    ...
    "fullTopic": "IT Project Management",
    "d": "medium",
    "q": "A product owner has collected more requested features than can fit into the first release of a mobile banking application. The team needs a structured method to distinguish mandatory capabilities from important but deferrable enhancements. Which approach BEST supports this need?",
    "opts": [
    ...
    "a": 0,
    "exp": "Correct answer is supported by the concept coverage: Requirements • Prioritization • MoSCoW • Method. Reference: Scope Management; Requirements Prioritization.",
    "objective": "IT Project Management",
    "conceptCoverage": "Requirements • Prioritization • MoSCoW • Method",
  ...
  },
  {
    ...
    "fullTopic": "IT Project Management",
    "d": "medium",
    "q": "A testing activity can start as late as Thursday without delaying any successor activities or the final project completion date. The activity is currently scheduled to start on Monday. What does this MOST directly indicate?",
    "opts": [
    ...
    "a": 1,
    "exp": "Correct answer is supported by the concept coverage: Project • Scheduling • Float. Reference: Project Scheduling; Critical Path Method.",
    "objective": "IT Project Management",
    "conceptCoverage": "Project • Scheduling • Float",
    "reference": "Project Scheduling; Critical Path Method"
  },
  {
    "id": "PM-079",
    ...
    "fullTopic": "IT Project Management",
    "d": "medium",
    "q": "A proposed integration feature would improve reporting but requires an additional vendor contract, new security testing, and a four-week schedule extension. The project manager has completed impact analysis and prepared options. Who should generally review and authorize the change?",
    "opts": [
    ...
    "a": 2,
    "exp": "Correct answer is supported by the concept coverage: Change • Control • Board • Governance. Reference: Integrated Change Control; Project Governance.",
    "objective": "IT Project Management",
    "conceptCoverage": "Change • Control • Board • Governance",
  ...
  },
  {
    ...
    "fullTopic": "IT Project Management",
    "d": "medium",
    "q": "A project team identifies the risk that a third-party data feed may not be delivered on time. The risk response plan states that if the vendor misses two scheduled test-file deliveries, the team will activate a backup data-source process. What are the missed deliveries MOST accurately called?",
    "opts": [
    ...
    "a": 0,
    "exp": "Correct answer is supported by the concept coverage: Project • Risk • Trigger • Conditions. Reference: Risk Management; Monitoring and Control.",
    "objective": "IT Project Management",
    "conceptCoverage": "Project • Risk • Trigger • Conditions",
  ...
  },
  {
    ...
    "fullTopic": "IT Project Management",
    "d": "medium",
    "q": "A development team completes a set of user stories during a sprint. Each story has passed testing, satisfies the team’s definition of done, and can be demonstrated to stakeholders as usable functionality. What is the BEST description of the result?",
    "opts": [
    ...
    "a": 1,
    "exp": "Correct answer is supported by the concept coverage: Agile • Delivery • Product • Increment. Reference: Agile Project Management; Incremental Delivery.",
    "objective": "IT Project Management",
    "conceptCoverage": "Agile • Delivery • Product • Increment",
  ...
  },
  {
    ...
    "a": 2,
    "exp": "Correct answer is supported by the concept coverage: Project • Estimation • Bottom-Up • Estimating. Reference: Project Planning; Estimation Techniques.",
    "objective": "IT Project Management",
    "conceptCoverage": "Project • Estimation • Bottom-Up • Estimating",
  ...
  },
  {
    ...
    "fullTopic": "IT Project Management",
    "d": "medium",
    "q": "A cross-functional implementation team spends significant time in weekly meetings, yet members leave unclear about decisions, owners, and next steps. Which practice would MOST directly improve meeting effectiveness?",
    "opts": [
    ...
    "a": 3,
    "exp": "Correct answer is supported by the concept coverage: Communications • Management • Meeting • Effectiveness. Reference: Project Communications; Team Coordination.",
    "objective": "IT Project Management",
    "conceptCoverage": "Communications • Management • Meeting • Effectiveness",
  ...
  },
  {
    ...
    "fullTopic": "IT Project Management",
    "d": "medium",
    "q": "A municipality is implementing a permit-processing system. Before launch, permit clerks execute realistic scenarios to confirm that the system correctly routes applications, calculates fees, generates notices, and handles exception cases. What type of testing is MOST directly being performed?",
    "opts": [
    ...
    "a": 0,
    "exp": "Correct answer is supported by the concept coverage: Project • Quality • Acceptance • Testing. Reference: Quality Management; Validation.",
    "objective": "IT Project Management",
    "conceptCoverage": "Project • Quality • Acceptance • Testing",
  ...
  },
  {
    ...
    "fullTopic": "IT Project Management",
    "d": "medium",
    "q": "A company plans to outsource development of a reporting interface. Before requesting vendor proposals, the procurement team needs to describe required deliverables, technical expectations, performance standards, milestones, assumptions, and acceptance conditions. Which document is MOST appropriate?",
    "opts": [
    ...
    "a": 1,
    "exp": "Correct answer is supported by the concept coverage: Procurement • Management • Statement • of • Work. Reference: Procurement Management; Contract Planning.",
    "objective": "IT Project Management",
    "conceptCoverage": "Procurement • Management • Statement • of • Work",
  ...
  },
  {
    ...
    "fullTopic": "IT Project Management",
    "d": "medium",
    "q": "A project team adds encryption, access controls, and monitoring to reduce the chance of unauthorized access to customer records. Despite these controls, a small possibility of a security incident remains. What is this remaining exposure MOST accurately called?",
    "opts": [
    ...
    "a": 2,
    "exp": "Correct answer is supported by the concept coverage: Risk • Management • Residual • Risk. Reference: Risk Management; Response Planning.",
    "objective": "IT Project Management",
    "conceptCoverage": "Risk • Management • Residual • Risk",
    "reference": "Risk Management; Response Planning"
  },
  {
    "id": "PM-087",
    ...
    "fullTopic": "IT Project Management",
    "d": "medium",
    "q": "A Scrum team is developing a customer self-service application. One individual is responsible for maximizing product value, ordering backlog items, clarifying feature priorities with stakeholders, and accepting completed work based on agreed criteria. Which role is MOST directly described?",
    "opts": [
      "Scrum Master",
      "Product Owner",
      "Project Sponsor",
    ...
    "a": 1,
    "exp": "Correct answer is supported by the concept coverage: Agile • Roles • Product • Owner. Reference: Agile Project Management; Scrum Roles.",
    "objective": "IT Project Management",
    "conceptCoverage": "Agile • Roles • Product • Owner",
  ...
  },
  {
    ...
    "fullTopic": "IT Project Management",
    "d": "medium",
    "q": "A project has earned value of $180,000 and actual cost of $225,000. The project manager calculates a cost performance index of 0.80. What does this result MOST directly indicate?",
    "opts": [
    ...
    "a": 0,
    "exp": "Correct answer is supported by the concept coverage: Project • Performance • Cost • Performance • Index. Reference: Earned Value Management; Cost Performance.",
    "objective": "IT Project Management",
    "conceptCoverage": "Project • Performance • Cost • Performance • Index",
  ...
  },
  {
    ...
    "fullTopic": "IT Project Management",
    "d": "medium",
    "q": "Six months after a new scheduling system goes live, leadership reviews appointment no-show rates, staff workload, customer wait times, user satisfaction, and realized cost savings against the original business case. What activity is MOST directly being performed?",
    "opts": [
    ...
    "a": 2,
    "exp": "Correct answer is supported by the concept coverage: Project • Closeout • Post-Implementation • Review. Reference: Project Closeout; Benefits Evaluation.",
    "objective": "IT Project Management",
    "conceptCoverage": "Project • Closeout • Post-Implementation • Review",
  ...
  },
  {
    ...
    "fullTopic": "IT Project Management",
    "d": "medium",
    "q": "Which statement BEST describes a project milestone?",
    "opts": [
    ...
    "a": 3,
    "exp": "Correct answer is supported by the concept coverage: Recall • Project • Milestones. Reference: Project Scheduling; Milestones.",
    "objective": "IT Project Management",
    "conceptCoverage": "Recall • Project • Milestones",
    "reference": "Project Scheduling; Milestones"
  },
  {
    "id": "PM-091",
    ...
    "fullTopic": "IT Project Management",
    "d": "medium",
    "q": "A manufacturer is implementing a new supply-chain planning platform. Before moving from design into development, executives require confirmation that requirements are approved, major risks are understood, funding remains justified, and the proposed architecture is acceptable. What project-governance practice is MOST directly represented?",
    "opts": [
    ...
    "a": 0,
    "exp": "Correct answer is supported by the concept coverage: Project • Governance • Stage-Gate • Reviews. Reference: Project Governance; Lifecycle Controls.",
    "objective": "IT Project Management",
    "conceptCoverage": "Project • Governance • Stage-Gate • Reviews",
  ...
  },
  {
    ...
    "fullTopic": "IT Project Management",
    "d": "medium",
    "q": "A hospital is implementing a new patient-portal platform. During testing, staff discover that a regulatory requirement for multilingual consent notices was never included in design specifications or test cases. Which project artifact would have MOST directly helped identify this gap earlier?",
    "opts": [
    ...
    "a": 1,
    "exp": "Correct answer is supported by the concept coverage: Scope • Management • Requirements • Traceability. Reference: Scope Management; Traceability Matrix.",
    "objective": "IT Project Management",
    "conceptCoverage": "Scope • Management • Requirements • Traceability",
  ...
  },
  {
    ...
    "a": 2,
    "exp": "Correct answer is supported by the concept coverage: Schedule • Management • Critical • Chain. Reference: Project Scheduling; Resource-Constrained Planning.",
    "objective": "IT Project Management",
    "conceptCoverage": "Schedule • Management • Critical • Chain",
  ...
  },
  {
    ...
    "fullTopic": "IT Project Management",
    "d": "medium",
    "q": "A university plans to migrate student records during a weekend conversion window. The team develops a tested rollback procedure, identifies decision criteria for abandoning the conversion, and assigns leaders who can authorize a return to the legacy system. What has the team MOST directly created?",
    "opts": [
    ...
    "a": 3,
    "exp": "Correct answer is supported by the concept coverage: Risk • Management • Contingency • Plans. Reference: Risk Response Planning; Contingency Actions.",
    "objective": "IT Project Management",
    "conceptCoverage": "Risk • Management • Contingency • Plans",
  ...
  },
  {
    ...
    "fullTopic": "IT Project Management",
    "d": "medium",
    "q": "At the end of a two-week sprint, a development team demonstrates newly completed claims-processing features to business users. Stakeholders provide feedback about usability and business priority, and the product backlog may be adjusted based on the discussion. Which Scrum event is MOST directly represented?",
    "opts": [
      "Sprint review",
      "Daily Scrum",
    ...
    "a": 0,
    "exp": "Correct answer is supported by the concept coverage: Agile • Delivery • Sprint • Review. Reference: Agile Project Management; Scrum Events.",
    "objective": "IT Project Management",
    "conceptCoverage": "Agile • Delivery • Sprint • Review",
  ...
  },
  {
    ...
    "fullTopic": "IT Project Management",
    "d": "medium",
    "q": "A project manager estimates data-cleansing effort using historical evidence that each source-system field typically requires 2.5 hours of analysis and remediation. The new project contains 180 fields requiring review. Which estimating technique is MOST directly being used?",
    "opts": [
    ...
    "a": 1,
    "exp": "Correct answer is supported by the concept coverage: Cost • Estimation • Parametric • Estimating. Reference: Project Cost Management; Estimation Techniques.",
    "objective": "IT Project Management",
    "conceptCoverage": "Cost • Estimation • Parametric • Estimating",
  ...
  },
  {
    ...
    "fullTopic": "IT Project Management",
    "d": "medium",
    "q": "A company is introducing a new procurement application. Department leaders support the technology, but many buyers are worried that automated approval rules will reduce their discretion and change established relationships with vendors. Which action would MOST effectively improve readiness for change?",
    "opts": [
    ...
    "a": 2,
    "exp": "Correct answer is supported by the concept coverage: Stakeholder • Management • Change • Readiness. Reference: Stakeholder Engagement; Organizational Change.",
    "objective": "IT Project Management",
    "conceptCoverage": "Stakeholder • Management • Change • Readiness",
  ...
  },
  {
    ...
    "fullTopic": "IT Project Management",
    "d": "medium",
    "q": "A program sponsor sets aside funding for unforeseen work that cannot be linked to any specific identified risk but may arise because of general project uncertainty. This amount is held outside the approved cost baseline and is controlled by senior management. What is this funding MOST accurately called?",
    "opts": [
      "Contingency reserve",
      "Management reserve",
      "Sunk cost",
    ...
    "a": 1,
    "exp": "Correct answer is supported by the concept coverage: Project • Controls • Management • Reserve. Reference: Project Cost Management; Reserves.",
    "objective": "IT Project Management",
    "conceptCoverage": "Project • Controls • Management • Reserve",
  ...
  },
  {
    ...
    "fullTopic": "IT Project Management",
    "d": "medium",
    "q": "A software-support organization tracks the number of production defects reported each week. The quality manager wants to distinguish normal variation from unusual patterns that may indicate a process problem requiring investigation. Which tool is MOST appropriate?",
    "opts": [
    ...
    "a": 0,
    "exp": "Correct answer is supported by the concept coverage: Quality • Management • Control • Charts. Reference: Quality Control; Statistical Process Control.",
    "objective": "IT Project Management",
    "conceptCoverage": "Quality • Management • Control • Charts",
  ...
  },
  {
    ...
    "fullTopic": "IT Project Management",
    "d": "medium",
    "q": "A software vendor is under contract to deliver a secure interface by a specified date. The project manager reviews milestone completion, service-level compliance, defect trends, invoice accuracy, and corrective-action commitments throughout the engagement. What is the PRIMARY purpose of these activities?",
    "opts": [
    ...
    "a": 1,
    "exp": "Correct answer is supported by the concept coverage: Procurement • Management • Vendor • Performance. Reference: Contract Administration; Performance Monitoring.",
    "objective": "IT Project Management",
    "conceptCoverage": "Procurement • Management • Vendor • Performance",
  ...
  },
  {
    ...
    "fullTopic": "IT Project Management",
    "d": "medium",
    "q": "A project team completes a testing activity three days later than planned. The final delivery date is not yet affected because the activity had five days of total float. Which statement is MOST accurate?",
    "opts": [
    ...
    "a": 2,
    "exp": "Correct answer is supported by the concept coverage: Schedule • Management • Baseline • Variance. Reference: Project Monitoring and Control; Schedule Performance.",
    "objective": "IT Project Management",
    "conceptCoverage": "Schedule • Management • Baseline • Variance",
  ...
  },
  {
    ...
    "fullTopic": "IT Project Management",
    "d": "medium",
    "q": "A development team is frequently interrupted by unplanned requests from managers outside the team. One person works to remove impediments, coach the team in Scrum practices, facilitate events, and protect the team from unnecessary disruption. Which role is MOST directly described?",
    "opts": [
      "Product Owner",
      "Project Sponsor",
      "Functional Manager",
    ...
    "a": 3,
    "exp": "Correct answer is supported by the concept coverage: Agile • Roles • Scrum • Master. Reference: Agile Project Management; Scrum Roles.",
    "objective": "IT Project Management",
    "conceptCoverage": "Agile • Roles • Scrum • Master",
    "reference": "Agile Project Management; Scrum Roles"
  },
  {
    "id": "PM-103",
    ...
    "fullTopic": "IT Project Management",
    "d": "medium",
    "q": "A city deploys a new permitting system. Before ending the project, the implementation team provides operations staff with architecture diagrams, runbooks, access procedures, support escalation paths, and training on routine maintenance tasks. What is the PRIMARY objective of this work?",
    "opts": [
    ...
    "a": 0,
    "exp": "Correct answer is supported by the concept coverage: Project • Closeout • Knowledge • Transfer. Reference: Project Closeout; Operational Transition.",
    "objective": "IT Project Management",
    "conceptCoverage": "Project • Closeout • Knowledge • Transfer",
  ...
  },
  {
    ...
    "fullTopic": "IT Project Management",
    "d": "medium",
    "q": "A project team estimates a 20% chance that a data-conversion failure would require $150,000 in remediation. Ignoring other risks, what is the expected monetary value of this risk?",
    "opts": [
      "$20,000",
      "$30,000",
      "$120,000",
    ...
    "a": 1,
    "exp": "Correct answer is supported by the concept coverage: Risk • Analysis • Expected • Monetary • Value. Reference: Risk Management; Quantitative Analysis.",
    "objective": "IT Project Management",
    "conceptCoverage": "Risk • Analysis • Expected • Monetary • Value",
  ...
  },
  {
    ...
    "fullTopic": "IT Project Management",
    "d": "medium",
    "q": "Which term refers to a limiting factor that restricts available options for managing a project, such as a fixed deadline, capped budget, required technology standard, or mandated compliance requirement?",
    "opts": [
      "Deliverable",
      "Milestone",
      "Constraint",
  ...
  },
  {
    ...
    "a": 2,
    "exp": "Correct answer is supported by the concept coverage: Network • Topologies • Redundancy. Reference: Networking Fundamentals; Network Design.",
    "objective": "IT Infrastructure",
    "conceptCoverage": "Network • Topologies • Redundancy",
  ...
  },
  {
    ...
    "fullTopic": "IT Infrastructure",
    "d": "medium",
    "q": "A company assigns internal devices addresses beginning with 10.x.x.x and uses a firewall to translate outbound traffic to a public address when employees access the internet. What is the PRIMARY purpose of using these internal addresses?",
    "opts": [
    ...
    "a": 0,
    "exp": "Correct answer is supported by the concept coverage: IP • Addressing • Private • Networks. Reference: Networking Fundamentals; IP Addressing.",
    "objective": "IT Infrastructure",
    "conceptCoverage": "IP • Addressing • Private • Networks",
  ...
  },
  {
    ...
    "fullTopic": "IT Infrastructure",
    "d": "medium",
    "q": "An employee enters portal.company.org into a browser. Before the browser can establish a connection to the web server, it must determine the numerical network address associated with that name. Which infrastructure service MOST directly performs this function?",
    "opts": [
    ...
    "a": 1,
    "exp": "Correct answer is supported by the concept coverage: DNS • Name • Resolution. Reference: Network Services; Domain Name System.",
    "objective": "IT Infrastructure",
    "conceptCoverage": "DNS • Name • Resolution",
  ...
  },
  {
    ...
    "fullTopic": "IT Infrastructure",
    "d": "medium",
    "q": "A company operates several underused physical servers, each hosting one low-demand business application. The infrastructure team wants to reduce hardware costs, simplify provisioning, and allow multiple isolated operating systems to share the same physical machine. Which technology MOST directly supports this goal?",
    "opts": [
    ...
    "a": 1,
    "exp": "Correct answer is supported by the concept coverage: Virtualization • Resource • Utilization. Reference: Server Infrastructure; Virtual Machines.",
    "objective": "IT Infrastructure",
    "conceptCoverage": "Virtualization • Resource • Utilization",
  ...
  },
  {
    ...
    "fullTopic": "IT Infrastructure",
    "d": "medium",
    "q": "A company wants to prevent unauthorized inbound connections to its internal network while permitting approved web traffic, remote-access connections, and business-partner integrations. Which infrastructure component MOST directly enforces rules governing allowed and blocked network traffic?",
    "opts": [
    ...
    "a": 0,
    "exp": "Correct answer is supported by the concept coverage: Firewalls • Network • Security. Reference: Network Security; Perimeter Controls.",
    "objective": "IT Infrastructure",
    "conceptCoverage": "Firewalls • Network • Security",
  ...
  },
  {
    ...
    "fullTopic": "IT Infrastructure",
    "d": "medium",
    "q": "A database server uses multiple physical disks configured so that data can continue to be accessed after one disk fails. The organization understands that the arrangement improves availability but does not replace a backup strategy. What capability is MOST directly being provided?",
    "opts": [
    ...
    "a": 0,
    "exp": "Correct answer is supported by the concept coverage: Storage • RAID. Reference: Storage Infrastructure; Fault Tolerance.",
    "objective": "IT Infrastructure",
    "conceptCoverage": "Storage • RAID",
  ...
  },
  {
    ...
    "fullTopic": "IT Infrastructure",
    "d": "medium",
    "q": "A company adds hundreds of laptops to its wireless network. Rather than manually configuring an IP address, subnet mask, default gateway, and DNS server on every device, the infrastructure team wants these settings assigned automatically when users connect. Which service should be used?",
    "opts": [
      "DNS",
      "DHCP",
      "LDAP",
    ...
    "a": 1,
    "exp": "Correct answer is supported by the concept coverage: DHCP • Network • Configuration. Reference: Network Services; Dynamic Host Configuration Protocol.",
    "objective": "IT Infrastructure",
    "conceptCoverage": "DHCP • Network • Configuration",
  ...
  },
  {
    ...
    "fullTopic": "IT Infrastructure",
    "d": "medium",
    "q": "An online retailer expects heavy traffic during a holiday promotion. To prevent one web server from becoming overloaded, incoming customer requests are distributed across several application servers that provide the same service. Which infrastructure capability is MOST directly being used?",
    "opts": [
    ...
    "a": 0,
    "exp": "Correct answer is supported by the concept coverage: Load • Balancing • Availability. Reference: Server Infrastructure; High Availability.",
    "objective": "IT Infrastructure",
    "conceptCoverage": "Load • Balancing • Availability",
  ...
  },
  {
    ...
    "fullTopic": "IT Infrastructure",
    "d": "medium",
    "q": "A university wants student devices, faculty devices, guest Wi-Fi users, and administrative systems to use the same physical switching infrastructure while remaining logically separated from one another. Which approach BEST supports this requirement?",
    "opts": [
    ...
    "a": 0,
    "exp": "Correct answer is supported by the concept coverage: Network • Segmentation • VLANs. Reference: Networking Fundamentals; Virtual LANs.",
    "objective": "IT Infrastructure",
    "conceptCoverage": "Network • Segmentation • VLANs",
  ...
  },
  {
    ...
    "fullTopic": "IT Infrastructure",
    "d": "medium",
    "q": "A hospital’s network core and server rack must remain powered long enough to shut down gracefully or switch to generator power during a short electrical outage. Which infrastructure component MOST directly supports this objective?",
    "opts": [
    ...
    "a": 0,
    "exp": "Correct answer is supported by the concept coverage: Backup • Power • Uninterruptible • Power • Supply. Reference: Data Center Infrastructure; Power Protection.",
    "objective": "IT Infrastructure",
    "conceptCoverage": "Backup • Power • Uninterruptible • Power • Supply",
  ...
  },
  {
    ...
    "fullTopic": "IT Infrastructure",
    "d": "medium",
    "q": "A professional-services firm is deploying a new employee wireless network. Security leaders want strong authentication and encryption protections that are more modern than legacy WEP or WPA implementations. Which wireless security standard is MOST appropriate?",
    "opts": [
      "WPA3",
      "HTTP",
      "FTP",
    ...
    "a": 0,
    "exp": "Correct answer is supported by the concept coverage: Wireless • Security • WPA3. Reference: Wireless Networking; Security Controls.",
    "objective": "IT Infrastructure",
    "conceptCoverage": "Wireless • Security • WPA3",
  ...
  },
  {
    ...
    "fullTopic": "IT Infrastructure",
    "d": "medium",
    "q": "A startup rents virtual machines, storage, and networking resources from a cloud provider. Its own IT team remains responsible for selecting operating systems, configuring applications, applying patches to guest systems, and managing its data. Which cloud service model is MOST directly represented?",
    "opts": [
    ...
    "a": 2,
    "exp": "Correct answer is supported by the concept coverage: Cloud • Computing • IaaS. Reference: Cloud Services; Service Models.",
    "objective": "IT Infrastructure",
    "conceptCoverage": "Cloud • Computing • IaaS",
  ...
  },
  {
    ...
    "fullTopic": "IT Infrastructure",
    "d": "medium",
    "q": "Which network device primarily forwards packets between different networks and selects a path toward the destination network?",
    "opts": [
      "Router",
      "Switch",
    ...
    "a": 0,
    "exp": "Correct answer is supported by the concept coverage: Recall • Routers. Reference: Networking Fundamentals; Network Devices.",
    "objective": "IT Infrastructure",
    "conceptCoverage": "Recall • Routers",
  ...
  },
  {
    ...
    "fullTopic": "IT Infrastructure",
    "d": "medium",
    "q": "An infrastructure team wants centralized visibility into switch status, interface errors, bandwidth use, device temperatures, and hardware alerts across hundreds of network devices. Which protocol is commonly used to collect and manage this type of network-management information?",
    "opts": [
      "SMTP",
      "SNMP",
      "SSH",
    ...
    "a": 1,
    "exp": "Correct answer is supported by the concept coverage: Monitoring • SNMP. Reference: Network Management; Monitoring Protocols.",
    "objective": "IT Infrastructure",
    "conceptCoverage": "Monitoring • SNMP",
  ...
  },
  {
    ...
    "fullTopic": "IT Infrastructure",
    "d": "medium",
    "q": "A company determines that its customer-ordering platform must be restored within four hours after a major outage to avoid unacceptable operational disruption. What does this four-hour requirement represent?",
    "opts": [
    ...
    "a": 1,
    "exp": "Correct answer is supported by the concept coverage: Disaster • Recovery • Recovery • Time • Objective. Reference: Business Continuity; Disaster Recovery Planning.",
    "objective": "IT Infrastructure",
    "conceptCoverage": "Disaster • Recovery • Recovery • Time • Objective",
  ...
  },
  {
    ...
    "a": 0,
    "exp": "Correct answer is supported by the concept coverage: Network • Address • Translation • Public • and • Private • Addressing. Reference: Networking Fundamentals; NAT.",
    "objective": "IT Infrastructure",
    "conceptCoverage": "Network • Address • Translation • Public • and • Private • Addressing",
  ...
  },
  {
    ...
    "fullTopic": "IT Infrastructure",
    "d": "medium",
    "q": "A financial institution wants to monitor network traffic for suspicious patterns, such as repeated attempts to exploit known vulnerabilities. Security staff also want the system to block clearly malicious traffic automatically when confidence is high. Which capability BEST meets this need?",
    "opts": [
    ...
    "a": 1,
    "exp": "Correct answer is supported by the concept coverage: Network • Security • Intrusion • Detection • and • Prevention. Reference: Network Security; IDS and IPS.",
    "objective": "IT Infrastructure",
    "conceptCoverage": "Network • Security • Intrusion • Detection • and • Prevention",
  ...
  },
  {
    ...
    "fullTopic": "IT Infrastructure",
    "d": "medium",
    "q": "A consulting firm has employees working from home who need secure access to internal file shares and applications. Leadership wants traffic between each employee’s device and the corporate network protected while it travels across public internet connections. Which solution is MOST appropriate?",
    "opts": [
    ...
    "a": 0,
    "exp": "Correct answer is supported by the concept coverage: Virtual • Private • Networks • Remote • Access. Reference: Network Security; Remote Connectivity.",
    "objective": "IT Infrastructure",
    "conceptCoverage": "Virtual • Private • Networks • Remote • Access",
  ...
  },
  {
    ...
    "a": 1,
    "exp": "Correct answer is supported by the concept coverage: Storage • Network-Attached • Storage. Reference: Storage Infrastructure; NAS and SAN.",
    "objective": "IT Infrastructure",
    "conceptCoverage": "Storage • Network-Attached • Storage",
  ...
  },
  {
    ...
    "fullTopic": "IT Infrastructure",
    "d": "medium",
    "q": "A company hosts critical customer-facing applications under its public domain. Leadership wants name resolution to remain available even if one DNS server becomes unreachable due to maintenance or a regional outage. Which design BEST supports this objective?",
    "opts": [
    ...
    "a": 0,
    "exp": "Correct answer is supported by the concept coverage: DNS • Redundancy • High • Availability. Reference: Network Services; DNS Architecture.",
    "objective": "IT Infrastructure",
    "conceptCoverage": "DNS • Redundancy • High • Availability",
  ...
  },
  {
    ...
    "a": 1,
    "exp": "Correct answer is supported by the concept coverage: Cloud • Computing • Platform • as • a • Service. Reference: Cloud Services; Service Models.",
    "objective": "IT Infrastructure",
    "conceptCoverage": "Cloud • Computing • Platform • as • a • Service",
    "reference": "Cloud Services; Service Models"
  },
  {
    "id": "INF-022",
    ...
    "a": 1,
    "exp": "Correct answer is supported by the concept coverage: Network • Segmentation • Zero • Trust • Principles. Reference: Network Security; Segmentation.",
    "objective": "IT Infrastructure",
    "conceptCoverage": "Network • Segmentation • Zero • Trust • Principles",
  ...
  },
  {
    ...
    "a": 0,
    "exp": "Correct answer is supported by the concept coverage: High • Availability • Failover • Clusters. Reference: Server Infrastructure; Fault Tolerance.",
    "objective": "IT Infrastructure",
    "conceptCoverage": "High • Availability • Failover • Clusters",
  ...
  },
  {
    ...
    "fullTopic": "IT Infrastructure",
    "d": "medium",
    "q": "A university expands Wi-Fi coverage in a large lecture hall. The infrastructure team installs devices that connect wireless client devices to the wired campus network and provide radio coverage for laptops, tablets, and phones. Which device is being installed?",
    "opts": [
      "A router",
    ...
    "a": 1,
    "exp": "Correct answer is supported by the concept coverage: Wireless • Networking • Access • Points. Reference: Wireless Networking; Network Devices.",
    "objective": "IT Infrastructure",
    "conceptCoverage": "Wireless • Networking • Access • Points",
  ...
  },
  {
    ...
    "fullTopic": "IT Infrastructure",
    "d": "medium",
    "q": "A medical-practice management system has a recovery point objective of 15 minutes. After a database failure, the organization should be able to restore data with no more than 15 minutes of recent transactions lost. Which backup or replication design BEST aligns with this requirement?",
    "opts": [
    ...
    "a": 2,
    "exp": "Correct answer is supported by the concept coverage: Backup • Strategy • Recovery • Point • Objective. Reference: Business Continuity; Backup and Recovery.",
    "objective": "IT Infrastructure",
    "conceptCoverage": "Backup • Strategy • Recovery • Point • Objective",
  ...
  },
  {
    ...
    "fullTopic": "IT Infrastructure",
    "d": "medium",
    "q": "A company discovers that hundreds of employee laptops are running different versions of an operating system and several have missed critical security updates. The infrastructure team wants to reduce exposure consistently across the organization. What should it implement MOST directly?",
    "opts": [
    ...
    "a": 0,
    "exp": "Correct answer is supported by the concept coverage: Endpoint • Security • Patch • Management. Reference: Infrastructure Security; Vulnerability Management.",
    "objective": "IT Infrastructure",
    "conceptCoverage": "Endpoint • Security • Patch • Management",
  ...
  },
  {
    ...
    "fullTopic": "IT Infrastructure",
    "d": "medium",
    "q": "A development team wants to package an application along with its libraries and runtime dependencies so it behaves consistently in development, testing, and production environments. The team does not need a full separate guest operating system for each deployment. Which technology MOST directly supports this goal?",
    "opts": [
    ...
    "a": 1,
    "exp": "Correct answer is supported by the concept coverage: Containerization • Application • Deployment. Reference: Server Infrastructure; Containers.",
    "objective": "IT Infrastructure",
    "conceptCoverage": "Containerization • Application • Deployment",
  ...
  },
  {
    ...
    "fullTopic": "IT Infrastructure",
    "d": "medium",
    "q": "An employee’s laptop needs to send traffic to a cloud application hosted on a network outside the local office subnet. The device forwards the packet to a configured network address that can route traffic to other networks. What is this address MOST commonly called?",
    "opts": [
      "A subnet mask",
      "A DNS resolver",
      "A default gateway",
    ...
    "a": 2,
    "exp": "Correct answer is supported by the concept coverage: Routing • Default • Gateway. Reference: Networking Fundamentals; IP Routing.",
    "objective": "IT Infrastructure",
    "conceptCoverage": "Routing • Default • Gateway",
  ...
  },
  {
    ...
    "fullTopic": "IT Infrastructure",
    "d": "medium",
    "q": "Which component enables multiple virtual machines to share a physical server while maintaining isolation between their guest operating systems?",
    "opts": [
      "Hypervisor",
      "Firewall",
      "Switch",
    ...
    "a": 0,
    "exp": "Correct answer is supported by the concept coverage: Recall • Hypervisors. Reference: Virtualization; Server Infrastructure.",
    "objective": "IT Infrastructure",
    "conceptCoverage": "Recall • Hypervisors",
  ...
  },
  {
    ...
    "a": 0,
    "exp": "Correct answer is supported by the concept coverage: Business • Continuity • Disaster • Recovery • Testing. Reference: Business Continuity; Disaster Recovery Planning.",
    "objective": "IT Infrastructure",
    "conceptCoverage": "Business • Continuity • Disaster • Recovery • Testing",
    "reference": "Business Continuity; Disaster Recovery Planning"
  },
  {
    "id": "INF-031",
    ...
    "fullTopic": "IT Infrastructure",
    "d": "medium",
    "q": "A company assigns the network 192.168.40.0/24 to one office location. The network administrator wants to divide it into four equal subnets for finance, operations, engineering, and guest devices. Each subnet must support more than 50 usable host addresses. Which subnet mask is MOST appropriate?",
    "opts": [
    ...
    "a": 0,
    "exp": "Correct answer is supported by the concept coverage: Subnetting • CIDR • Notation. Reference: Networking Fundamentals; IP Addressing.",
    "objective": "IT Infrastructure",
    "conceptCoverage": "Subnetting • CIDR • Notation",
    "reference": "Networking Fundamentals; IP Addressing"
  },
  {
    "id": "INF-032",
    ...
    "fullTopic": "IT Infrastructure",
    "d": "medium",
    "q": "A switch receives an Ethernet frame addressed to a device on the same local network. The switch has previously learned the destination device’s hardware address and associated it with a specific physical port. What does the switch MOST directly use to determine where to forward the frame?",
    "opts": [
    ...
    "a": 1,
    "exp": "Correct answer is supported by the concept coverage: Switching • MAC • Address • Tables. Reference: Networking Fundamentals; Switching.",
    "objective": "IT Infrastructure",
    "conceptCoverage": "Switching • MAC • Address • Tables",
  ...
  },
  {
    ...
    "a": 0,
    "exp": "Correct answer is supported by the concept coverage: Identity • Services • Directory • Services. Reference: Infrastructure Security; Identity and Access Management.",
    "objective": "IT Infrastructure",
    "conceptCoverage": "Identity • Services • Directory • Services",
  ...
  },
  {
    ...
    "fullTopic": "IT Infrastructure",
    "d": "medium",
    "q": "A cybersecurity team investigates suspicious activity across firewalls, servers, endpoints, and cloud services. Analysts struggle to reconstruct the sequence of events because logs show inconsistent timestamps. Which infrastructure control would MOST directly improve the reliability of cross-system investigations?",
    "opts": [
    ...
    "a": 1,
    "exp": "Correct answer is supported by the concept coverage: Network • Time • Protocol • Log • Correlation. Reference: Network Management; Time Synchronization.",
    "objective": "IT Infrastructure",
    "conceptCoverage": "Network • Time • Protocol • Log • Correlation",
  ...
  },
  {
    ...
    "fullTopic": "IT Infrastructure",
    "d": "medium",
    "q": "A call center uses voice-over-IP phones, video meetings, cloud applications, and large software downloads over the same network. During periods of heavy download activity, voice calls become choppy and delayed. Which network capability would MOST directly address the problem?",
    "opts": [
    ...
    "a": 0,
    "exp": "Correct answer is supported by the concept coverage: Quality • of • Service • Traffic • Prioritization. Reference: Networking Fundamentals; Quality of Service.",
    "objective": "IT Infrastructure",
    "conceptCoverage": "Quality • of • Service • Traffic • Prioritization",
  ...
  },
  {
    ...
    "fullTopic": "IT Infrastructure",
    "d": "medium",
    "q": "A hospital runs several database servers that require high-performance shared storage presented as block-level volumes. Administrators want storage managed centrally and connected over a dedicated high-speed network rather than through ordinary file shares. Which solution MOST directly fits this requirement?",
    "opts": [
    ...
    "a": 2,
    "exp": "Correct answer is supported by the concept coverage: Storage • Area • Networks • Block • Storage. Reference: Storage Infrastructure; SAN.",
    "objective": "IT Infrastructure",
    "conceptCoverage": "Storage • Area • Networks • Block • Storage",
  ...
  },
  {
    ...
    "a": 0,
    "exp": "Correct answer is supported by the concept coverage: Content • Delivery • Networks • Performance. Reference: Internet Infrastructure; Content Delivery Networks.",
    "objective": "IT Infrastructure",
    "conceptCoverage": "Content • Delivery • Networks • Performance",
  ...
  },
  {
    ...
    "a": 0,
    "exp": "Correct answer is supported by the concept coverage: Reverse • Proxies • Web • Application • Architecture. Reference: Server Infrastructure; Application Delivery.",
    "objective": "IT Infrastructure",
    "conceptCoverage": "Reverse • Proxies • Web • Application • Architecture",
  ...
  },
  {
    ...
    "a": 1,
    "exp": "Correct answer is supported by the concept coverage: SIEM • Security • Monitoring. Reference: Infrastructure Security; Security Operations.",
    "objective": "IT Infrastructure",
    "conceptCoverage": "SIEM • Security • Monitoring",
  ...
  },
  {
    ...
    "fullTopic": "IT Infrastructure",
    "d": "medium",
    "q": "A data center hosts critical clinical systems that cannot tolerate a single power-device failure. The infrastructure team uses independent power feeds, separate uninterruptible power supplies, and redundant power-distribution units for key servers. What design principle is MOST directly being applied?",
    "opts": [
    ...
    "a": 2,
    "exp": "Correct answer is supported by the concept coverage: Redundant • Power • Data • Center • Availability. Reference: Data Center Infrastructure; Power Resilience.",
    "objective": "IT Infrastructure",
    "conceptCoverage": "Redundant • Power • Data • Center • Availability",
  ...
  },
  {
    ...
    "a": 0,
    "exp": "Correct answer is supported by the concept coverage: IPv6 • Address • Capacity. Reference: Networking Fundamentals; Internet Protocol Version 6.",
    "objective": "IT Infrastructure",
    "conceptCoverage": "IPv6 • Address • Capacity",
  ...
  },
  {
    ...
    "a": 1,
    "exp": "Correct answer is supported by the concept coverage: Endpoint • Detection • and • Response. Reference: Infrastructure Security; Endpoint Protection.",
    "objective": "IT Infrastructure",
    "conceptCoverage": "Endpoint • Detection • and • Response",
  ...
  },
  {
    ...
    "a": 2,
    "exp": "Correct answer is supported by the concept coverage: Power • over • Ethernet. Reference: Networking Fundamentals; Ethernet Infrastructure.",
    "objective": "IT Infrastructure",
    "conceptCoverage": "Power • over • Ethernet",
  ...
  },
  {
    ...
    "a": 0,
    "exp": "Correct answer is supported by the concept coverage: Public-Key • Infrastructure • Digital • Certificates. Reference: Infrastructure Security; Cryptography.",
    "objective": "IT Infrastructure",
    "conceptCoverage": "Public-Key • Infrastructure • Digital • Certificates",
  ...
  },
  {
    ...
    "fullTopic": "IT Infrastructure",
    "d": "medium",
    "q": "Which statement BEST describes the purpose of a TCP or UDP port number?",
    "opts": [
    ...
    "a": 1,
    "exp": "Correct answer is supported by the concept coverage: Recall • Network • Ports. Reference: Networking Fundamentals; TCP and UDP.",
    "objective": "IT Infrastructure",
    "conceptCoverage": "Recall • Network • Ports",
  ...
  },
  {
    ...
    "a": 0,
    "exp": "Correct answer is supported by the concept coverage: Network • Segmentation • Demilitarized • Zone. Reference: Network Security; Perimeter Architecture.",
    "objective": "IT Infrastructure",
    "conceptCoverage": "Network • Segmentation • Demilitarized • Zone",
  ...
  },
  {
    ...
    "a": 1,
    "exp": "Correct answer is supported by the concept coverage: DNS • Security • DNSSEC. Reference: Network Services; DNS Security.",
    "objective": "IT Infrastructure",
    "conceptCoverage": "DNS • Security • DNSSEC",
  ...
  },
  {
    ...
    "fullTopic": "IT Infrastructure",
    "d": "medium",
    "q": "A sales organization subscribes to a cloud-based customer relationship management application. The provider manages the application software, infrastructure, operating system, storage, and upgrades, while the organization configures users, workflows, and reports. Which cloud service model is MOST directly represented?",
    "opts": [
      "Infrastructure as a Service",
      "Platform as a Service",
      "Software as a Service",
    ...
    "a": 2,
    "exp": "Correct answer is supported by the concept coverage: Cloud • Computing • Software • as • a • Service. Reference: Cloud Services; Service Models.",
    "objective": "IT Infrastructure",
    "conceptCoverage": "Cloud • Computing • Software • as • a • Service",
    "reference": "Cloud Services; Service Models"
  },
  {
    "id": "INF-049",
    ...
    "fullTopic": "IT Infrastructure",
    "d": "medium",
    "q": "A data center connects a core switch to a storage network using multiple physical Ethernet links. The network team wants the links to operate together for additional bandwidth and to maintain connectivity if one individual cable fails. Which technology MOST directly supports this objective?",
    "opts": [
    ...
    "a": 1,
    "exp": "Correct answer is supported by the concept coverage: Network • Redundancy • Link • Aggregation. Reference: Networking Fundamentals; High Availability.",
    "objective": "IT Infrastructure",
    "conceptCoverage": "Network • Redundancy • Link • Aggregation",
  ...
  },
  {
    ...
    "a": 0,
    "exp": "Correct answer is supported by the concept coverage: Storage • Object • Storage. Reference: Storage Infrastructure; Cloud Storage.",
    "objective": "IT Infrastructure",
    "conceptCoverage": "Storage • Object • Storage",
  ...
  },
  {
    ...
    "fullTopic": "IT Infrastructure",
    "d": "medium",
    "q": "A systems administrator needs to manage Linux servers located in a remote data center. The administrator wants command-line access that encrypts login credentials and session traffic while allowing secure file transfer when needed. Which protocol is MOST appropriate?",
    "opts": [
      "Telnet",
      "FTP",
      "SSH",
    ...
    "a": 2,
    "exp": "Correct answer is supported by the concept coverage: Secure • Remote • Administration • SSH. Reference: Network Security; Administrative Access.",
    "objective": "IT Infrastructure",
    "conceptCoverage": "Secure • Remote • Administration • SSH",
  ...
  },
  {
    ...
    "a": 0,
    "exp": "Correct answer is supported by the concept coverage: Network • Monitoring • Baselines. Reference: Infrastructure Operations; Performance Monitoring.",
    "objective": "IT Infrastructure",
    "conceptCoverage": "Network • Monitoring • Baselines",
  ...
  },
  {
    ...
    "fullTopic": "IT Infrastructure",
    "d": "medium",
    "q": "A development application server needs to communicate with a database server only over TCP port 5432. Security architects want to limit unnecessary network exposure while allowing the required application function. Which firewall rule BEST follows the principle of least privilege?",
    "opts": [
    ...
    "a": 1,
    "exp": "Correct answer is supported by the concept coverage: Firewall • Rules • Least • Privilege. Reference: Network Security; Access Control.",
    "objective": "IT Infrastructure",
    "conceptCoverage": "Firewall • Rules • Least • Privilege",
  ...
  },
  {
    ...
    "fullTopic": "IT Infrastructure",
    "d": "medium",
    "q": "An e-commerce company operates two geographically separate application environments. Both locations actively process customer traffic under normal conditions, and traffic can continue through the remaining location if one region becomes unavailable. Which architecture is MOST directly described?",
    "opts": [
    ...
    "a": 2,
    "exp": "Correct answer is supported by the concept coverage: Business • Continuity • Active-Active • Architecture. Reference: High Availability; Continuity Planning.",
    "objective": "IT Infrastructure",
    "conceptCoverage": "Business • Continuity • Active-Active • Architecture",
  ...
  },
  {
    ...
    "fullTopic": "IT Infrastructure",
    "d": "medium",
    "q": "A university provides separate wireless access for students, faculty, and visitors. Each group sees a different network name when connecting, and each network is mapped to different authentication and access policies. What is the network name broadcast by the wireless infrastructure MOST commonly called?",
    "opts": [
    ...
    "a": 0,
    "exp": "Correct answer is supported by the concept coverage: Wireless • Networking • SSIDs. Reference: Wireless Networking; Network Configuration.",
    "objective": "IT Infrastructure",
    "conceptCoverage": "Wireless • Networking • SSIDs",
  ...
  },
  {
    ...
    "fullTopic": "IT Infrastructure",
    "d": "medium",
    "q": "A load balancer distributes traffic among four web servers. One server begins returning repeated errors even though it still responds to network pings. The organization wants the load balancer to stop sending customer requests to that server until the web application is functioning correctly. What capability is MOST directly needed?",
    "opts": [
    ...
    "a": 0,
    "exp": "Correct answer is supported by the concept coverage: High • Availability • Health • Checks. Reference: Application Delivery; Load Balancing.",
    "objective": "IT Infrastructure",
    "conceptCoverage": "High • Availability • Health • Checks",
  ...
  },
  {
    ...
    "fullTopic": "IT Infrastructure",
    "d": "medium",
    "q": "A company issues smartphones and tablets to sales representatives. IT wants to enforce screen-lock policies, require device encryption, deploy approved applications, remotely wipe lost devices, and separate business data from personal content. Which platform MOST directly supports these requirements?",
    "opts": [
    ...
    "a": 0,
    "exp": "Correct answer is supported by the concept coverage: Endpoint • Management • Mobile • Device • Management. Reference: Infrastructure Security; Endpoint Administration.",
    "objective": "IT Infrastructure",
    "conceptCoverage": "Endpoint • Management • Mobile • Device • Management",
  ...
  },
  {
    ...
    "fullTopic": "IT Infrastructure",
    "d": "medium",
    "q": "Which statement BEST describes packet switching in modern data networks?",
    "opts": [
    ...
    "a": 1,
    "exp": "Correct answer is supported by the concept coverage: Recall • Packet • Switching. Reference: Networking Fundamentals; Data Transmission.",
    "objective": "IT Infrastructure",
    "conceptCoverage": "Recall • Packet • Switching",
  ...
  },
  {
    ...
    "fullTopic": "IT Infrastructure",
    "d": "medium",
    "q": "A customer-facing website suddenly displays browser warnings indicating that its secure connection cannot be trusted. Investigation shows that the site’s TLS certificate expired overnight. What operational practice would MOST directly reduce the chance of this recurring?",
    "opts": [
    ...
    "a": 0,
    "exp": "Correct answer is supported by the concept coverage: Certificate • Management • Expiration • Monitoring. Reference: Infrastructure Security; Public-Key Infrastructure.",
    "objective": "IT Infrastructure",
    "conceptCoverage": "Certificate • Management • Expiration • Monitoring",
  ...
  },
  {
    ...
    "a": 2,
    "exp": "Correct answer is supported by the concept coverage: Incident • Response • Service • Restoration. Reference: Infrastructure Operations; Incident Management.",
    "objective": "IT Infrastructure",
    "conceptCoverage": "Incident • Response • Service • Restoration",
  ...
  },
  {
    ...
    "a": 2,
    "exp": "Correct answer is supported by the concept coverage: Network • Layering • OSI • Model. Reference: Networking Fundamentals; OSI Model.",
    "objective": "IT Infrastructure",
    "conceptCoverage": "Network • Layering • OSI • Model",
  ...
  },
  {
    ...
    "fullTopic": "IT Infrastructure",
    "d": "medium",
    "q": "A company wants to ensure that all employee laptops automatically enforce password complexity, screen-lock timing, approved browser settings, and software-installation restrictions when users sign in. Which infrastructure capability MOST directly supports centralized enforcement of these settings?",
    "opts": [
    ...
    "a": 0,
    "exp": "Correct answer is supported by the concept coverage: Domain • Controllers • Group • Policy. Reference: Identity Infrastructure; Directory Services.",
    "objective": "IT Infrastructure",
    "conceptCoverage": "Domain • Controllers • Group • Policy",
  ...
  },
  {
    ...
    "a": 1,
    "exp": "Correct answer is supported by the concept coverage: Storage • Performance • IOPS. Reference: Storage Infrastructure; Performance Metrics.",
    "objective": "IT Infrastructure",
    "conceptCoverage": "Storage • Performance • IOPS",
  ...
  },
  {
    ...
    "fullTopic": "IT Infrastructure",
    "d": "medium",
    "q": "A company hosts an online payment portal. Security leaders want protection against malicious HTTP requests, common web exploits, and suspicious application-layer traffic before requests reach the web servers. Which infrastructure control is MOST appropriate?",
    "opts": [
    ...
    "a": 0,
    "exp": "Correct answer is supported by the concept coverage: Network • Security • Web • Application • Firewalls. Reference: Application Security; Perimeter Defense.",
    "objective": "IT Infrastructure",
    "conceptCoverage": "Network • Security • Web • Application • Firewalls",
  ...
  },
  {
    ...
    "a": 1,
    "exp": "Correct answer is supported by the concept coverage: Backup • Types • Immutable • Backups. Reference: Business Continuity; Backup Security.",
    "objective": "IT Infrastructure",
    "conceptCoverage": "Backup • Types • Immutable • Backups",
  ...
  },
  {
    ...
    "fullTopic": "IT Infrastructure",
    "d": "medium",
    "q": "A support technician wants to determine whether a workstation can reach a server at the network layer before investigating application-specific issues. Which tool MOST directly tests basic IP connectivity by sending ICMP echo requests?",
    "opts": [
      "Ping",
      "Traceroute",
      "Nslookup",
    ...
    "a": 0,
    "exp": "Correct answer is supported by the concept coverage: Network • Troubleshooting • Ping • and • ICMP. Reference: Networking Fundamentals; Diagnostic Utilities.",
    "objective": "IT Infrastructure",
    "conceptCoverage": "Network • Troubleshooting • Ping • and • ICMP",
  ...
  },
  {
    ...
    "fullTopic": "IT Infrastructure",
    "d": "medium",
    "q": "A company deploys virtual machines in a public-cloud infrastructure-as-a-service environment. The cloud provider secures the physical data center, networking hardware, and hypervisor layer. The company must still configure guest operating systems, patch applications, manage identities, and protect its data. What principle is MOST directly illustrated?",
    "opts": [
    ...
    "a": 1,
    "exp": "Correct answer is supported by the concept coverage: Cloud • Computing • Shared • Responsibility • Model. Reference: Cloud Security; Shared Responsibility.",
    "objective": "IT Infrastructure",
    "conceptCoverage": "Cloud • Computing • Shared • Responsibility • Model",
  ...
  },
  {
    ...
    "fullTopic": "IT Infrastructure",
    "d": "medium",
    "q": "A campus network uses multiple redundant switch connections to improve resilience. However, unmanaged redundant Layer 2 paths could create broadcast storms and forwarding loops. Which protocol MOST directly prevents this problem by logically blocking certain redundant paths until they are needed?",
    "opts": [
    ...
    "a": 0,
    "exp": "Correct answer is supported by the concept coverage: Redundant • Networking • Spanning • Tree • Protocol. Reference: Networking Fundamentals; Switching and Loop Prevention.",
    "objective": "IT Infrastructure",
    "conceptCoverage": "Redundant • Networking • Spanning • Tree • Protocol",
  ...
  },
  {
    ...
    "fullTopic": "IT Infrastructure",
    "d": "medium",
    "q": "A financial-services company maintains an alternate facility with preinstalled hardware, network connectivity, and partially configured systems. The site is not actively processing production traffic but can be activated more quickly than an empty facility after a disaster. What type of recovery site is MOST directly described?",
    "opts": [
      "Cold site",
      "Warm site",
      "Active-active site",
    ...
    "a": 1,
    "exp": "Correct answer is supported by the concept coverage: Disaster • Recovery • Warm • Sites. Reference: Business Continuity; Recovery Sites.",
    "objective": "IT Infrastructure",
    "conceptCoverage": "Disaster • Recovery • Warm • Sites",
  ...
  },
  {
    ...
    "fullTopic": "IT Infrastructure",
    "d": "medium",
    "q": "A hospital’s employee wireless network requires users to authenticate with their individual organizational credentials rather than using one shared password. The security team also wants centralized authentication, authorization, and accounting for wireless access. Which approach BEST supports this requirement?",
    "opts": [
    ...
    "a": 1,
    "exp": "Correct answer is supported by the concept coverage: Wireless • Security • Enterprise • Authentication. Reference: Wireless Networking; Access Control.",
    "objective": "IT Infrastructure",
    "conceptCoverage": "Wireless • Security • Enterprise • Authentication",
  ...
  },
  {
    ...
    "fullTopic": "IT Infrastructure",
    "d": "medium",
    "q": "A company manages hundreds of servers across several environments. Administrators want to define approved configurations as code, automatically deploy consistent settings, detect drift from standards, and reduce manual setup errors. Which approach MOST directly supports these goals?",
    "opts": [
    ...
    "a": 0,
    "exp": "Correct answer is supported by the concept coverage: Infrastructure • Automation • Configuration • Management. Reference: Infrastructure Operations; Automation.",
    "objective": "IT Infrastructure",
    "conceptCoverage": "Infrastructure • Automation • Configuration • Management",
  ...
  },
  {
    ...
    "fullTopic": "IT Infrastructure",
    "d": "medium",
    "q": "Which protocol is primarily used on IPv4 local networks to associate an IP address with the corresponding media access control address?",
    "opts": [
      "DNS",
      "ARP",
      "NTP",
    ...
    "a": 1,
    "exp": "Correct answer is supported by the concept coverage: Recall • ARP. Reference: Networking Fundamentals; Address Resolution.",
    "objective": "IT Infrastructure",
    "conceptCoverage": "Recall • ARP",
  ...
  },
  {
    ...
    "fullTopic": "IT Infrastructure",
    "d": "medium",
    "q": "An online retailer expects order volume to double during an upcoming promotion. Infrastructure leaders review CPU usage, memory demand, database throughput, network utilization, and historical traffic trends to determine whether additional resources are needed before the event. What activity is MOST directly being performed?",
    "opts": [
      "Incident response",
      "Capacity planning",
    ...
    "a": 1,
    "exp": "Correct answer is supported by the concept coverage: Capacity • Planning • Scalability. Reference: Infrastructure Operations; Capacity Management.",
    "objective": "IT Infrastructure",
    "conceptCoverage": "Capacity • Planning • Scalability",
  ...
  },
  {
    ...
    "fullTopic": "IT Infrastructure",
    "d": "medium",
    "q": "A security team discovers that each server stores logs locally, with inconsistent retention settings and no centralized search capability. During an incident, analysts spend hours collecting evidence from individual systems. Which improvement would MOST directly strengthen investigation capability?",
    "opts": [
    ...
    "a": 0,
    "exp": "Correct answer is supported by the concept coverage: Logging • Centralized • Log • Management. Reference: Infrastructure Security; Logging and Monitoring.",
    "objective": "IT Infrastructure",
    "conceptCoverage": "Logging • Centralized • Log • Management",
  ...
  },
  {
    ...
    "a": 0,
    "exp": "Correct answer is supported by the concept coverage: High • Availability • Redundant • Internet • Connectivity. Reference: Network Infrastructure; Resilience.",
    "objective": "IT Infrastructure",
    "conceptCoverage": "High • Availability • Redundant • Internet • Connectivity",
  ...
  },
  {
    ...
    "a": 1,
    "exp": "Correct answer is supported by the concept coverage: Network • Troubleshooting • Traceroute. Reference: Networking Fundamentals; Diagnostic Utilities.",
    "objective": "IT Infrastructure",
    "conceptCoverage": "Network • Troubleshooting • Traceroute",
    "reference": "Networking Fundamentals; Diagnostic Utilities"
  },
  {
    "id": "INF-077",
    ...
    "a": 0,
    "exp": "Correct answer is supported by the concept coverage: Network • Access • Control • Authentication. Reference: Network Security; Access Control.",
    "objective": "IT Infrastructure",
    "conceptCoverage": "Network • Access • Control • Authentication",
    "reference": "Network Security; Access Control"
  },
  {
    "id": "INF-078",
    ...
    "a": 1,
    "exp": "Correct answer is supported by the concept coverage: DNS • Caching. Reference: Network Services; Domain Name System.",
    "objective": "IT Infrastructure",
    "conceptCoverage": "DNS • Caching",
    "reference": "Network Services; Domain Name System"
  },
  {
    "id": "INF-079",
    ...
    "fullTopic": "IT Infrastructure",
    "d": "medium",
    "q": "A server-room temperature sensor shows a gradual increase after an air-conditioning unit begins malfunctioning. The organization wants to avoid hardware shutdowns, component damage, and service interruption. Which action is MOST appropriate?",
    "opts": [
    ...
    "a": 2,
    "exp": "Correct answer is supported by the concept coverage: Data • Center • Cooling • Environmental • Monitoring. Reference: Data Center Infrastructure; Environmental Controls.",
    "objective": "IT Infrastructure",
    "conceptCoverage": "Data • Center • Cooling • Environmental • Monitoring",
  ...
  },
  {
    ...
    "fullTopic": "IT Infrastructure",
    "d": "medium",
    "q": "A company wants employee web traffic to pass through a controlled service that can enforce browsing policies, inspect requests, log activity, and block access to known malicious or inappropriate websites. Which infrastructure component MOST directly supports this requirement?",
    "opts": [
    ...
    "a": 0,
    "exp": "Correct answer is supported by the concept coverage: Network • Security • Proxy • Servers. Reference: Network Security; Web Access Controls.",
    "objective": "IT Infrastructure",
    "conceptCoverage": "Network • Security • Proxy • Servers",
  ...
  },
  {
    ...
    "a": 0,
    "exp": "Correct answer is supported by the concept coverage: Routing • Protocols • Dynamic • Routing. Reference: Networking Fundamentals; Routing.",
    "objective": "IT Infrastructure",
    "conceptCoverage": "Routing • Protocols • Dynamic • Routing",
  ...
  },
  {
    ...
    "fullTopic": "IT Infrastructure",
    "d": "medium",
    "q": "A company performs successful nightly backups of its critical database. During a recovery exercise, however, the team discovers that a backup file cannot be restored because it is corrupted. Which practice would MOST directly reduce the likelihood of this problem remaining undetected?",
    "opts": [
    ...
    "a": 1,
    "exp": "Correct answer is supported by the concept coverage: Backup • Recovery • Restore • Validation. Reference: Business Continuity; Backup and Recovery.",
    "objective": "IT Infrastructure",
    "conceptCoverage": "Backup • Recovery • Restore • Validation",
    "reference": "Business Continuity; Backup and Recovery"
  },
  {
    "id": "INF-083",
    ...
    "fullTopic": "IT Infrastructure",
    "d": "medium",
    "q": "A company must perform maintenance on a physical host running several critical virtual machines. Administrators want to move the virtual machines to another compatible host with little or no interruption to users. Which virtualization capability MOST directly supports this objective?",
    "opts": [
    ...
    "a": 2,
    "exp": "Correct answer is supported by the concept coverage: Virtualization • Live • Migration. Reference: Server Infrastructure; Virtual Machine Management.",
    "objective": "IT Infrastructure",
    "conceptCoverage": "Virtualization • Live • Migration",
  ...
  },
  {
    ...
    "fullTopic": "IT Infrastructure",
    "d": "medium",
    "q": "A company’s domain is being impersonated in phishing emails sent to customers. The security team wants receiving mail systems to verify authorized senders, validate message signatures, and apply the organization’s policy to suspicious messages. Which set of controls MOST directly addresses this concern?",
    "opts": [
    ...
    "a": 0,
    "exp": "Correct answer is supported by the concept coverage: Email • Infrastructure • SPF • DKIM • and • DMARC. Reference: Messaging Security; Email Authentication.",
    "objective": "IT Infrastructure",
    "conceptCoverage": "Email • Infrastructure • SPF • DKIM • and • DMARC",
  ...
  },
  {
    ...
    "fullTopic": "IT Infrastructure",
    "d": "medium",
    "q": "A company stores its primary backups in the same building as its production servers. Leadership is concerned that a fire, flood, or major facility outage could destroy both production systems and local backup copies. Which improvement MOST directly addresses this risk?",
    "opts": [
    ...
    "a": 1,
    "exp": "Correct answer is supported by the concept coverage: Redundancy • Geographic • Diversity. Reference: Business Continuity; Infrastructure Resilience.",
    "objective": "IT Infrastructure",
    "conceptCoverage": "Redundancy • Geographic • Diversity",
  ...
  },
  {
    ...
    "fullTopic": "IT Infrastructure",
    "d": "medium",
    "q": "Which term refers to the largest packet or frame payload size that a network interface or network path can transmit without requiring fragmentation?",
    "opts": [
      "Bandwidth",
      "Latency",
    ...
    "a": 2,
    "exp": "Correct answer is supported by the concept coverage: Recall • MTU. Reference: Networking Fundamentals; Packet Transmission.",
    "objective": "IT Infrastructure",
    "conceptCoverage": "Recall • MTU",
  ...
  },
  {
    ...
    "fullTopic": "IT Infrastructure",
    "d": "medium",
    "q": "An operations team monitors server CPU utilization. A brief spike to 95% is common during nightly processing and does not require action, but sustained CPU usage above 90% for fifteen minutes may indicate a capacity issue. How should the monitoring system be configured MOST appropriately?",
    "opts": [
    ...
    "a": 0,
    "exp": "Correct answer is supported by the concept coverage: Infrastructure • Monitoring • Alert • Thresholds. Reference: Infrastructure Operations; Monitoring and Alerting.",
    "objective": "IT Infrastructure",
    "conceptCoverage": "Infrastructure • Monitoring • Alert • Thresholds",
  ...
  },
  {
    ...
    "a": 1,
    "exp": "Correct answer is supported by the concept coverage: Cloud • Architecture • Availability • Zones. Reference: Cloud Infrastructure; High Availability.",
    "objective": "IT Infrastructure",
    "conceptCoverage": "Cloud • Architecture • Availability • Zones",
  ...
  },
  {
    ...
    "fullTopic": "IT Infrastructure",
    "d": "medium",
    "q": "A company is replacing broad remote-network access with a model in which users authenticate strongly, device posture is assessed, and access is granted only to specific authorized applications rather than to the entire internal network. Which approach MOST directly reflects this design?",
    "opts": [
    ...
    "a": 2,
    "exp": "Correct answer is supported by the concept coverage: Network • Security • Zero • Trust • Network • Access. Reference: Infrastructure Security; Zero Trust Architecture.",
    "objective": "IT Infrastructure",
    "conceptCoverage": "Network • Security • Zero • Trust • Network • Access",
  ...
  },
  {
    ...
    "fullTopic": "IT Infrastructure",
    "d": "medium",
    "q": "A network outage occurs shortly after a firewall policy update. During investigation, the operations team needs to determine exactly what was changed, who approved it, when it was deployed, and whether a rollback plan existed. Which operational record is MOST directly relevant?",
    "opts": [
    ...
    "a": 1,
    "exp": "Correct answer is supported by the concept coverage: Incident • Management • Change • Records. Reference: Infrastructure Operations; Change Management.",
    "objective": "IT Infrastructure",
    "conceptCoverage": "Incident • Management • Change • Records",
  ...
  },
  {
    ...
    "a": 0,
    "exp": "Correct answer is supported by the concept coverage: Network • Security • Multi-Factor • Authentication. Reference: Identity and Access Management; Authentication Controls.",
    "objective": "IT Infrastructure",
    "conceptCoverage": "Network • Security • Multi-Factor • Authentication",
  ...
  },
  {
    ...
    "a": 1,
    "exp": "Correct answer is supported by the concept coverage: Network • Traffic • Bandwidth • vs. • Throughput. Reference: Networking Fundamentals; Performance Metrics.",
    "objective": "IT Infrastructure",
    "conceptCoverage": "Network • Traffic • Bandwidth • vs. • Throughput",
  ...
  },
  {
    ...
    "a": 2,
    "exp": "Correct answer is supported by the concept coverage: Storage • Snapshots. Reference: Storage Infrastructure; Data Protection.",
    "objective": "IT Infrastructure",
    "conceptCoverage": "Storage • Snapshots",
  ...
  },
  {
    ...
    "fullTopic": "IT Infrastructure",
    "d": "medium",
    "q": "An online retailer is concerned that attackers may overwhelm its public website with massive volumes of traffic, preventing legitimate customers from completing purchases. The company wants a service that can detect abnormal traffic patterns and absorb, filter, or divert malicious requests before they reach the application environment. Which solution is MOST appropriate?",
    "opts": [
    ...
    "a": 0,
    "exp": "Correct answer is supported by the concept coverage: Network • Security • Denial-of-Service • Protection. Reference: Network Security; Availability Protection.",
    "objective": "IT Infrastructure",
    "conceptCoverage": "Network • Security • Denial-of-Service • Protection",
  ...
  },
  {
    ...
    "fullTopic": "IT Infrastructure",
    "d": "medium",
    "q": "A network engineer creates separate VLANs for accounting, human resources, engineering, and guest devices. The engineer explains that broadcasts generated in one VLAN should not automatically reach devices in the other VLANs. What is the PRIMARY effect of this design?",
    "opts": [
    ...
    "a": 1,
    "exp": "Correct answer is supported by the concept coverage: Network • Switching • Broadcast • Domains. Reference: Networking Fundamentals; LAN Design.",
    "objective": "IT Infrastructure",
    "conceptCoverage": "Network • Switching • Broadcast • Domains",
  ...
  },
  {
    ...
    "fullTopic": "IT Infrastructure",
    "d": "medium",
    "q": "A ticketing platform experiences unpredictable demand. During major event announcements, traffic can increase tenfold within minutes, but usage drops substantially afterward. The company wants infrastructure capacity to increase automatically during spikes and decrease when demand returns to normal. Which cloud capability MOST directly supports this requirement?",
    "opts": [
    ...
    "a": 2,
    "exp": "Correct answer is supported by the concept coverage: Cloud • Computing • Elastic • Scalability. Reference: Cloud Infrastructure; Scalability.",
    "objective": "IT Infrastructure",
    "conceptCoverage": "Cloud • Computing • Elastic • Scalability",
  ...
  },
  {
    ...
    "a": 0,
    "exp": "Correct answer is supported by the concept coverage: Network • Security • Least • Privilege. Reference: Infrastructure Security; Administrative Access.",
    "objective": "IT Infrastructure",
    "conceptCoverage": "Network • Security • Least • Privilege",
  ...
  },
  {
    ...
    "fullTopic": "IT Infrastructure",
    "d": "medium",
    "q": "A web application experiences increasing demand. Rather than replacing one server with a larger and more expensive machine, the company adds several additional application servers behind a load balancer. Which scaling strategy is MOST directly being used?",
    "opts": [
    ...
    "a": 1,
    "exp": "Correct answer is supported by the concept coverage: Server • Infrastructure • Horizontal • Scaling. Reference: Infrastructure Architecture; Scalability.",
    "objective": "IT Infrastructure",
    "conceptCoverage": "Server • Infrastructure • Horizontal • Scaling",
  ...
  },
  {
    ...
    "fullTopic": "IT Infrastructure",
    "d": "medium",
    "q": "A company encrypts sensitive customer information in cloud storage. Security leaders want to reduce the risk that encrypted data could be exposed because keys are poorly protected, overused, or never rotated. Which practice MOST directly supports secure encryption-key management?",
    "opts": [
    ...
    "a": 2,
    "exp": "Correct answer is supported by the concept coverage: Cryptography • Encryption • Key • Management. Reference: Infrastructure Security; Key Management.",
    "objective": "IT Infrastructure",
    "conceptCoverage": "Cryptography • Encryption • Key • Management",
  ...
  },
  {
    ...
    "fullTopic": "IT Infrastructure",
    "d": "medium",
    "q": "A healthcare organization wants stronger protection against accidental deletion, ransomware, hardware failure, and site-level disasters. Leadership requires at least three copies of critical data, stored on two different media types, with one copy kept off-site. Which backup principle is being applied?",
    "opts": [
    ...
    "a": 0,
    "exp": "Correct answer is supported by the concept coverage: Backup • Operations • 3-2-1 • Backup • Strategy. Reference: Business Continuity; Backup Design.",
    "objective": "IT Infrastructure",
    "conceptCoverage": "Backup • Operations • 3-2-1 • Backup • Strategy",
  ...
  },
  {
    ...
    "fullTopic": "IT Infrastructure",
    "d": "medium",
    "q": "A patient portal uses a browser-based interface for appointment scheduling, messaging, and access to sensitive medical information. The organization wants communications between the patient’s browser and the portal to be encrypted and authenticated using TLS. Which protocol should be used?",
    "opts": [
      "HTTP",
      "HTTPS",
      "FTP",
    ...
    "a": 1,
    "exp": "Correct answer is supported by the concept coverage: Network • Protocols • HTTPS. Reference: Networking Fundamentals; Secure Web Communication.",
    "objective": "IT Infrastructure",
    "conceptCoverage": "Network • Protocols • HTTPS",
  ...
  },
  {
    ...
    "a": 1,
    "exp": "Correct answer is supported by the concept coverage: Infrastructure • Monitoring • Synthetic • Monitoring. Reference: Infrastructure Operations; Availability Monitoring.",
    "objective": "IT Infrastructure",
    "conceptCoverage": "Infrastructure • Monitoring • Synthetic • Monitoring",
  ...
  },
  {
    ...
    "fullTopic": "IT Infrastructure",
    "d": "medium",
    "q": "Which hardware component provides a computer or server with the physical or wireless interface required to connect to a network?",
    "opts": [
      "Network interface card",
      "Hypervisor",
    ...
    "a": 0,
    "exp": "Correct answer is supported by the concept coverage: Recall • Network • Interface • Cards. Reference: Networking Fundamentals; Network Hardware.",
    "objective": "IT Infrastructure",
    "conceptCoverage": "Recall • Network • Interface • Cards",
  ...
  },
  {
    ...
    "a": 1,
    "exp": "Correct answer is supported by the concept coverage: DNS • Architecture • Split-Horizon • DNS. Reference: Network Services; DNS Design.",
    "objective": "IT Infrastructure",
    "conceptCoverage": "DNS • Architecture • Split-Horizon • DNS",
  ...
  },
  {
    ...
    "a": 2,
    "exp": "Correct answer is supported by the concept coverage: Incident • Response • Root • Cause • Analysis. Reference: Infrastructure Operations; Problem Management.",
    "objective": "IT Infrastructure",
    "conceptCoverage": "Incident • Response • Root • Cause • Analysis",
    "reference": "Infrastructure Operations; Problem Management"
  },
  {
    "id": "ET-001",
    "t": "Emerging",
    "fullTopic": "Emerging Technologies",
    "d": "medium",
    ...
    "a": 0,
    "exp": "Correct answer is supported by the concept coverage: Artificial • Intelligence • Machine • Learning. Reference: Emerging Technologies; Artificial Intelligence Fundamentals.",
    "objective": "Emerging Technologies",
    "conceptCoverage": "Artificial • Intelligence • Machine • Learning",
  ...
  },
  {
    ...
    "a": 1,
    "exp": "Correct answer is supported by the concept coverage: Internet • of • Things • Sensor • Networks. Reference: Emerging Technologies; Internet of Things.",
    "objective": "Emerging Technologies",
    "conceptCoverage": "Internet • of • Things • Sensor • Networks",
  ...
  },
  {
    ...
    "fullTopic": "Emerging Technologies",
    "d": "medium",
    "q": "A transportation company analyzes engine-temperature trends, maintenance history, mileage, and diagnostic-code patterns to estimate which vehicles are likely to require service soon. The goal is to schedule repairs before breakdowns occur. What business use of analytics is MOST directly illustrated?",
    "opts": [
    ...
    "a": 2,
    "exp": "Correct answer is supported by the concept coverage: Predictive • Analytics • Predictive • Maintenance. Reference: Emerging Technologies; Analytics Applications.",
    "objective": "Emerging Technologies",
    "conceptCoverage": "Predictive • Analytics • Predictive • Maintenance",
  ...
  },
  {
    ...
    "a": 0,
    "exp": "Correct answer is supported by the concept coverage: Robotic • Process • Automation • Rule-Based • Workflows. Reference: Emerging Technologies; Automation.",
    "objective": "Emerging Technologies",
    "conceptCoverage": "Robotic • Process • Automation • Rule-Based • Workflows",
  ...
  },
  {
    ...
    "fullTopic": "Emerging Technologies",
    "d": "medium",
    "q": "A marketing team uses an AI system to draft product descriptions, generate campaign concepts, summarize customer feedback, and create initial versions of promotional emails. Employees review and revise the results before publication. Which capability MOST directly describes this use case?",
    "opts": [
    ...
    "a": 1,
    "exp": "Correct answer is supported by the concept coverage: Generative • AI • Content • Generation. Reference: Emerging Technologies; Generative Artificial Intelligence.",
    "objective": "Emerging Technologies",
    "conceptCoverage": "Generative • AI • Content • Generation",
  ...
  },
  {
    ...
    "a": 0,
    "exp": "Correct answer is supported by the concept coverage: Bias • in • AI • Model • Governance. Reference: Emerging Technologies; Responsible AI.",
    "objective": "Emerging Technologies",
    "conceptCoverage": "Bias • in • AI • Model • Governance",
  ...
  },
  {
    ...
    "fullTopic": "Emerging Technologies",
    "d": "medium",
    "q": "A food distributor wants suppliers, warehouses, transport providers, and retailers to record custody events for high-value products. Participants need a shared, tamper-evident history of where goods originated and how they moved through the supply chain. Which technology MOST directly supports this objective?",
    "opts": [
    ...
    "a": 1,
    "exp": "Correct answer is supported by the concept coverage: Blockchain • Distributed • Ledgers. Reference: Emerging Technologies; Blockchain Fundamentals.",
    "objective": "Emerging Technologies",
    "conceptCoverage": "Blockchain • Distributed • Ledgers",
  ...
  },
  {
    ...
    "fullTopic": "Emerging Technologies",
    "d": "medium",
    "q": "A field-service technician repairs complex imaging equipment at customer sites. The company wants technicians to see step-by-step repair instructions, component labels, and remote expert annotations overlaid onto their view of the physical machine. Which technology MOST directly supports this use case?",
    "opts": [
    ...
    "a": 1,
    "exp": "Correct answer is supported by the concept coverage: Augmented • Reality • Operational • Support. Reference: Emerging Technologies; Augmented and Virtual Reality.",
    "objective": "Emerging Technologies",
    "conceptCoverage": "Augmented • Reality • Operational • Support",
  ...
  },
  {
    ...
    "fullTopic": "Emerging Technologies",
    "d": "medium",
    "q": "A utility company creates a dynamic virtual model of a power-generation facility. The model receives data from equipment sensors and is used to test how changes in operating conditions may affect output, maintenance needs, and system reliability. What technology is MOST directly represented?",
    "opts": [
    ...
    "a": 0,
    "exp": "Correct answer is supported by the concept coverage: Digital • Twins • Simulation. Reference: Emerging Technologies; Digital Twin Technology.",
    "objective": "Emerging Technologies",
    "conceptCoverage": "Digital • Twins • Simulation",
  ...
  },
  {
    ...
    "fullTopic": "Emerging Technologies",
    "d": "medium",
    "q": "A manufacturing plant uses computer vision to identify defects on products moving quickly along a production line. Sending every camera frame to a distant cloud service creates delays that prevent timely removal of defective products. Which architecture BEST addresses this problem?",
    "opts": [
    ...
    "a": 0,
    "exp": "Correct answer is supported by the concept coverage: Edge • Computing • Latency • Reduction. Reference: Emerging Technologies; Edge Computing.",
    "objective": "Emerging Technologies",
    "conceptCoverage": "Edge • Computing • Latency • Reduction",
  ...
  },
  {
    ...
    "a": 0,
    "exp": "Correct answer is supported by the concept coverage: Natural • Language • Processing • Conversational • Interfaces. Reference: Emerging Technologies; Natural Language Processing.",
    "objective": "Emerging Technologies",
    "conceptCoverage": "Natural • Language • Processing • Conversational • Interfaces",
  ...
  },
  {
    ...
    "a": 0,
    "exp": "Correct answer is supported by the concept coverage: Quantum • Computing • Optimization. Reference: Emerging Technologies; Quantum Computing Concepts.",
    "objective": "Emerging Technologies",
    "conceptCoverage": "Quantum • Computing • Optimization",
  ...
  },
  {
    ...
    "a": 1,
    "exp": "Correct answer is supported by the concept coverage: Explainable • AI • Transparency. Reference: Emerging Technologies; Responsible AI.",
    "objective": "Emerging Technologies",
    "conceptCoverage": "Explainable • AI • Transparency",
    "reference": "Emerging Technologies; Responsible AI"
  },
  {
    "id": "ET-014",
    ...
    "fullTopic": "Emerging Technologies",
    "d": "medium",
    "q": "A retailer wants to analyze security-camera footage to identify when checkout lanes become crowded and alert managers to open additional registers. The system must interpret visual scenes and recognize objects, people, and queue patterns in video frames. Which AI capability is MOST directly required?",
    "opts": [
    ...
    "a": 1,
    "exp": "Correct answer is supported by the concept coverage: Computer • Vision • Image • Classification. Reference: Emerging Technologies; Computer Vision.",
    "objective": "Emerging Technologies",
    "conceptCoverage": "Computer • Vision • Image • Classification",
  ...
  },
  {
    ...
    "fullTopic": "Emerging Technologies",
    "d": "medium",
    "q": "Which term describes the dataset used to teach a machine-learning model to recognize patterns and make predictions before its performance is evaluated on separate validation or test data?",
    "opts": [
      "Training data",
      "Production data",
      "Backup data",
    ...
    "a": 0,
    "exp": "Correct answer is supported by the concept coverage: Recall • Machine • Learning • Model • Training. Reference: Emerging Technologies; Machine Learning Fundamentals.",
    "objective": "Emerging Technologies",
    "conceptCoverage": "Recall • Machine • Learning • Model • Training",
  ...
  },
  {
    ...
    "fullTopic": "Emerging Technologies",
    "d": "medium",
    "q": "A utility company wants to estimate each customer’s likely electricity usage next month based on weather forecasts, household size, prior consumption, appliance type, and seasonal patterns. The target outcome is a numerical value measured in kilowatt-hours rather than a category. Which machine-learning task is MOST directly represented?",
    "opts": [
    ...
    "a": 1,
    "exp": "Correct answer is supported by the concept coverage: Supervised • Learning • Regression. Reference: Emerging Technologies; Machine Learning Fundamentals.",
    "objective": "Emerging Technologies",
    "conceptCoverage": "Supervised • Learning • Regression",
    "reference": "Emerging Technologies; Machine Learning Fundamentals"
  },
  {
    "id": "ET-017",
    ...
    "fullTopic": "Emerging Technologies",
    "d": "medium",
    "q": "A retailer has purchase-history data for millions of customers but no predefined labels describing customer types. Analysts want to identify groups with similar buying patterns, such as frequent premium buyers, occasional discount shoppers, and seasonal purchasers, to support targeted marketing. Which analytical approach is MOST appropriate?",
    "opts": [
    ...
    "a": 0,
    "exp": "Correct answer is supported by the concept coverage: Unsupervised • Learning • Clustering. Reference: Emerging Technologies; Machine Learning Fundamentals.",
    "objective": "Emerging Technologies",
    "conceptCoverage": "Unsupervised • Learning • Clustering",
    "reference": "Emerging Technologies; Machine Learning Fundamentals"
  },
  {
    "id": "ET-018",
    ...
    "a": 3,
    "exp": "Correct answer is supported by the concept coverage: Overfitting • Model • Generalization. Reference: Emerging Technologies; Machine Learning Evaluation.",
    "objective": "Emerging Technologies",
    "conceptCoverage": "Overfitting • Model • Generalization",
  ...
  },
  {
    ...
    "fullTopic": "Emerging Technologies",
    "d": "medium",
    "q": "A consumer-lending model was accurate when introduced two years ago. Since then, interest rates, customer spending behavior, and economic conditions have changed. The model’s approval predictions are becoming less reliable even though the software itself has not changed. What issue should the organization investigate MOST directly?",
    "opts": [
    ...
    "a": 2,
    "exp": "Correct answer is supported by the concept coverage: Model • Drift • Monitoring. Reference: Emerging Technologies; AI Operations.",
    "objective": "Emerging Technologies",
    "conceptCoverage": "Model • Drift • Monitoring",
  ...
  },
  {
    ...
    "a": 1,
    "exp": "Correct answer is supported by the concept coverage: Robotic • Process • Automation • Exception • Handling. Reference: Emerging Technologies; Process Automation.",
    "objective": "Emerging Technologies",
    "conceptCoverage": "Robotic • Process • Automation • Exception • Handling",
  ...
  },
  {
    ...
    "fullTopic": "Emerging Technologies",
    "d": "medium",
    "q": "A customer-support team uses a generative AI assistant to draft answers to policy questions. During testing, the assistant occasionally produces confident but incorrect statements about refund eligibility that are not supported by company policy. What risk is MOST directly illustrated?",
    "opts": [
    ...
    "a": 0,
    "exp": "Correct answer is supported by the concept coverage: Generative • AI • Hallucinations. Reference: Emerging Technologies; Generative AI Risks.",
    "objective": "Emerging Technologies",
    "conceptCoverage": "Generative • AI • Hallucinations",
  ...
  },
  {
    ...
    "a": 2,
    "exp": "Correct answer is supported by the concept coverage: Retrieval-Augmented • Generation • Grounding. Reference: Emerging Technologies; Generative AI Applications.",
    "objective": "Emerging Technologies",
    "conceptCoverage": "Retrieval-Augmented • Generation • Grounding",
  ...
  },
  {
    ...
    "fullTopic": "Emerging Technologies",
    "d": "medium",
    "q": "A hospital deploys an AI tool that prioritizes radiology studies for review. The organization requires clinicians to retain final decision authority, review high-risk recommendations, document overrides, and report unexpected model behavior. Which governance principle is MOST directly being applied?",
    "opts": [
    ...
    "a": 3,
    "exp": "Correct answer is supported by the concept coverage: AI • Governance • Human • Oversight. Reference: Emerging Technologies; Responsible AI.",
    "objective": "Emerging Technologies",
    "conceptCoverage": "AI • Governance • Human • Oversight",
    "reference": "Emerging Technologies; Responsible AI"
  },
  {
    "id": "ET-024",
    ...
    "fullTopic": "Emerging Technologies",
    "d": "medium",
    "q": "A manufacturer deploys thousands of internet-connected sensors across production facilities. Security staff discover that many devices use outdated firmware containing known vulnerabilities, and manual updating would be difficult at this scale. Which control would MOST directly reduce this risk?",
    "opts": [
    ...
    "a": 1,
    "exp": "Correct answer is supported by the concept coverage: Internet • of • Things • Security • Firmware • Management. Reference: Emerging Technologies; IoT Security.",
    "objective": "Emerging Technologies",
    "conceptCoverage": "Internet • of • Things • Security • Firmware • Management",
  ...
  },
  {
    ...
    "a": 0,
    "exp": "Correct answer is supported by the concept coverage: Federated • Learning • Privacy-Preserving • AI. Reference: Emerging Technologies; Privacy-Preserving Machine Learning.",
    "objective": "Emerging Technologies",
    "conceptCoverage": "Federated • Learning • Privacy-Preserving • AI",
  ...
  },
  {
    ...
    "a": 2,
    "exp": "Correct answer is supported by the concept coverage: Virtual • Reality • Immersive • Simulation. Reference: Emerging Technologies; Augmented and Virtual Reality.",
    "objective": "Emerging Technologies",
    "conceptCoverage": "Virtual • Reality • Immersive • Simulation",
    "reference": "Emerging Technologies; Augmented and Virtual Reality"
  },
  {
    "id": "ET-027",
    ...
    "a": 3,
    "exp": "Correct answer is supported by the concept coverage: Edge • Computing • Distributed • Processing. Reference: Emerging Technologies; Edge Computing.",
    "objective": "Emerging Technologies",
    "conceptCoverage": "Edge • Computing • Distributed • Processing",
    "reference": "Emerging Technologies; Edge Computing"
  },
  {
    "id": "ET-028",
    ...
    "fullTopic": "Emerging Technologies",
    "d": "medium",
    "q": "A shipping company wants payment to be released automatically to a carrier when a shipment reaches the destination, proof of delivery is recorded, and agreed temperature conditions were maintained during transit. The parties want the agreement’s logic to execute according to predefined conditions. What blockchain-related capability is MOST directly represented?",
    "opts": [
    ...
    "a": 0,
    "exp": "Correct answer is supported by the concept coverage: Blockchain • Smart • Contracts. Reference: Emerging Technologies; Blockchain Applications.",
    "objective": "Emerging Technologies",
    "conceptCoverage": "Blockchain • Smart • Contracts",
  ...
  },
  {
    ...
    "a": 1,
    "exp": "Correct answer is supported by the concept coverage: Privacy • Data • Minimization. Reference: Emerging Technologies; Responsible Data Use.",
    "objective": "Emerging Technologies",
    "conceptCoverage": "Privacy • Data • Minimization",
  ...
  },
  {
    ...
    "fullTopic": "Emerging Technologies",
    "d": "medium",
    "q": "Which statement BEST describes a digital twin?",
    "opts": [
    ...
    "a": 2,
    "exp": "Correct answer is supported by the concept coverage: Recall • Digital • Twins. Reference: Emerging Technologies; Digital Twin Technology.",
    "objective": "Emerging Technologies",
    "conceptCoverage": "Recall • Digital • Twins",
    "reference": "Emerging Technologies; Digital Twin Technology"
  },
  {
    "id": "ET-031",
    ...
    "fullTopic": "Emerging Technologies",
    "d": "medium",
    "q": "A hospital develops a model that predicts whether a patient is at high risk of readmission. Lowering the model’s decision threshold identifies more potentially high-risk patients but also increases the number of false alerts sent to care managers. Which trade-off is MOST directly affected by changing the threshold?",
    "opts": [
    ...
    "a": 0,
    "exp": "Correct answer is supported by the concept coverage: Machine • Learning • Classification • Thresholds. Reference: Emerging Technologies; Machine Learning Evaluation.",
    "objective": "Emerging Technologies",
    "conceptCoverage": "Machine • Learning • Classification • Thresholds",
    "reference": "Emerging Technologies; Machine Learning Evaluation"
  },
  {
    "id": "ET-032",
    ...
    "fullTopic": "Emerging Technologies",
    "d": "medium",
    "q": "A company trains an image-analysis system to identify damaged packages in warehouse photographs. The system automatically learns complex visual patterns from many labeled examples without developers manually defining every edge, shape, and texture rule. Which approach is MOST directly represented?",
    "opts": [
    ...
    "a": 1,
    "exp": "Correct answer is supported by the concept coverage: Deep • Learning • Neural • Networks. Reference: Emerging Technologies; Artificial Intelligence Fundamentals.",
    "objective": "Emerging Technologies",
    "conceptCoverage": "Deep • Learning • Neural • Networks",
    "reference": "Emerging Technologies; Artificial Intelligence Fundamentals"
  },
  {
    "id": "ET-033",
    ...
    "fullTopic": "Emerging Technologies",
    "d": "medium",
    "q": "A fraud model flags 1,000 transactions as suspicious. After investigation, 800 are confirmed fraudulent and 200 are legitimate. Which metric is MOST directly represented by the proportion of flagged transactions that were actually fraudulent?",
    "opts": [
      "Recall",
      "Specificity",
      "Precision",
    ...
    "a": 2,
    "exp": "Correct answer is supported by the concept coverage: Model • Evaluation • Precision. Reference: Emerging Technologies; Machine Learning Metrics.",
    "objective": "Emerging Technologies",
    "conceptCoverage": "Model • Evaluation • Precision",
  ...
  },
  {
    ...
    "a": 0,
    "exp": "Correct answer is supported by the concept coverage: Generative • AI • Prompt • Engineering. Reference: Emerging Technologies; Generative AI Applications.",
    "objective": "Emerging Technologies",
    "conceptCoverage": "Generative • AI • Prompt • Engineering",
    "reference": "Emerging Technologies; Generative AI Applications"
  },
  {
    "id": "ET-035",
    ...
    "a": 1,
    "exp": "Correct answer is supported by the concept coverage: AI • Governance • Model • Documentation. Reference: Emerging Technologies; Responsible AI.",
    "objective": "Emerging Technologies",
    "conceptCoverage": "AI • Governance • Model • Documentation",
    "reference": "Emerging Technologies; Responsible AI"
  },
  {
    "id": "ET-036",
    ...
    "a": 2,
    "exp": "Correct answer is supported by the concept coverage: Computer • Vision • Optical • Character • Recognition. Reference: Emerging Technologies; Intelligent Document Processing.",
    "objective": "Emerging Technologies",
    "conceptCoverage": "Computer • Vision • Optical • Character • Recognition",
  ...
  },
  {
    ...
    "a": 0,
    "exp": "Correct answer is supported by the concept coverage: Reinforcement • Learning • Optimization. Reference: Emerging Technologies; Machine Learning Methods.",
    "objective": "Emerging Technologies",
    "conceptCoverage": "Reinforcement • Learning • Optimization",
  ...
  },
  {
    ...
    "a": 1,
    "exp": "Correct answer is supported by the concept coverage: AI • Security • Adversarial • Examples. Reference: Emerging Technologies; AI Risks and Security.",
    "objective": "Emerging Technologies",
    "conceptCoverage": "AI • Security • Adversarial • Examples",
  ...
  },
  {
    ...
    "a": 2,
    "exp": "Correct answer is supported by the concept coverage: Robotics • Autonomous • Systems. Reference: Emerging Technologies; Intelligent Automation.",
    "objective": "Emerging Technologies",
    "conceptCoverage": "Robotics • Autonomous • Systems",
  ...
  },
  {
    ...
    "a": 0,
    "exp": "Correct answer is supported by the concept coverage: Responsible • AI • Data • Representativeness. Reference: Emerging Technologies; Bias and Fairness.",
    "objective": "Emerging Technologies",
    "conceptCoverage": "Responsible • AI • Data • Representativeness",
  ...
  },
  {
    ...
    "a": 1,
    "exp": "Correct answer is supported by the concept coverage: Internet • of • Things • Digital • Supply • Chains. Reference: Emerging Technologies; IoT Applications.",
    "objective": "Emerging Technologies",
    "conceptCoverage": "Internet • of • Things • Digital • Supply • Chains",
  ...
  },
  {
    ...
    "fullTopic": "Emerging Technologies",
    "d": "medium",
    "q": "A legal firm asks a large language model to summarize thousands of pages of discovery documents in one request. The system cannot process the entire collection at once because it has a maximum amount of text it can consider in a single interaction. What limitation is MOST directly involved?",
    "opts": [
    ...
    "a": 2,
    "exp": "Correct answer is supported by the concept coverage: Large • Language • Models • Token • Limits. Reference: Emerging Technologies; Generative AI Fundamentals.",
    "objective": "Emerging Technologies",
    "conceptCoverage": "Large • Language • Models • Token • Limits",
  ...
  },
  {
    ...
    "fullTopic": "Emerging Technologies",
    "d": "medium",
    "q": "A public-health agency wants to publish statistics about disease prevalence by neighborhood while reducing the chance that someone could infer whether a specific person’s medical record was included in the underlying data. Which technique MOST directly supports this objective?",
    "opts": [
    ...
    "a": 0,
    "exp": "Correct answer is supported by the concept coverage: Privacy-Enhancing • Technologies • Differential • Privacy. Reference: Emerging Technologies; Privacy and Analytics.",
    "objective": "Emerging Technologies",
    "conceptCoverage": "Privacy-Enhancing • Technologies • Differential • Privacy",
  ...
  },
  {
    ...
    "fullTopic": "Emerging Technologies",
    "d": "medium",
    "q": "A company has deployed dozens of machine-learning models. Teams need repeatable processes for versioning data and models, automating testing and deployment, monitoring performance, detecting drift, and retraining when necessary. Which practice MOST directly supports this operational need?",
    "opts": [
    ...
    "a": 0,
    "exp": "Correct answer is supported by the concept coverage: AI • Lifecycle • MLOps. Reference: Emerging Technologies; AI Operations.",
    "objective": "Emerging Technologies",
    "conceptCoverage": "AI • Lifecycle • MLOps",
    "reference": "Emerging Technologies; AI Operations"
  },
  {
    "id": "ET-045",
    ...
    "fullTopic": "Emerging Technologies",
    "d": "medium",
    "q": "Which task is MOST directly associated with natural language processing?",
    "opts": [
    ...
    "a": 1,
    "exp": "Correct answer is supported by the concept coverage: Recall • Natural • Language • Processing. Reference: Emerging Technologies; AI Fundamentals.",
    "objective": "Emerging Technologies",
    "conceptCoverage": "Recall • Natural • Language • Processing",
  ...
  },
  {
    ...
    "a": 1,
    "exp": "Correct answer is supported by the concept coverage: Machine • Learning • Confusion • Matrix. Reference: Emerging Technologies; Machine Learning Evaluation.",
    "objective": "Emerging Technologies",
    "conceptCoverage": "Machine • Learning • Confusion • Matrix",
    "reference": "Emerging Technologies; Machine Learning Evaluation"
  },
  {
    "id": "ET-047",
    ...
    "fullTopic": "Emerging Technologies",
    "d": "medium",
    "q": "A law firm uses generative AI to prepare first drafts of client correspondence. The firm requires attorneys to review factual statements, legal citations, client-specific details, and tone before any message is sent externally. What is the PRIMARY purpose of this requirement?",
    "opts": [
    ...
    "a": 0,
    "exp": "Correct answer is supported by the concept coverage: Generative • AI • Human • Review. Reference: Emerging Technologies; Responsible AI.",
    "objective": "Emerging Technologies",
    "conceptCoverage": "Generative • AI • Human • Review",
    "reference": "Emerging Technologies; Responsible AI"
  },
  {
    "id": "ET-048",
    ...
    "fullTopic": "Emerging Technologies",
    "d": "medium",
    "q": "A manufacturer deploys thousands of connected sensors in factories worldwide. Security staff want to ensure that only authorized devices can send data to the company’s monitoring platform and that compromised devices can be revoked quickly. Which control MOST directly supports this requirement?",
    "opts": [
    ...
    "a": 2,
    "exp": "Correct answer is supported by the concept coverage: Internet • of • Things • Device • Identity. Reference: Emerging Technologies; IoT Security.",
    "objective": "Emerging Technologies",
    "conceptCoverage": "Internet • of • Things • Device • Identity",
    "reference": "Emerging Technologies; IoT Security"
  },
  {
    "id": "ET-049",
    ...
    "a": 3,
    "exp": "Correct answer is supported by the concept coverage: Predictive • Analytics • Prescriptive • Analytics. Reference: Emerging Technologies; Analytics Applications.",
    "objective": "Emerging Technologies",
    "conceptCoverage": "Predictive • Analytics • Prescriptive • Analytics",
    "reference": "Emerging Technologies; Analytics Applications"
  },
  {
    "id": "ET-050",
    ...
    "a": 0,
    "exp": "Correct answer is supported by the concept coverage: AI • Governance • Data • Provenance. Reference: Emerging Technologies; Responsible AI.",
    "objective": "Emerging Technologies",
    "conceptCoverage": "AI • Governance • Data • Provenance",
    "reference": "Emerging Technologies; Responsible AI"
  },
  {
    "id": "ET-051",
    ...
    "fullTopic": "Emerging Technologies",
    "d": "medium",
    "q": "A warehouse uses cameras to monitor loading docks. The system must identify forklifts, pallets, workers, and delivery trucks within each video frame and indicate where each item is located. Which computer-vision task is MOST directly required?",
    "opts": [
    ...
    "a": 1,
    "exp": "Correct answer is supported by the concept coverage: Computer • Vision • Object • Detection. Reference: Emerging Technologies; Computer Vision.",
    "objective": "Emerging Technologies",
    "conceptCoverage": "Computer • Vision • Object • Detection",
    "reference": "Emerging Technologies; Computer Vision"
  },
  {
    "id": "ET-052",
    ...
    "a": 0,
    "exp": "Correct answer is supported by the concept coverage: Digital • Ethics • Algorithmic • Accountability. Reference: Emerging Technologies; Responsible AI.",
    "objective": "Emerging Technologies",
    "conceptCoverage": "Digital • Ethics • Algorithmic • Accountability",
    "reference": "Emerging Technologies; Responsible AI"
  },
  {
    "id": "ET-053",
    ...
    "a": 1,
    "exp": "Correct answer is supported by the concept coverage: Autonomous • Vehicles • Sensor • Fusion. Reference: Emerging Technologies; Autonomous Systems.",
    "objective": "Emerging Technologies",
    "conceptCoverage": "Autonomous • Vehicles • Sensor • Fusion",
  ...
  },
  {
    ...
    "fullTopic": "Emerging Technologies",
    "d": "medium",
    "q": "A company connects a generative AI assistant to internal policy documents and workflow tools. During testing, a malicious user includes hidden instructions in an uploaded document attempting to make the assistant ignore its rules and disclose confidential content. What threat is MOST directly illustrated?",
    "opts": [
    ...
    "a": 2,
    "exp": "Correct answer is supported by the concept coverage: AI • Security • Prompt • Injection. Reference: Emerging Technologies; Generative AI Security.",
    "objective": "Emerging Technologies",
    "conceptCoverage": "AI • Security • Prompt • Injection",
  ...
  },
  {
    ...
    "a": 0,
    "exp": "Correct answer is supported by the concept coverage: Machine • Learning • Feature • Engineering. Reference: Emerging Technologies; Model Development.",
    "objective": "Emerging Technologies",
    "conceptCoverage": "Machine • Learning • Feature • Engineering",
  ...
  },
  {
    ...
    "a": 1,
    "exp": "Correct answer is supported by the concept coverage: Extended • Reality • Mixed • Reality. Reference: Emerging Technologies; Augmented and Virtual Reality.",
    "objective": "Emerging Technologies",
    "conceptCoverage": "Extended • Reality • Mixed • Reality",
    "reference": "Emerging Technologies; Augmented and Virtual Reality"
  },
  {
    "id": "ET-057",
    ...
    "fullTopic": "Emerging Technologies",
    "d": "medium",
    "q": "A mobile health application collects optional activity, sleep, and nutrition data. Users can choose which data categories to share, withdraw permission later, and review how their information is used for personalized recommendations and research. Which privacy capability is MOST directly being implemented?",
    "opts": [
    ...
    "a": 0,
    "exp": "Correct answer is supported by the concept coverage: Data • Privacy • Consent • Management. Reference: Emerging Technologies; Privacy and Data Governance.",
    "objective": "Emerging Technologies",
    "conceptCoverage": "Data • Privacy • Consent • Management",
  ...
  },
  {
    ...
    "fullTopic": "Emerging Technologies",
    "d": "medium",
    "q": "A financial institution is assessing long-term security risks from advances in quantum computing. Leaders are concerned that some currently used public-key cryptographic methods may eventually become vulnerable to sufficiently capable quantum systems. What planning activity is MOST appropriate?",
    "opts": [
    ...
    "a": 1,
    "exp": "Correct answer is supported by the concept coverage: Quantum • Computing • Cryptography • Risk. Reference: Emerging Technologies; Quantum Computing Implications.",
    "objective": "Emerging Technologies",
    "conceptCoverage": "Quantum • Computing • Cryptography • Risk",
  ...
  },
  {
    ...
    "fullTopic": "Emerging Technologies",
    "d": "medium",
    "q": "Which task is MOST directly associated with natural language generation?",
    "opts": [
    ...
    "a": 2,
    "exp": "Correct answer is supported by the concept coverage: Recall • Natural • Language • Generation. Reference: Emerging Technologies; Artificial Intelligence Fundamentals.",
    "objective": "Emerging Technologies",
    "conceptCoverage": "Recall • Natural • Language • Generation",
    "reference": "Emerging Technologies; Artificial Intelligence Fundamentals"
  },
  {
    "id": "ET-060",
    ...
    "fullTopic": "Emerging Technologies",
    "d": "medium",
    "q": "A company introduces an AI assistant to help employees draft reports and summarize meetings. Some employees worry that it will replace their jobs, while others use it inconsistently and do not understand its limitations. Which approach would MOST likely support responsible adoption?",
    "opts": [
    ...
    "a": 2,
    "exp": "Correct answer is supported by the concept coverage: AI • Adoption • Change • Management. Reference: Emerging Technologies; Organizational Adoption.",
    "objective": "Emerging Technologies",
    "conceptCoverage": "AI • Adoption • Change • Management",
  ...
  },
  {
    ...
    "a": 1,
    "exp": "Correct answer is supported by the concept coverage: Machine • Learning • Validation • Sets. Reference: Emerging Technologies; Machine Learning Evaluation.",
    "objective": "Emerging Technologies",
    "conceptCoverage": "Machine • Learning • Validation • Sets",
    "reference": "Emerging Technologies; Machine Learning Evaluation"
  },
  {
    "id": "ET-062",
    ...
    "fullTopic": "Emerging Technologies",
    "d": "medium",
    "q": "A company deploys a generative AI assistant that can search internal strategy documents, employee records, and confidential financial reports. Security leaders want each user to receive only information they are authorized to access in the source systems. Which control is MOST important?",
    "opts": [
    ...
    "a": 0,
    "exp": "Correct answer is supported by the concept coverage: AI • Governance • Access • Controls. Reference: Emerging Technologies; Responsible AI.",
    "objective": "Emerging Technologies",
    "conceptCoverage": "AI • Governance • Access • Controls",
    "reference": "Emerging Technologies; Responsible AI"
  },
  {
    "id": "ET-063",
    ...
    "fullTopic": "Emerging Technologies",
    "d": "medium",
    "q": "A fraud model flags a legitimate customer purchase as suspicious, causing the transaction to be temporarily blocked. The customer later confirms that the purchase was valid. How should this model outcome be classified?",
    "opts": [
      "True positive",
      "False negative",
      "False positive",
    ...
    "a": 2,
    "exp": "Correct answer is supported by the concept coverage: Predictive • Models • False • Positives. Reference: Emerging Technologies; Machine Learning Evaluation.",
    "objective": "Emerging Technologies",
    "conceptCoverage": "Predictive • Models • False • Positives",
    "reference": "Emerging Technologies; Machine Learning Evaluation"
  },
  {
    "id": "ET-064",
    ...
    "fullTopic": "Emerging Technologies",
    "d": "medium",
    "q": "A company’s internal AI assistant sometimes gives incomplete answers because it retrieves outdated policy documents instead of the current approved versions. The language model itself performs well when provided with the correct sources. Which improvement would MOST directly address the problem?",
    "opts": [
    ...
    "a": 1,
    "exp": "Correct answer is supported by the concept coverage: Generative • AI • Retrieval • Quality. Reference: Emerging Technologies; Retrieval-Augmented Generation.",
    "objective": "Emerging Technologies",
    "conceptCoverage": "Generative • AI • Retrieval • Quality",
  ...
  },
  {
    ...
    "fullTopic": "Emerging Technologies",
    "d": "medium",
    "q": "A radiology AI system must not only identify whether an abnormality is present on an image but also outline the exact pixels corresponding to the suspected lesion. Which computer-vision task is MOST directly required?",
    "opts": [
    ...
    "a": 3,
    "exp": "Correct answer is supported by the concept coverage: Computer • Vision • Image • Segmentation. Reference: Emerging Technologies; Computer Vision.",
    "objective": "Emerging Technologies",
    "conceptCoverage": "Computer • Vision • Image • Segmentation",
    "reference": "Emerging Technologies; Computer Vision"
  },
  {
    "id": "ET-066",
    ...
    "fullTopic": "Emerging Technologies",
    "d": "medium",
    "q": "A manufacturer collects vibration, temperature, and power-consumption data from industrial pumps. The company uses these readings to identify equipment showing early warning signs before failure occurs. Which business benefit is MOST directly supported?",
    "opts": [
    ...
    "a": 0,
    "exp": "Correct answer is supported by the concept coverage: Internet • of • Things • Predictive • Maintenance. Reference: Emerging Technologies; IoT Applications.",
    "objective": "Emerging Technologies",
    "conceptCoverage": "Internet • of • Things • Predictive • Maintenance",
    "reference": "Emerging Technologies; IoT Applications"
  },
  {
    "id": "ET-067",
    ...
    "fullTopic": "Emerging Technologies",
    "d": "medium",
    "q": "A hospital introduces an AI tool that suggests possible diagnoses from imaging studies. Some clinicians begin accepting the tool’s recommendations without carefully reviewing the images or considering conflicting patient information. What risk is MOST directly illustrated?",
    "opts": [
    ...
    "a": 1,
    "exp": "Correct answer is supported by the concept coverage: AI • Ethics • Automation • Bias. Reference: Emerging Technologies; Responsible AI.",
    "objective": "Emerging Technologies",
    "conceptCoverage": "AI • Ethics • Automation • Bias",
    "reference": "Emerging Technologies; Responsible AI"
  },
  {
    "id": "ET-068",
    ...
    "fullTopic": "Emerging Technologies",
    "d": "medium",
    "q": "A consortium of manufacturers, distributors, and regulators wants to share supply-chain records. Only approved organizations should be able to participate, validate transactions, and view sensitive shipment details. Which blockchain model is MOST appropriate?",
    "opts": [
    ...
    "a": 2,
    "exp": "Correct answer is supported by the concept coverage: Blockchain • Permissioned • Networks. Reference: Emerging Technologies; Blockchain Applications.",
    "objective": "Emerging Technologies",
    "conceptCoverage": "Blockchain • Permissioned • Networks",
    "reference": "Emerging Technologies; Blockchain Applications"
  },
  {
    "id": "ET-069",
    ...
    "fullTopic": "Emerging Technologies",
    "d": "medium",
    "q": "A smart-home device uses voice commands to control lighting and security settings. The manufacturer wants simple voice commands to be processed locally when possible to reduce response delays and minimize transmission of sensitive audio to cloud systems. Which approach BEST supports this objective?",
    "opts": [
    ...
    "a": 0,
    "exp": "Correct answer is supported by the concept coverage: Edge • AI • Privacy • and • Latency. Reference: Emerging Technologies; Edge Computing.",
    "objective": "Emerging Technologies",
    "conceptCoverage": "Edge • AI • Privacy • and • Latency",
    "reference": "Emerging Technologies; Edge Computing"
  },
  {
    "id": "ET-070",
    ...
    "fullTopic": "Emerging Technologies",
    "d": "medium",
    "q": "A company’s customer-churn model was accurate at launch, but its precision and recall have declined over several months. The organization wants to detect the problem early and determine whether retraining or threshold adjustment is needed. What should the company implement?",
    "opts": [
    ...
    "a": 0,
    "exp": "Correct answer is supported by the concept coverage: Model • Monitoring • Performance • Degradation. Reference: Emerging Technologies; MLOps.",
    "objective": "Emerging Technologies",
    "conceptCoverage": "Model • Monitoring • Performance • Degradation",
  ...
  },
  {
    ...
    "fullTopic": "Emerging Technologies",
    "d": "medium",
    "q": "A company is considering automation for four processes. Which process is MOST suitable for robotic process automation?",
    "opts": [
    ...
    "a": 2,
    "exp": "Correct answer is supported by the concept coverage: Robotic • Process • Automation • Process • Suitability. Reference: Emerging Technologies; Automation Strategy.",
    "objective": "Emerging Technologies",
    "conceptCoverage": "Robotic • Process • Automation • Process • Suitability",
  ...
  },
  {
    ...
    "fullTopic": "Emerging Technologies",
    "d": "medium",
    "q": "An employee pastes confidential source code into a public generative AI service to request debugging help. The organization has not approved the service for proprietary information. What is the MOST significant concern?",
    "opts": [
    ...
    "a": 0,
    "exp": "Correct answer is supported by the concept coverage: Generative • AI • Data • Leakage. Reference: Emerging Technologies; AI Security and Privacy.",
    "objective": "Emerging Technologies",
    "conceptCoverage": "Generative • AI • Data • Leakage",
  ...
  },
  {
    ...
    "a": 1,
    "exp": "Correct answer is supported by the concept coverage: Digital • Twins • Scenario • Analysis. Reference: Emerging Technologies; Digital Twin Technology.",
    "objective": "Emerging Technologies",
    "conceptCoverage": "Digital • Twins • Scenario • Analysis",
    "reference": "Emerging Technologies; Digital Twin Technology"
  },
  {
    "id": "ET-074",
    ...
    "fullTopic": "Emerging Technologies",
    "d": "medium",
    "q": "Which description BEST defines explainable AI?",
    "opts": [
    ...
    "a": 2,
    "exp": "Correct answer is supported by the concept coverage: Recall • Explainable • AI. Reference: Emerging Technologies; Responsible AI.",
    "objective": "Emerging Technologies",
    "conceptCoverage": "Recall • Explainable • AI",
    "reference": "Emerging Technologies; Responsible AI"
  },
  {
    "id": "ET-075",
    ...
    "a": 0,
    "exp": "Correct answer is supported by the concept coverage: Responsible • AI • Deployment • Readiness. Reference: Emerging Technologies; AI Governance.",
    "objective": "Emerging Technologies",
    "conceptCoverage": "Responsible • AI • Deployment • Readiness",
  ...
  },
  {
    ...
    "a": 0,
    "exp": "Correct answer is supported by the concept coverage: Machine • Learning • Class • Imbalance. Reference: Emerging Technologies; Machine Learning Evaluation.",
    "objective": "Emerging Technologies",
    "conceptCoverage": "Machine • Learning • Class • Imbalance",
    "reference": "Emerging Technologies; Machine Learning Evaluation"
  },
  {
    "id": "ET-077",
    ...
    "fullTopic": "Emerging Technologies",
    "d": "medium",
    "q": "A communications team uses a generative AI system to draft formal regulatory notices. They want responses to be consistent, conservative, and less likely to vary substantially when the same prompt is used repeatedly. Which configuration adjustment would MOST directly support this goal?",
    "opts": [
    ...
    "a": 1,
    "exp": "Correct answer is supported by the concept coverage: Generative • AI • Temperature • Settings. Reference: Emerging Technologies; Generative AI Fundamentals.",
    "objective": "Emerging Technologies",
    "conceptCoverage": "Generative • AI • Temperature • Settings",
    "reference": "Emerging Technologies; Generative AI Fundamentals"
  },
  {
    "id": "ET-078",
    ...
    "fullTopic": "Emerging Technologies",
    "d": "medium",
    "q": "A city plans to use an AI system to prioritize inspections of rental properties. Before deployment, officials want to evaluate potential effects on fairness, privacy, accessibility, affected communities, legal obligations, and opportunities for appeal. What process is MOST directly appropriate?",
    "opts": [
    ...
    "a": 2,
    "exp": "Correct answer is supported by the concept coverage: AI • Governance • Impact • Assessment. Reference: Emerging Technologies; Responsible AI.",
    "objective": "Emerging Technologies",
    "conceptCoverage": "AI • Governance • Impact • Assessment",
    "reference": "Emerging Technologies; Responsible AI"
  },
  {
    "id": "ET-079",
    ...
    "fullTopic": "Emerging Technologies",
    "d": "medium",
    "q": "An insurance company receives thousands of scanned repair estimates containing printed fields, handwritten notes, and itemized costs. The company wants to convert readable text into searchable digital data before employees review exceptions. Which technology is MOST directly required?",
    "opts": [
  ...
  },
  {
    ...
    "a": 0,
    "exp": "Correct answer is supported by the concept coverage: AI • Security • Data • Poisoning. Reference: Emerging Technologies; AI Risks and Security.",
    "objective": "Emerging Technologies",
    "conceptCoverage": "AI • Security • Data • Poisoning",
    "reference": "Emerging Technologies; AI Risks and Security"
  },
  {
    "id": "ET-081",
    ...
    "a": 1,
    "exp": "Correct answer is supported by the concept coverage: Internet • of • Things • Device • Lifecycle • Management. Reference: Emerging Technologies; IoT Operations.",
    "objective": "Emerging Technologies",
    "conceptCoverage": "Internet • of • Things • Device • Lifecycle • Management",
  ...
  },
  {
    ...
    "fullTopic": "Emerging Technologies",
    "d": "medium",
    "q": "A hotel chain wants to analyze thousands of guest reviews to identify whether comments about cleanliness, staff service, breakfast, or room condition are generally positive, negative, or neutral. Which natural-language-processing task is MOST directly appropriate?",
    "opts": [
    ...
    "a": 2,
    "exp": "Correct answer is supported by the concept coverage: Natural • Language • Processing • Sentiment • Analysis. Reference: Emerging Technologies; Natural Language Processing.",
    "objective": "Emerging Technologies",
    "conceptCoverage": "Natural • Language • Processing • Sentiment • Analysis",
    "reference": "Emerging Technologies; Natural Language Processing"
  },
  {
    "id": "ET-083",
    ...
    "fullTopic": "Emerging Technologies",
    "d": "medium",
    "q": "A factory creates a virtual model of a production line that receives live telemetry from machines, inventory systems, and energy meters. Supervisors use the model to identify bottlenecks and test changes to line speed before altering physical equipment. What distinguishes this system from a static simulation?",
    "opts": [
    ...
    "a": 0,
    "exp": "Correct answer is supported by the concept coverage: Digital • Twins • Real-Time • Operations. Reference: Emerging Technologies; Digital Twin Technology.",
    "objective": "Emerging Technologies",
    "conceptCoverage": "Digital • Twins • Real-Time • Operations",
    "reference": "Emerging Technologies; Digital Twin Technology"
  },
  {
    "id": "ET-084",
    ...
    "fullTopic": "Emerging Technologies",
    "d": "medium",
    "q": "A design firm uses a generative AI image tool to create marketing concepts. Legal counsel is concerned that outputs could resemble protected work or that prompts may include copyrighted client materials. Which action MOST directly supports responsible use?",
    "opts": [
    ...
    "a": 1,
    "exp": "Correct answer is supported by the concept coverage: Generative • AI • Copyright • and • Intellectual • Property. Reference: Emerging Technologies; AI Governance.",
    "objective": "Emerging Technologies",
    "conceptCoverage": "Generative • AI • Copyright • and • Intellectual • Property",
    "reference": "Emerging Technologies; AI Governance"
  },
  {
    "id": "ET-085",
    ...
    "a": 2,
    "exp": "Correct answer is supported by the concept coverage: Machine • Learning • Feature • Leakage. Reference: Emerging Technologies; Model Development.",
    "objective": "Emerging Technologies",
    "conceptCoverage": "Machine • Learning • Feature • Leakage",
    "reference": "Emerging Technologies; Model Development"
  },
  {
    "id": "ET-086",
    ...
    "a": 2,
    "exp": "Correct answer is supported by the concept coverage: Robotics • Human-Robot • Collaboration. Reference: Emerging Technologies; Intelligent Automation.",
    "objective": "Emerging Technologies",
    "conceptCoverage": "Robotics • Human-Robot • Collaboration",
    "reference": "Emerging Technologies; Intelligent Automation"
  },
  {
    "id": "ET-087",
    ...
    "fullTopic": "Emerging Technologies",
    "d": "medium",
    "q": "A financial consortium wants to perform limited calculations on encrypted account data without exposing the underlying values to the analytics provider. Which privacy-preserving technology concept is MOST directly relevant?",
    "opts": [
    ...
    "a": 0,
    "exp": "Correct answer is supported by the concept coverage: Privacy-Enhancing • Technologies • Homomorphic • Encryption. Reference: Emerging Technologies; Privacy and Security.",
    "objective": "Emerging Technologies",
    "conceptCoverage": "Privacy-Enhancing • Technologies • Homomorphic • Encryption",
  ...
  },
  {
    ...
    "fullTopic": "Emerging Technologies",
    "d": "medium",
    "q": "An organization’s internal AI assistant answers policy questions by retrieving approved documents. Employees want to verify where each answer came from and quickly inspect the relevant source passage. Which design feature MOST directly supports this need?",
    "opts": [
    ...
    "a": 1,
    "exp": "Correct answer is supported by the concept coverage: Generative • AI • Retrieval • Citations. Reference: Emerging Technologies; Retrieval-Augmented Generation.",
    "objective": "Emerging Technologies",
    "conceptCoverage": "Generative • AI • Retrieval • Citations",
    "reference": "Emerging Technologies; Retrieval-Augmented Generation"
  },
  {
    "id": "ET-089",
    ...
    "fullTopic": "Emerging Technologies",
    "d": "medium",
    "q": "A company replaces an older credit-risk model with a newer version. The previous model should no longer make production decisions, but the organization must preserve relevant records, validation evidence, decision history, and documentation for audit purposes. What process is MOST directly needed?",
    "opts": [
    ...
    "a": 0,
    "exp": "Correct answer is supported by the concept coverage: AI • Governance • Model • Retirement. Reference: Emerging Technologies; AI Lifecycle Management.",
    "objective": "Emerging Technologies",
    "conceptCoverage": "AI • Governance • Model • Retirement",
  ...
  },
  {
    ...
    "fullTopic": "Emerging Technologies",
    "d": "medium",
    "q": "Which statement BEST describes reinforcement learning?",
    "opts": [
    ...
    "a": 2,
    "exp": "Correct answer is supported by the concept coverage: Recall • Reinforcement • Learning. Reference: Emerging Technologies; Machine Learning Fundamentals.",
    "objective": "Emerging Technologies",
    "conceptCoverage": "Recall • Reinforcement • Learning",
    "reference": "Emerging Technologies; Machine Learning Fundamentals"
  },
  {
    "id": "ET-091",
    ...
    "fullTopic": "Emerging Technologies",
    "d": "medium",
    "q": "A hospital develops a model that assigns patients a predicted 20% risk of readmission. Leaders want to know whether, across many similar patients, approximately 20% actually return within 30 days. Which model-quality concept is MOST directly being evaluated?",
    "opts": [
    ...
    "a": 0,
    "exp": "Correct answer is supported by the concept coverage: Machine • Learning • Calibration. Reference: Emerging Technologies; Machine Learning Evaluation.",
    "objective": "Emerging Technologies",
    "conceptCoverage": "Machine • Learning • Calibration",
    "reference": "Emerging Technologies; Machine Learning Evaluation"
  },
  {
    "id": "ET-092",
    ...
    "a": 1,
    "exp": "Correct answer is supported by the concept coverage: Generative • AI • Prompt • Templates. Reference: Emerging Technologies; Generative AI Applications.",
    "objective": "Emerging Technologies",
    "conceptCoverage": "Generative • AI • Prompt • Templates",
    "reference": "Emerging Technologies; Generative AI Applications"
  },
  {
    "id": "ET-093",
    ...
    "fullTopic": "Emerging Technologies",
    "d": "medium",
    "q": "A company deploys a facial-recognition access system at multiple facilities. Testing shows lower identification accuracy for certain demographic groups because those groups were underrepresented in the training images. What action is MOST appropriate before broader deployment?",
    "opts": [
    ...
    "a": 2,
    "exp": "Correct answer is supported by the concept coverage: Computer • Vision • Model • Bias. Reference: Emerging Technologies; Responsible AI.",
    "objective": "Emerging Technologies",
    "conceptCoverage": "Computer • Vision • Model • Bias",
    "reference": "Emerging Technologies; Responsible AI"
  },
  {
    "id": "ET-094",
    ...
    "fullTopic": "Emerging Technologies",
    "d": "medium",
    "q": "A manufacturing company uses edge devices to process machine-sensor data locally. Security leaders want to reduce the chance that a compromised edge gateway can be used to access central production systems. Which control MOST directly supports this objective?",
    "opts": [
    ...
    "a": 1,
    "exp": "Correct answer is supported by the concept coverage: Internet • of • Things • Edge • Security. Reference: Emerging Technologies; IoT Security.",
    "objective": "Emerging Technologies",
    "conceptCoverage": "Internet • of • Things • Edge • Security",
    "reference": "Emerging Technologies; IoT Security"
  },
  {
    "id": "ET-095",
    ...
    "fullTopic": "Emerging Technologies",
    "d": "medium",
    "q": "A commercial airline uses a virtual model of an aircraft engine that receives sensor readings from active flights. Engineers simulate different operating conditions to estimate component wear and determine the best time for maintenance. Which outcome is MOST directly supported by this digital-twin application?",
    "opts": [
    ...
    "a": 0,
    "exp": "Correct answer is supported by the concept coverage: Digital • Twins • Predictive • Simulation. Reference: Emerging Technologies; Digital Twin Technology.",
    "objective": "Emerging Technologies",
    "conceptCoverage": "Digital • Twins • Predictive • Simulation",
    "reference": "Emerging Technologies; Digital Twin Technology"
  },
  {
    "id": "ET-096",
    ...
    "fullTopic": "Emerging Technologies",
    "d": "medium",
    "q": "A legal-services firm processes thousands of contracts and wants to automatically identify company names, dates, monetary amounts, jurisdictions, and individual names within each document. Which natural-language-processing task is MOST directly required?",
    "opts": [
      "Sentiment analysis",
      "Machine translation",
    ...
    "a": 2,
    "exp": "Correct answer is supported by the concept coverage: Natural • Language • Processing • Named • Entity • Recognition. Reference: Emerging Technologies; Natural Language Processing.",
    "objective": "Emerging Technologies",
    "conceptCoverage": "Natural • Language • Processing • Named • Entity • Recognition",
    "reference": "Emerging Technologies; Natural Language Processing"
  },
  {
    "id": "ET-097",
    ...
    "fullTopic": "Emerging Technologies",
    "d": "medium",
    "q": "A financial institution uses an AI system to recommend whether unusual transactions should be escalated for investigation. Compliance officers want records showing the model version used, input data references, recommendation generated, reviewer decision, overrides, and timestamp. What control is MOST directly needed?",
    "opts": [
    ...
    "a": 0,
    "exp": "Correct answer is supported by the concept coverage: AI • Governance • Audit • Logging. Reference: Emerging Technologies; Responsible AI.",
    "objective": "Emerging Technologies",
    "conceptCoverage": "AI • Governance • Audit • Logging",
    "reference": "Emerging Technologies; Responsible AI"
  },
  {
    "id": "ET-098",
    ...
    "a": 1,
    "exp": "Correct answer is supported by the concept coverage: Automation • Intelligent • Document • Processing. Reference: Emerging Technologies; Automation Applications.",
    "objective": "Emerging Technologies",
    "conceptCoverage": "Automation • Intelligent • Document • Processing",
  ...
  },
  {
    ...
    "fullTopic": "Emerging Technologies",
    "d": "medium",
    "q": "A company has a computer-vision model already trained on millions of general images. It wants to adapt the model for identifying defects in a smaller collection of specialized manufacturing images rather than training an entirely new model from scratch. Which technique is MOST directly represented?",
    "opts": [
      "Data deduplication",
    ...
    "a": 2,
    "exp": "Correct answer is supported by the concept coverage: Machine • Learning • Transfer • Learning. Reference: Emerging Technologies; Model Development.",
    "objective": "Emerging Technologies",
    "conceptCoverage": "Machine • Learning • Transfer • Learning",
    "reference": "Emerging Technologies; Model Development"
  },
  {
    "id": "ET-100",
    ...
    "a": 0,
    "exp": "Correct answer is supported by the concept coverage: Generative • AI • Fine-Tuning. Reference: Emerging Technologies; Generative AI Applications.",
    "objective": "Emerging Technologies",
    "conceptCoverage": "Generative • AI • Fine-Tuning",
    "reference": "Emerging Technologies; Generative AI Applications"
  },
  {
    "id": "ET-101",
    ...
    "a": 1,
    "exp": "Correct answer is supported by the concept coverage: Robotics • Safety • Systems. Reference: Emerging Technologies; Autonomous Systems.",
    "objective": "Emerging Technologies",
    "conceptCoverage": "Robotics • Safety • Systems",
    "reference": "Emerging Technologies; Autonomous Systems"
  },
  {
    "id": "ET-102",
    ...
    "fullTopic": "Emerging Technologies",
    "d": "medium",
    "q": "A health organization releases a data set with names and medical-record numbers removed. Researchers later determine that combinations of age, ZIP code, admission date, and diagnosis could potentially be linked with external sources to identify individuals. What risk is MOST directly illustrated?",
    "opts": [
      "Model drift",
      "Prompt injection",
    ...
    "a": 2,
    "exp": "Correct answer is supported by the concept coverage: AI • Privacy • Re-Identification • Risk. Reference: Emerging Technologies; Privacy and Data Protection.",
    "objective": "Emerging Technologies",
    "conceptCoverage": "AI • Privacy • Re-Identification • Risk",
  ...
  },
  {
    ...
    "fullTopic": "Emerging Technologies",
    "d": "medium",
    "q": "A consortium blockchain includes several approved organizations that maintain copies of a shared ledger. Before a new transaction is added, the network follows agreed rules to determine whether participants accept the transaction as valid. What process is MOST directly being used?",
    "opts": [
    ...
    "a": 0,
    "exp": "Correct answer is supported by the concept coverage: Blockchain • Consensus • Mechanisms. Reference: Emerging Technologies; Blockchain Fundamentals.",
    "objective": "Emerging Technologies",
    "conceptCoverage": "Blockchain • Consensus • Mechanisms",
    "reference": "Emerging Technologies; Blockchain Fundamentals"
  },
  {
    "id": "ET-104",
    ...
    "fullTopic": "Emerging Technologies",
    "d": "medium",
    "q": "A bank uses an AI model to recommend credit-limit adjustments. Relationship managers need to explain to customers why a recommendation was made without disclosing proprietary model code or exposing sensitive data about other customers. Which capability BEST supports this requirement?",
    "opts": [
    ...
    "a": 1,
    "exp": "Correct answer is supported by the concept coverage: Machine • Learning • Explainability • for • Stakeholders. Reference: Emerging Technologies; Responsible AI.",
    "objective": "Emerging Technologies",
    "conceptCoverage": "Machine • Learning • Explainability • for • Stakeholders",
    "reference": "Emerging Technologies; Responsible AI"
  },
  {
    "id": "ET-105",
    ...
    "a": 1,
    "exp": "Correct answer is supported by the concept coverage: Recall • Artificial • Intelligence. Reference: Emerging Technologies; Artificial Intelligence Fundamentals.",
    "objective": "Emerging Technologies",
    "conceptCoverage": "Recall • Artificial • Intelligence",
    "reference": "Emerging Technologies; Artificial Intelligence Fundamentals"
  }
];
